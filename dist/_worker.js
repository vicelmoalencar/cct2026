...
`;return typeof a=="function"&&a(null,v),v},er}var Rs;function Ao(){if(Rs)return qe;Rs=1;const e=no(),t=Eo(),r=_o(),s=So();function n(i,o,a,c,u){const l=[].slice.call(arguments,1),f=l.length,d=typeof l[f-1]=="function";if(!d&&!e())throw new Error("Callback required as last argument");if(d){if(f<2)throw new Error("Too few arguments provided");f===2?(u=a,a=o,o=c=void 0):f===3&&(o.getContext&&typeof u>"u"?(u=c,c=void 0):(u=c,c=a,a=o,o=void 0))}else{if(f<1)throw new Error("Too few arguments provided");return f===1?(a=o,o=c=void 0):f===2&&!o.getContext&&(c=a,a=o,o=void 0),new Promise(function(p,g){try{const b=t.create(a,c);p(i(b,o,c))}catch(b){g(b)}})}try{const p=t.create(a,c);u(null,i(p,o,c))}catch(p){u(p)}}return qe.create=t.create,qe.toCanvas=n.bind(null,r.render),qe.toDataURL=n.bind(null,r.renderToDataURL),qe.toString=n.bind(null,function(i,o,a){return s.render(i,a)}),qe}var Co=Ao();const To=Jn(Co),I=new Gn,tr=new Map,rr=new Map,sr=new Map;function q(e){const t=e.env.DATABASE_CCT;if(!t)throw new Error("DATABASE_CCT não configurado nas variáveis de ambiente");return new wt(t)}function ti(e){const t=e.env.DATABASE_URL_CREDITOS||e.env.DATABASE_SUITEPLUS;if(!t)throw new Error("DATABASE_URL_CREDITOS não configurado");return new wt(t)}async function ri(e){const t=e.connectionString||"credits";tr.has(t)||tr.set(t,(async()=>{await e.sql(`
     ...
     RETURNING credits_balance`,[r,t])).length>0}async function Hr(e){const t=e.connectionString||"lesson-rentals";rr.has(t)||rr.set(t,(async()=>{await e.sql("ALTER TABLE lessons ADD COLUMN IF NOT EXISTS rentable BOOLEAN DEFAULT FALSE"),await e.sql("ALTER TABLE lessons ADD COLUMN IF NOT EXISTS rental_credits INTEGER DEFAULT 0"),await e.sql(`
      ...
      `),await e.sql("CREATE INDEX IF NOT EXISTS idx_lesson_rentals_email ON lesson_rentals(user_email)"),await e.sql("CREATE INDEX IF NOT EXISTS idx_lesson_rentals_lesson ON lesson_rentals(lesson_id)")})()),await rr.get(t)}async function ie(e){const t=e.connectionString||"question-bank";sr.has(t)||sr.set(t,(async()=>{await e.sql(`
...
<body class="bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
      ...
      `):e.redirect(`/?error=${r}`);const s=t.searchParams.get("access_token")||((c=t.hash.match(/access_token=([^&]+)/))==null?void 0:c[1]),n=t.searchParams.get("refresh_token")||((u=t.hash.match(/refresh_token=([^&]+)/))==null?void 0:u[1]),i=t.searchParams.get("type")||((l=t.hash.match(/type=([^&]+)/))==null?void 0:l[1]);if(!s)return e.redirect("/?error=no_token");try{const p=(f=JSON.parse(atob(s.split(".")[1])).amr)==null?void 0:f.some(g=>g.method==="otp");if(i==="recovery"||p)return e.redirect(`/reset-password#access_token=${s}&refresh_token=${n||""}&type=recovery`)}catch{if(i==="recovery")return e.redirect(`/reset-password#access_token=${s}&refresh_token=${n||""}&type=recovery`)}return se(e,"sb-access-token",s,{httpOnly:!0,secure:!0,sameSite:"Lax",maxAge:3600}),n&&se(e,"sb-refresh-token",n,{httpOnly:!0,secure:!0,sameSite:"Lax",maxAge:604800}),e.redirect("/?auth=success")}I.post("/api/auth/callback",async e=>{try{const{access_token:t,refresh_token:r}=await e.req.json();return t?(se(e,"sb-access-token",t,{httpOnly:!0,secure:!0,sameSite:"Lax",maxAge:3600}),r&&se(e,"sb-refresh-token",r,{httpOnly:!0,secure:!0,sameSite:"Lax",maxAge:604800}),e.json({success:!0})):e.json({error:"No access token"},400)}catch{return e.json({error:"Callback failed"},500)}});I.post("/api/auth/forgot-password",async e=>{try{const{email:t}=await e.req.json();if(!t)return e.json({error:"Email is required"},400);const r=e.req.header("host")||"localhost:3000",n=`${r.includes("localhost")?"http":"https"}://${r}/auth/callback`,i=await fetch(`${e.env.SUPABASE_URL}/auth/v1/recover`,{method:"POST",headers:{"Content-Type":"application/json",apikey:e.env.SUPABASE_ANON_KEY},body:JSON.stringify({email:t,options:{redirectTo:n}})});if(i.ok)return e.json({success:!0,message:"Se o email estiver cadastrado, você receberá um link de recuperação. O link é válido por 1 hora."});const o=await i.json();return e.json({error:o.error_description||"Failed to send reset email"},400)}catch{return e.json({error:"Failed to process request"},500)}});I.post("/api/auth/reset-password",async e=>{try{const t=await e.req.json(),{token:r,password:s}=t;if(console.log("🔐 Password reset attempt"),console.log("   Token present:",!!r),console.log("   Token length:",r==null?void 0:r.length),console.log("   Password length:",s==null?void 0:s.length),!r||!s)return console.error("❌ Missing token or password"),e.json({error:"Token e senha são obrigatórios"},400);if(s.length<6)return console.error("❌ Password too short"),e.json({error:"A senha deve ter pelo menos 6 caracteres"},400);console.log("📨 Calling Supabase to update password...");const n=await fetch(`${e.env.SUPABASE_URL}/auth/v1/user`,{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`,apikey:e.env.SUPABASE_ANON_KEY},body:JSON.stringify({password:s})});if(console.log("📨 Supabase response:",{status:n.status,ok:n.ok}),!n.ok){const o=await n.json();console.error("❌ Password reset failed:",o);let a="Falha ao redefinir senha";return o.error_code==="same_password"?a="A nova senha deve ser diferente da senha atual":o.msg?a=o.msg:o.error_description?a=o.error_description:o.message&&(a=o.message),e.json({error:a},400)}const i=await n.json();return console.log("✅ Password reset successful"),i.access_token&&se(e,"sb-access-token",i.access_token,{httpOnly:!0,secure:!0,sameSite:"Lax",maxAge:3600}),i.refresh_token&&se(e,"sb-refresh-token",i.refresh_token,{httpOnly:!0,secure:!0,sameSite:"Lax",maxAge:604800}),e.json({success:!0,message:"Senha alterada com sucesso!"})}catch{return e.json({error:"Failed to reset password"},500)}});async function Vr(e,t,r,s){try{return await new ro(t,r).query("users",{select:"id, email, isadmin",filters:{email:e,isadmin:!0},single:!0},s)!==null}catch(n){return console.error("Error checking admin access in Supabase users:",n),!1}}async function L(e,t){const r=$(e,"sb-access-token");if(!r)return e.json({error:"Unauthorized"},401);const s=await J(r,e.env.SUPABASE_URL,e.env.SUPABASE_ANON_KEY);if(!s)return e.json({error:"Invalid token"},401);if(!await Vr(s.email,e.env.SUPABASE_URL,e.env.SUPABASE_ANON_KEY,r))return e.json({error:"Forbidden - Admin only"},403);e.set("user",s),await t()}I.get("/api/admin/check",async e=>{const t=$(e,"sb-access-token");if(!t)return e.json({isAdmin:!1});const r=await J(t,e.env.SUPABASE_URL,e.env.SUPABASE_ANON_KEY);if(!r)return e.json({isAdmin:!1});const s=await Vr(r.email,e.env.SUPABASE_URL,e.env.SUPABASE_ANON_KEY,t);return e.json({isAdmin:s})});I.post("/api/admin/impersonate",L,async e=>{try{const{user_email:t}=await e.req.json();if(!t)return e.json({error:"user_email is required"},400);console.log(`🎭 Admin impersonating user: ${t}`);const s=await q(e).query("users",{select:"*",filters:{email:t}});if(!s||s.length===0)return e.json({error:"User not found"},404);const n=s[0],i={email:t,nome:n.nome||"Usuário",impersonated:!0,impersonated_at:new Date().toISOString(),user_id:n.id,signature:Buffer.from(`${t}:${e.env.SUPABASE_ANON_KEY}`).toString("base64")},o=`IMPERSONATE:${Buffer.from(JSON.stringify(i)).toString("base64")}`;return console.log(`✅ Impersonation token created for ${t}`),e.json({token:o,user_email:t,user_name:n.nome})}catch(t){return console.error("Impersonation error:",t),e.json({error:t.message||"Failed to impersonate user"},500)}});I.post("/api/admin/courses",L,async e=>{try{const{title:t,description:r,duration_hours:s,instructor:n,offers_certificate:i,is_published:o}=await e.req.json(),c=await q(e).insert("courses",{title:t,description:r||null,duration_hours:s||0,instructor:n||"Vicelmo",offers_certificate:i!==void 0?i:!0,is_published:o!==void 0?o:!0});return e.json({success:!0,course_id:c[0].id})}catch(t){return console.error("Create course error:",t),e.json({error:t.message||"Failed to create course"},500)}});I.put("/api/admin/courses/:id",L,async e=>{try{const t=e.req.param("id"),{title:r,description:s,duration_hours:n,instructor:i,offers_certificate:o,is_published:a}=await e.req.json();return await q(e).update("courses",{id:t},{title:r,description:s||null,duration_hours:n||0,instructor:i||"Vicelmo",offers_certificate:o!==void 0?o:!0,is_published:a!==void 0?a:!0}),e.json({success:!0})}catch{return e.json({error:"Failed to update course"},500)}});I.delete("/api/admin/courses/:id",L,async e=>{try{const t=e.req.param("id");return await q(e).delete("courses",{id:t}),e.json({success:!0})}catch{return e.json({error:"Failed to delete course"},500)}});I.get("/api/admin/courses/find",L,async e=>{try{const t=e.req.query("title");if(!t)return e.json({error:"Title is required"},400);const s=await q(e).query("courses",{select:"*",filters:{title:t},limit:1});return s&&s.length>0?e.json({course:s[0]}):e.json({course:null})}catch(t){return console.error("Find course error:",t),e.json({error:t.message||"Failed to find course"},500)}});I.post("/api/admin/modules",L,async e=>{try{const{course_id:t,title:r,description:s,order_index:n}=await e.req.json(),o=await q(e).insert("modules",{course_id:t,title:r,description:s||null,order_index:n||0});return e.json({success:!0,module_id:o[0].id})}catch(t){return console.error("Create module error:",t),e.json({error:t.message||"Failed to create module"},500)}});I.put("/api/admin/modules/:id",L,async e=>{try{const t=e.req.param("id"),{title:r,description:s,order_index:n}=await e.req.json();return await q(e).update("modules",{id:t},{title:r,description:s||null,order_index:n}),e.json({success:!0})}catch{return e.json({error:"Failed to update module"},500)}});I.delete("/api/admin/modules/:id",L,async e=>{try{const t=e.req.param("id");return await q(e).delete("modules",{id:t}),e.json({success:!0})}catch{return e.json({error:"Failed to delete module"},500)}});I.get("/api/admin/modules/find",L,async e=>{try{const t=e.req.query("course_id"),r=e.req.query("title");if(!t||!r)return e.json({error:"course_id and title are required"},400);const n=await q(e).query("modules",{select:"*",filters:{course_id:t,title:r},limit:1});return n&&n.length>0?e.json({module:n[0]}):e.json({module:null})}catch(t){return console.error("Find module error:",t),e.json({error:t.message||"Failed to find module"},500)}});I.post("/api/admin/lessons",L,async e=>{try{const{module_id:t,title:r,description:s,video_provider:n,video_id:i,duration_minutes:o,order_index:a,free_trial:c,support_text:u,transcript:l,attachments:f,rentable:d,rental_credits:p}=await e.req.json();let g=null;n&&i&&(n==="youtube"?g=`https://www.youtube.com/watch?v=${i}`:n==="vimeo"?g=`https://vimeo.com/${i}`:g=i);const v=await q(e).insert("lessons",{module_id:t,title:r,description:s||null,video_url:g,video_provider:n||null,video_id:i||null,duration_minutes:o||0,order_index:a||0,teste_gratis:c||!1,support_text:u||null,transcript:l||null,attachments:JSON.stringify(f||[]),rentable:d||!1,rental_credits:p||0});return e.json({success:!0,lesson_id:v[0].id})}catch(t){return console.error("Create lesson error:",t),e.json({error:t.message||"Failed to create lesson"},500)}});I.post("/api/admin/lessons-reorder",L,async e=>{try{const{lessons:t}=await e.req.json();if(!Array.isArray(t))return e.json({error:"lessons must be an array"},400);const r=q(e);for(const{id:s,order_index:n}of t)await r.update("lessons",{id:Number(s)},{order_index:Number(n)});return e.json({success:!0})}catch(t){return console.error("Reorder lessons error:",t),e.json({error:t.message||"Failed to reorder lessons"},500)}});I.put("/api/admin/lessons/:id",L,async e=>{try{const t=e.req.param("id"),{title:r,description:s,video_provider:n,video_id:i,duration_minutes:o,order_index:a,free_trial:c,support_text:u,transcript:l,attachments:f,rentable:d,rental_credits:p}=await e.req.json();let g=null;n&&i&&(n==="youtube"?g=`https://www.youtube.com/watch?v=${i}`:n==="vimeo"?g=`https://vimeo.com/${i}`:g=i);const b=q(e),v=parseInt(t);await b.update("lessons",{id:v},{title:r,description:s||null,video_url:g,video_provider:n||null,video_id:i||null,duration_minutes:parseInt(o)||0,order_index:parseInt(a)||0,teste_gratis:c===!0||c==="true"});try{await b.sql("UPDATE lessons SET support_text = $1, transcript = $2, attachments = $3::jsonb WHERE id = $4",[u||null,l||null,JSON.stringify(f||[]),v])}catch(h){console.warn("support_text/transcript/attachments columns may not exist:",h.message)}return await b.sql("UPDATE lessons SET rentable = $1, rental_credits = $2 WHERE id = $3",[d===!0||d==="true",parseInt(p)||0,v]),e.json({success:!0})}catch(t){return console.error("Update lesson error:",t),e.json({error:t.message||"Failed to update lesson"},500)}});I.post("/api/admin/lessons/:id/generate-transcript",L,async e=>{var t,r,s;try{const n=parseInt(e.req.param("id")),{context:i}=await e.req.json(),a=await q(e).sql("SELECT title, transcript FROM lessons WHERE id = $1",[n]);if(!a.length)return e.json({error:"Aula não encontrada"},404);const c=a[0];if(!c.transcript)return e.json({error:"Esta aula não possui transcrição para estruturar."},400);const u=e.env.VITE_OPENROUTER_API_KEY;if(!u)return e.json({error:"VITE_OPENROUTER_API_KEY não configurada no ambiente"},500);const l="Você é um especialista em direito trabalhista, liquidação de sentença judicial e uso do software PJe-Calc. Sua tarefa é pegar transcrições brutas de aulas e organizá-las em Markdown estruturado, claro e didático.",f=`Abaixo está a transcrição bruta de uma aula chamada "${c.title}".${i?`
...
---
${i}
---`,l=await fetch("https://openrouter.ai/api/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${a}`,"HTTP-Referer":"https://cct2026.com.br","X-Title":"CCT2026 Admin"},body:JSON.stringify({model:"google/gemini-2.5-flash",messages:[{role:"system",content:c},{role:"user",content:u}]})});if(!l.ok)return e.json({error:`OpenRouter: ${await l.text()}`},500);const f=await l.json();return e.json({transcript:((s=(r=(t=f.choices)==null?void 0:t[0])==null?void 0:r.message)==null?void 0:s.content)||""})}catch(n){return e.json({error:n.message},500)}});I.post("/api/admin/vimeo-transcript",L,async e=>{try{const{video_id:t}=await e.req.json();if(!t)return e.json({error:"video_id obrigatório"},400);const r=e.env.VIMEO_ACCESS_TOKEN;if(!r)return e.json({error:"VIMEO_ACCESS_TOKEN não configurada"},500);const s=String(t).replace(/^https?:\/\/(?:www\.)?vimeo\.com\//i,"").replace(/[?#].*$/,"").replace(/\/$/,""),n=await fetch(`https://api.vimeo.com/videos/${s}/texttracks?per_page=100`,{headers:{Authorization:`Bearer ${r}`,Accept:"application/vnd.vimeo.*+json;version=3.4"}});if(!n.ok)return e.json({error:`Vimeo API ${n.status}`},502);const o=(await n.json()).data||[];if(!o.length)return e.json({error:"Nenhuma legenda encontrada para este vídeo"},404);const c=[...o].sort((g,b)=>{const v=h=>{let y=0;return String(h.language||"").toLowerCase().startsWith("pt")&&(y+=40),h.active!==!1&&(y+=20),h.type==="captions"&&(y+=10),y};return v(b)-v(g)}).find(g=>g.link)||null;if(!c)return e.json({error:"Nenhuma legenda com link disponível"},404);const u=await fetch(c.link);if(!u.ok)return e.json({error:`Download da legenda falhou: ${u.status}`},502);const f=(await u.text()).replace(/^﻿/,"").split(/\r?\n/).map(g=>g.trim()),d=[];for(const g of f){if(!g||/^(WEBVTT|Kind:|Language:|NOTE|STYLE|REGION|\d+$)/.test(g)||g.includes("-->"))continue;const b=g.replace(/<[^>]+>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim();b&&d[d.length-1]!==b&&d.push(b)}const p=d.join(" ").replace(/\s+/g," ").trim();return p?e.json({transcript:p,language:c.language}):e.json({error:"Legenda encontrada mas está vazia"},404)}catch(t){return e.json({error:t.message},500)}});I.post("/api/admin/lessons/:id/whisper-transcribe",L,async e=>{var t,r,s,n;try{const i=parseInt(e.req.param("id")),o=q(e),a=await o.sql("SELECT id, title, video_provider, video_id FROM lessons WHERE id = $1",[i]);if(!a.length)return e.json({error:"Aula não encontrada"},404);const c=a[0];if(c.video_provider!=="vimeo")return e.json({error:"Esta aula não usa Vimeo como provedor"},400);if(!c.video_id||!/^\d+$/.test(c.video_id))return e.json({error:"ID do vídeo Vimeo inválido"},400);const u=((t=globalThis.process)==null?void 0:t.env)||{},l=e.env.VIMEO_ACCESS_TOKEN||u.VIMEO_ACCESS_TOKEN,f=e.env.OPENAI_API_KEY||u.OPENAI_API_KEY||u["OPENAI_API-KEY"],d=e.env.VITE_OPENROUTER_API_KEY||u.VITE_OPENROUTER_API_KEY;if(!l)return e.json({error:"VIMEO_ACCESS_TOKEN não configurado"},500);if(!f){const E=Object.keys(u).filter(N=>N.toLowerCase().includes("openai"));return e.json({error:`OPENAI_API_KEY não configurado. Chaves OPENAI encontradas: [${E.join(", ")}]`},500)}const p=await fetch(`https://api.vimeo.com/videos/${c.video_id}?fields=download`,{headers:{Authorization:`Bearer ${l}`}});if(!p.ok)return e.json({error:`Vimeo API ${p.status}`},502);const b=((await p.json()).download||[]).filter(E=>E.link&&E.size).sort((E,N)=>E.size-N.size);if(!b.length)return e.json({error:"Download não disponível para este vídeo"},400);const v=b[0],h=(v.size/1024/1024).toFixed(1),y=await fetch(v.link);if(!y.ok)return e.json({error:`Download falhou: HTTP ${y.status}`},502);let x=Buffer.from(await y.arrayBuffer()),S="video.mp4";const O=24*1024*1024;if(x.length>O){try{const E=await import("os"),N=await import("path"),D=await import("fs"),M=await import("child_process"),F=N.join(E.tmpdir(),`cct_w_${i}.mp4`),z=N.join(E.tmpdir(),`cct_w_${i}.mp3`);D.writeFileSync(F,x),M.spawnSync("ffmpeg",["-y","-i",F,"-vn","-ar","16000","-ac","1","-b:a","32k",z],{stdio:"pipe"}).status===0&&D.existsSync(z)&&(x=D.readFileSync(z),S="audio.mp3",D.unlinkSync(z)),D.unlinkSync(F)}catch{}if(x.length>O)return e.json({error:`Arquivo muito grande (${h} MB). Use o script de transcrição em lote.`},400)}const A="----WhisperBoundary"+Date.now().toString(16),m=`\r
`,_=S.endsWith(".mp3")?"audio/mpeg":"video/mp4",w=Buffer.concat([Buffer.from(`--${A}${m}Content-Disposition: form-data; name="file"; filename="${S}"${m}Content-Type: ${_}${m}${m}`),x,Buffer.from(`${m}--${A}${m}Content-Disposition: form-data; name="model"${m}${m}whisper-1`),Buffer.from(`${m}--${A}${m}Content-Disposition: form-data; name="language"${m}${m}pt`),Buffer.from(`${m}--${A}${m}Content-Disposition: form-data; name="response_format"${m}${m}text`),Buffer.from(`${m}--${A}--${m}`)]),C=await fetch("https://api.openai.com/v1/audio/transcriptions",{method:"POST",headers:{Authorization:`Bearer ${f}`,"Content-Type":`multipart/form-data; boundary=${A}`,"Content-Length":String(w.length)},body:w});if(!C.ok)return e.json({error:`OpenAI Whisper ${C.status}: ${await C.text()}`},502);let T=(await C.text()).trim(),R=null;if(d&&T){const E=`Você é um assistente especializado em cursos de PJe-Calc (cálculos trabalhistas no sistema judicial brasileiro).
...
TRANSCRIÇÃO:
${T}`,N=await fetch("https://openrouter.ai/api/v1/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${d}`,"Content-Type":"application/json"},body:JSON.stringify({model:"google/gemini-2.5-flash",messages:[{role:"user",content:E}]})});if(N.ok){const M=((n=(s=(r=(await N.json()).choices)==null?void 0:r[0])==null?void 0:s.message)==null?void 0:n.content)||"";if(M){T=M;const F=M.match(/##\s*Resumo\s*\n([\s\S]*?)(?=\n##\s|\n*$)/);F&&(R=F[1].trim())}}}return await o.sql("UPDATE lessons SET transcript = $1, description = CASE WHEN $2::text IS NOT NULL THEN $2 ELSE description END WHERE id = $3",[T,R,i]),e.json({transcript:T,description:R,sizeMB:h})}catch(i){return e.json({error:i.message},500)}});I.post("/api/admin/lessons/:id/groq-transcribe",L,async e=>{var t,r,s,n;try{const i=parseInt(e.req.param("id")),o=q(e),a=await o.sql("SELECT id, title, video_provider, video_id FROM lessons WHERE id = $1",[i]);if(!a.length)return e.json({error:"Aula não encontrada"},404);const c=a[0];if(c.video_provider!=="vimeo")return e.json({error:"Esta aula não usa Vimeo como provedor"},400);if(!c.video_id||!/^\d+$/.test(c.video_id))return e.json({error:"ID do vídeo Vimeo inválido"},400);const u=((t=globalThis.process)==null?void 0:t.env)||{},l=e.env.VIMEO_ACCESS_TOKEN||u.VIMEO_ACCESS_TOKEN,f=e.env.GROQ_API_KEY||u.GROQ_API_KEY,d=e.env.VITE_OPENROUTER_API_KEY||u.VITE_OPENROUTER_API_KEY;if(!l)return e.json({error:"VIMEO_ACCESS_TOKEN não configurado"},500);if(!f){const E=Object.keys(u).filter(N=>N.toLowerCase().includes("groq"));return e.json({error:`GROQ_API_KEY não configurado. Chaves GROQ encontradas: [${E.join(", ")}]`},500)}const p=await fetch(`https://api.vimeo.com/videos/${c.video_id}?fields=download`,{headers:{Authorization:`Bearer ${l}`}});if(!p.ok)return e.json({error:`Vimeo API ${p.status}`},502);const b=((await p.json()).download||[]).filter(E=>E.link&&E.size).sort((E,N)=>E.size-N.size);if(!b.length)return e.json({error:"Download não disponível para este vídeo"},400);const v=b[0],h=(v.size/1024/1024).toFixed(1),y=await fetch(v.link);if(!y.ok)return e.json({error:`Download falhou: HTTP ${y.status}`},502);let x=Buffer.from(await y.arrayBuffer()),S="video.mp4";const O=24*1024*1024;if(x.length>O){try{const E=await import("os"),N=await import("path"),D=await import("fs"),M=await import("child_process"),F=N.join(E.tmpdir(),`cct_g_${i}.mp4`),z=N.join(E.tmpdir(),`cct_g_${i}.mp3`);D.writeFileSync(F,x),M.spawnSync("ffmpeg",["-y","-i",F,"-vn","-ar","16000","-ac","1","-b:a","32k",z],{stdio:"pipe"}).status===0&&D.existsSync(z)&&(x=D.readFileSync(z),S="audio.mp3",D.unlinkSync(z)),D.unlinkSync(F)}catch{}if(x.length>O)return e.json({error:`Arquivo muito grande (${h} MB). Use o script de transcrição em lote.`},400)}const A="----GroqBoundary"+Date.now().toString(16),m=`\r
`,_=S.endsWith(".mp3")?"audio/mpeg":"video/mp4",w=Buffer.concat([Buffer.from(`--${A}${m}Content-Disposition: form-data; name="file"; filename="${S}"${m}Content-Type: ${_}${m}${m}`),x,Buffer.from(`${m}--${A}${m}Content-Disposition: form-data; name="model"${m}${m}whisper-large-v3-turbo`),Buffer.from(`${m}--${A}${m}Content-Disposition: form-data; name="language"${m}${m}pt`),Buffer.from(`${m}--${A}${m}Content-Disposition: form-data; name="response_format"${m}${m}text`),Buffer.from(`${m}--${A}--${m}`)]),C=await fetch("https://api.groq.com/openai/v1/audio/transcriptions",{method:"POST",headers:{Authorization:`Bearer ${f}`,"Content-Type":`multipart/form-data; boundary=${A}`,"Content-Length":String(w.length)},body:w});if(!C.ok)return e.json({error:`Groq Whisper ${C.status}: ${await C.text()}`},502);let T=(await C.text()).trim(),R=null;if(d&&T){const E=`Você é um assistente especializado em cursos de PJe-Calc (cálculos trabalhistas no sistema judicial brasileiro).
...
TRANSCRIÇÃO:
${T}`,N=await fetch("https://openrouter.ai/api/v1/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${d}`,"Content-Type":"application/json"},body:JSON.stringify({model:"google/gemini-2.5-flash",messages:[{role:"user",content:E}]})});if(N.ok){const M=((n=(s=(r=(await N.json()).choices)==null?void 0:r[0])==null?void 0:s.message)==null?void 0:n.content)||"";if(M){T=M;const F=M.match(/##\s*Resumo\s*\n([\s\S]*?)(?=\n##\s|\n*$)/);F&&(R=F[1].trim())}}}return await o.sql("UPDATE lessons SET transcript = $1, description = CASE WHEN $2::text IS NOT NULL THEN $2 ELSE description END WHERE id = $3",[T,R,i]),e.json({transcript:T,description:R,sizeMB:h})}catch(i){return e.json({error:i.message},500)}});I.delete("/api/admin/lessons/:id",L,async e=>{try{const t=e.req.param("id");return await q(e).delete("lessons",{id:t}),e.json({success:!0})}catch{return e.json({error:"Failed to delete lesson"},500)}});I.post("/api/lessons/:id/rent",Y,async e=>{try{const t=parseInt(e.req.param("id")),s=e.get("user").email,n=q(e);await Hr(n);const i=await n.sql("SELECT id, title, rentable, rental_credits FROM lessons WHERE id = $1",[t]);if(!i.length||!i[0].rentable)return e.json({error:"Esta aula não está disponível para aluguel"},400);const o=i[0],a=parseInt(o.rental_credits);if(!Number.isFinite(a)||a<=0)return e.json({error:"Créditos de aluguel inválidos para esta aula"},400);const c=await n.sql("SELECT expires_at FROM lesson_rentals WHERE user_email = $1 AND lesson_id = $2 AND expires_at > NOW()",[s,t]);if(c.length>0)return e.json({error:"Você já possui acesso ativo a esta aula",expires_at:c[0].expires_at},400);const u=e.env.DATABASE_URL_CREDITOS||e.env.DATABASE_SUITEPLUS;console.log("Credits DB configured:",!!u,"| prefix:",u==null?void 0:u.substring(0,30));const l=ti(e),f=await Br(l,s);if(f<a)return e.json({error:"Créditos insuficientes",available:f,required:a},400);if(!await Po(l,s,a)){const p=await Br(l,s);return e.json({error:"Créditos insuficientes",available:p,required:a},400)}return await n.sql(`INSERT INTO lesson_rentals (user_email, lesson_id, credits_paid, rented_at, expires_at)
       VALUES ($1, $2, $3, NOW(), NOW() + INTERVAL '30 days')
       ON CONFLICT (user_email, lesson_id)
       DO UPDATE SET credits_paid = $3, rented_at = NOW(), expires_at = NOW() + INTERVAL '30 days'`,[s,t,a]),e.json({success:!0,message:"Aula alugada com sucesso! Acesso liberado por 30 dias."})}catch(t){return console.error("Rent lesson error:",t),e.json({error:t.message||"Erro ao processar aluguel"},500)}});I.get("/api/user/rentals",Y,async e=>{try{const t=e.get("user"),r=q(e);await Hr(r);const s=await r.sql(`SELECT lr.id, lr.lesson_id, lr.credits_paid, lr.rented_at, lr.expires_at,
       ...
       ORDER BY lr.expires_at DESC`,[t.email]);return e.json({rentals:s})}catch(t){return console.error("Get rentals error:",t),e.json({error:t.message||"Erro ao buscar aluguéis"},500)}});async function Re(e){await e.sql(`
  ...
  `),await e.sql("CREATE INDEX IF NOT EXISTS idx_trail_lessons_trail ON trail_lessons(trail_id)"),await e.sql("CREATE INDEX IF NOT EXISTS idx_trail_lessons_lesson ON trail_lessons(lesson_id)")}I.get("/api/trails",Y,async e=>{try{const t=e.get("user"),r=q(e);await Re(r);const s=await r.sql(`
      SELECT t.*,
    ...
    `,[t.email]);return e.json({trails:s})}catch(t){return console.error("Get trails error:",t),e.json({error:t.message||"Erro ao buscar trilhas"},500)}});I.get("/api/trails/:id",Y,async e=>{try{const t=e.req.param("id"),r=e.get("user"),s=q(e);await Re(s);const n=await s.sql("SELECT * FROM trails WHERE id = $1",[t]);if(!n.length)return e.json({error:"Trilha não encontrada"},404);const i=n[0],o=await s.sql(`
    ...
    `,[t,r.email]);return e.json({trail:i,lessons:o})}catch(t){return console.error("Get trail error:",t),e.json({error:t.message||"Erro ao buscar trilha"},500)}});I.get("/api/admin/trails",L,async e=>{try{const t=q(e);await Re(t);const r=await t.sql(`
      SELECT t.*, COUNT(tl.id)::int AS lessons_count
      FROM trails t
      LEFT JOIN trail_lessons tl ON tl.trail_id = t.id
      GROUP BY t.id
      ORDER BY t.order_index ASC, t.created_at DESC
    `);return e.json({trails:r})}catch(t){return e.json({error:t.message},500)}});I.post("/api/admin/trails",L,async e=>{try{const{title:t,description:r,is_published:s,order_index:n}=await e.req.json();if(!t)return e.json({error:"title is required"},400);const i=q(e);await Re(i);const o=await i.insert("trails",{title:t,description:r||null,is_published:s??!1,order_index:n??0});return e.json({success:!0,trail_id:o[0].id,trail:o[0]})}catch(t){return e.json({error:t.message},500)}});I.put("/api/admin/trails/:id",L,async e=>{try{const t=parseInt(e.req.param("id")),r=await e.req.json(),s=q(e);await Re(s);const n=["title","description","is_published","order_index"],i={updated_at:new Date().toISOString()};for(const o of n)o in r&&(i[o]=r[o]);return await s.update("trails",{id:t},i),e.json({success:!0})}catch(t){return e.json({error:t.message},500)}});I.delete("/api/admin/trails/:id",L,async e=>{try{const t=parseInt(e.req.param("id")),r=q(e);return await Re(r),await r.delete("trails",{id:t}),e.json({success:!0})}catch(t){return e.json({error:t.message},500)}});I.post("/api/admin/trails/:id/lessons",L,async e=>{var t;try{const r=parseInt(e.req.param("id")),{lesson_id:s}=await e.req.json();if(!s)return e.json({error:"lesson_id required"},400);const n=q(e);await Re(n);const o=(((t=(await n.sql("SELECT COALESCE(MAX(order_index), -1) AS max_idx FROM trail_lessons WHERE trail_id = $1",[r]))[0])==null?void 0:t.max_idx)??-1)+1;return await n.sql("INSERT INTO trail_lessons (trail_id, lesson_id, order_index) VALUES ($1, $2, $3) ON CONFLICT (trail_id, lesson_id) DO NOTHING",[r,s,o]),e.json({success:!0})}catch(r){return e.json({error:r.message},500)}});I.delete("/api/admin/trails/:id/lessons/:lessonId",L,async e=>{try{const t=parseInt(e.req.param("id")),r=parseInt(e.req.param("lessonId"));return await q(e).sql("DELETE FROM trail_lessons WHERE trail_id = $1 AND lesson_id = $2",[t,r]),e.json({success:!0})}catch(t){return e.json({error:t.message},500)}});I.post("/api/admin/trails/:id/reorder",L,async e=>{try{const t=parseInt(e.req.param("id")),{lessons:r}=await e.req.json();if(!Array.isArray(r))return e.json({error:"lessons array required"},400);const s=q(e);for(const n of r)await s.sql("UPDATE trail_lessons SET order_index = $1 WHERE trail_id = $2 AND lesson_id = $3",[n.order_index,t,n.lesson_id]);return e.json({success:!0})}catch(t){return e.json({error:t.message},500)}});I.get("/api/admin/trails/search-lessons",L,async e=>{try{const t=e.req.query("q")||"",r=e.req.query("course_id"),s=q(e),n=r?`AND co.id = ${parseInt(r)}`:"",i=t?"AND (l.title ILIKE $1)":"",o=t?[`%${t}%`]:[],a=await s.sql(`
      ...
      LIMIT 50
    `,o);return e.json({lessons:a})}catch(t){return e.json({error:t.message},500)}});I.get("/api/admin/lessons/find",L,async e=>{try{const t=e.req.query("module_id"),r=e.req.query("title");if(!t||!r)return e.json({error:"module_id and title are required"},400);const n=await q(e).query("lessons",{select:"*",filters:{module_id:t,title:r},limit:1});return n&&n.length>0?e.json({lesson:n[0]}):e.json({lesson:null})}catch(t){return console.error("Find lesson error:",t),e.json({error:t.message||"Failed to find lesson"},500)}});function Qr(e,t){const r=Array.isArray(e.alternatives)?e.alternatives:[],s=Array.isArray(e.tags)?e.tags:String(e.tags||"").split(",").map(n=>n.trim()).filter(Boolean);return{title:e.title||null,statement_html:e.statement_html||"",question_type:e.question_type||"multiple_choice",alternatives:JSON.stringify(r),answer_key:JSON.stringify(e.answer_key||{}),technical_comment_html:e.technical_comment_html||null,difficulty:e.difficulty||"medio",theme:e.theme||null,subtheme:e.subtheme||null,legal_basis:e.legal_basis||null,weight:Number(e.weight||1),estimated_minutes:parseInt(e.estimated_minutes)||5,tags:JSON.stringify(s),status:e.status||"draft",professor:e.professor||null,course_id:e.course_id?parseInt(e.course_id):null,lesson_id:e.lesson_id?parseInt(e.lesson_id):null,source_transcript:e.source_transcript||null,ai_generated:e.ai_generated===!0||e.ai_generated==="true",order_index:parseInt(e.order_index)||0,usage_count:parseInt(e.usage_count)||0,attempts_count:parseInt(e.attempts_count)||0,correct_count:parseInt(e.correct_count)||0,wrong_count:parseInt(e.wrong_count)||0,created_by:t||e.created_by||null}}I.get("/api/admin/questions",L,async e=>{try{const t=q(e);await ie(t);const r=[],s=[];let n=1;const i=(h,y)=>{r.push(h.replace("?",`$${n++}`)),s.push(y)},o=e.req.query("q"),a=e.req.query("theme"),c=e.req.query("professor"),u=e.req.query("course_id"),l=e.req.query("difficulty"),f=e.req.query("question_type"),d=e.req.query("status"),p=e.req.query("from"),g=e.req.query("to");o&&(r.push(`(title ILIKE $${n} OR statement_html ILIKE $${n+1} OR legal_basis ILIKE $${n+2})`),s.push(`%${o}%`,`%${o}%`,`%${o}%`),n+=3),a&&i("theme = ?",a),c&&i("professor = ?",c),u&&i("course_id = ?",parseInt(u)),l&&i("difficulty = ?",l),f&&i("question_type = ?",f),d&&i("status = ?",d),p&&i("created_at >= ?",p),g&&i("created_at <= ?",g);const b=r.length?`WHERE ${r.join(" AND ")}`:"",v=await t.sql(`
      SELECT q.*,
      ...
      LIMIT 500
    `,s);return e.json({questions:v})}catch(t){return console.error("List questions error:",t),e.json({error:t.message||"Failed to list questions"},500)}});I.get("/api/admin/questions/stats",L,async e=>{try{const t=q(e);await ie(t);const r=await t.sql(`
      SELECT
        COUNT(*)::int AS total,
      ...
      FROM question_bank
    `),s=await t.sql("SELECT id, title, wrong_count, attempts_count FROM question_bank ORDER BY wrong_count DESC, attempts_count DESC LIMIT 5"),n=await t.sql("SELECT id, title, usage_count FROM question_bank ORDER BY usage_count DESC LIMIT 5");return e.json({stats:r[0]||{},mostWrong:s,mostUsed:n})}catch(t){return e.json({error:t.message},500)}});I.get("/api/admin/questions/:id/versions",L,async e=>{try{const t=q(e);await ie(t);const r=await t.sql("SELECT * FROM question_bank_versions WHERE question_id = $1 ORDER BY version DESC, created_at DESC",[parseInt(e.req.param("id"))]);return e.json({versions:r})}catch(t){return e.json({error:t.message},500)}});I.post("/api/admin/questions",L,async e=>{try{const t=e.get("user"),r=q(e);await ie(r);const s=Qr(await e.req.json(),t==null?void 0:t.email),i=(await r.sql(`
    ...
    `,[o.title,o.statement_html,o.question_type,o.alternatives,o.answer_key,o.technical_comment_html,o.difficulty,o.theme,o.subtheme,o.legal_basis,o.weight,o.estimated_minutes,o.tags,o.status,o.professor,o.course_id,o.lesson_id,o.source_transcript,o.ai_generated,o.order_index,o.usage_count,o.attempts_count,o.correct_count,o.wrong_count,a,r]);return await s.sql("INSERT INTO question_bank_versions (question_id, version, snapshot, changed_by, change_note) VALUES ($1, $2, $3::jsonb, $4, $5)",[r,a,JSON.stringify(c[0]),(t==null?void 0:t.email)||null,"Edicao manual"]),e.json({success:!0,question:c[0]})}catch(t){return console.error("Update question error:",t),e.json({error:t.message||"Failed to update question"},500)}});I.post("/api/admin/questions/:id/duplicate",L,async e=>{try{const t=e.get("user"),r=parseInt(e.req.param("id")),s=q(e);await ie(s);const n=await s.sql("SELECT * FROM question_bank WHERE id = $1",[r]);if(!n.length)return e.json({error:"Question not found"},404);const i=n[0],o=await s.sql(`
      ...
      RETURNING *
    `,[`${i.title||"Questao"} (copia)`,i.statement_html,i.question_type,JSON.stringify(i.alternatives||[]),JSON.stringify(i.answer_key||{}),i.technical_comment_html,i.difficulty,i.theme,i.subtheme,i.legal_basis,i.weight,i.estimated_minutes,JSON.stringify(i.tags||[]),i.professor,i.course_id,i.lesson_id,i.source_transcript,i.ai_generated,i.order_index+1,(t==null?void 0:t.email)||null]);return e.json({success:!0,question:o[0]})}catch(t){return e.json({error:t.message},500)}});I.delete("/api/admin/questions/:id",L,async e=>{try{const t=q(e);return await ie(t),await t.sql("DELETE FROM question_bank WHERE id = $1",[parseInt(e.req.param("id"))]),e.json({success:!0})}catch(t){return e.json({error:t.message},500)}});I.post("/api/admin/questions-reorder",L,async e=>{try{const{questions:t}=await e.req.json();if(!Array.isArray(t))return e.json({error:"questions must be an array"},400);const r=q(e);await ie(r);for(const s of t)await r.sql("UPDATE question_bank SET order_index = $1, updated_at = NOW() WHERE id = $2",[parseInt(s.order_index),parseInt(s.id)]);return e.json({success:!0})}catch(t){return e.json({error:t.message},500)}});I.post("/api/admin/questions/import",L,async e=>{try{const{questions:t}=await e.req.json();if(!Array.isArray(t))return e.json({error:"questions array required"},400);const r=e.get("user"),s=q(e);await ie(s);let n=0;for(const i of t){const o=Qr(i,r==null?void 0:r.email);await s.sql(`
        INSERT INTO question_bank (
          title, statement_html, question_type, alternatives, answer_key, technical_comment_html,
          difficulty, theme, subtheme, legal_basis, weight, estimated_minutes, tags, status,
          professor, course_id, lesson_id, source_transcript, ai_generated, order_index, created_by
...
---
${f.slice(0,24e3)}
---`,b=await fetch("https://openrouter.ai/api/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${p}`,"HTTP-Referer":"https://cct2026.com.br","X-Title":"CCT2026 Admin"},body:JSON.stringify({model:"google/gemini-2.5-flash",messages:[{role:"system",content:"Voce e especialista em direito do trabalho, calculos trabalhistas, PJe-Calc e avaliacao educacional. Responda apenas JSON valido."},{role:"user",content:g}],response_format:{type:"json_object"}})});if(!b.ok)return e.json({error:`OpenRouter: ${await b.text()}`},500);const h=((s=(r=(t=(await b.json()).choices)==null?void 0:t[0])==null?void 0:r.message)==null?void 0:s.content)||'{"questions":[]}',x=(JSON.parse(h).questions||[]).map(S=>({...S,lesson_id:(d==null?void 0:d.id)||n||null,course_id:(d==null?void 0:d.course_id)||null,professor:(d==null?void 0:d.instructor)||null,source_transcript:f,ai_generated:!0,status:"review"}));return e.json({questions:x})}catch(n){return console.error("Generate questions error:",n),e.json({error:n.message||"Erro ao gerar questoes"},500)}});I.post("/api/admin/run-migration-lesson-fields",L,async e=>{try{const t=q(e);return await t.sql("ALTER TABLE lessons ADD COLUMN IF NOT EXISTS support_text TEXT"),await t.sql("ALTER TABLE lessons ADD COLUMN IF NOT EXISTS transcript TEXT"),await t.sql("ALTER TABLE lessons ADD COLUMN IF NOT EXISTS attachments JSONB DEFAULT '[]'::jsonb"),await Hr(t),e.json({success:!0,message:"Migration applied successfully"})}catch(t){return console.error("Migration error:",t),e.json({error:t.message},500)}});I.get("/api/admin/users",L,async e=>{try{const r=await q(e).query("users",{select:"*",order:"created_at DESC"});return e.json({users:r})}catch(t){return console.error("Get users error:",t),e.json({error:t.message||"Failed to fetch users"},500)}});I.get("/api/admin/users/find",L,async e=>{try{const t=e.req.query("email");if(!t)return e.json({error:"Email is required"},400);const s=await q(e).query("users",{select:"*",filters:{email:t},limit:1});return s&&s.length>0?e.json({user:s[0]}):e.json({user:null})}catch(t){return console.error("Find user error:",t),e.json({error:t.message||"Failed to find user"},500)}});I.post("/api/admin/users",L,async e=>{try{const t=await e.req.json();if(!t.email)return e.json({error:"Email is required"},400);const s=await q(e).insert("users",{email:t.email,nome:t.nome||null,first_name:t.first_name||null,last_name:t.last_name||null,cpf:t.cpf||null,telefone:t.telefone||null,whatsapp:t.whatsapp||null,foto:t.foto||null,end_cep:t.end_cep||null,end_logradouro:t.end_logradouro||null,end_numero:t.end_numero||null,end_cidade:t.end_cidade||null,end_estado:t.end_estado||null,ativo:t.ativo!==void 0?t.ativo:!0,teste_gratis:t.teste_gratis||!1,dt_expiracao:t.dt_expiracao||null});return e.json({success:!0,user_id:s[0].id})}catch(t){return console.error("Create user error:",t),e.json({error:t.message||"Failed to create user"},500)}});I.put("/api/admin/users/:id",L,async e=>{try{const t=e.req.param("id"),r=await e.req.json();return await q(e).update("users",{id:t},{nome:r.nome,first_name:r.first_name,last_name:r.last_name,cpf:r.cpf,telefone:r.telefone,whatsapp:r.whatsapp,foto:r.foto,end_cep:r.end_cep,end_logradouro:r.end_logradouro,end_numero:r.end_numero,end_cidade:r.end_cidade,end_estado:r.end_estado,ativo:r.ativo,teste_gratis:r.teste_gratis,dt_expiracao:r.dt_expiracao,updated_at:new Date().toISOString()}),e.json({success:!0})}catch(t){return console.error("Update user error:",t),e.json({error:t.message||"Failed to update user"},500)}});I.delete("/api/admin/users/:id",L,async e=>{try{const t=e.req.param("id");return await q(e).delete("users",{id:t}),e.json({success:!0})}catch(t){return console.error("Delete user error:",t),e.json({error:t.message||"Failed to delete user"},500)}});I.get("/api/admin/certificates",L,async e=>{try{const r=await q(e).query("certificates",{select:"*",order:"created_at DESC"});return e.json({certificates:r||[]})}catch(t){return console.error("List certificates error:",t),e.json({error:t.message||"Failed to list certificates"},500)}});I.get("/api/admin/certificates/:id",L,async e=>{try{const t=e.req.param("id"),s=await q(e).query("certificates",{select:"*",filters:{id:t}});return!s||s.length===0?e.json({error:"Certificate not found"},404):e.json({certificate:s[0]})}catch(t){return console.error("Get certificate error:",t),e.json({error:t.message||"Failed to get certificate"},500)}});I.get("/api/admin/certificates/find",L,async e=>{try{const t=e.req.query("email"),r=e.req.query("course");if(!t||!r)return e.json({error:"Email and course parameters are required"},400);const n=await q(e).query("certificates",{select:"*",filters:{user_email:t,course_title:r}});return e.json({certificates:n||[]})}catch(t){return console.error("Find certificate error:",t),e.json({error:t.message||"Failed to find certificate"},500)}});I.post("/api/admin/certificates",L,async e=>{try{const t=await e.req.json();if(!t.user_email||!t.course_title)return e.json({error:"Email and course title are required"},400);const r=q(e),s=new Date().toISOString(),n=await r.insert("certificates",{user_email:t.user_email,user_name:t.user_name||"Aluno",course_id:t.course_id||null,course_title:t.course_title,issued_at:t.issued_at||s,completion_date:t.completion_date||s,carga_horaria:t.carga_horaria||null,certificate_code:t.certificate_code||null,generated_at:t.generated_at||null});return e.json({success:!0,certificate_id:n&&n.length>0?n[0].id:null})}catch(t){return console.error("Create certificate error:",t),e.json({error:t.message||"Failed to create certificate"},500)}});I.put("/api/admin/certificates/:id",L,async e=>{try{const t=e.req.param("id"),r=await e.req.json(),s=q(e);let n=r.course_title;if(r.course_id){const i=await s.query("courses",{select:"title",filters:{id:r.course_id}});i&&i.length>0&&(n=i[0].title)}return await s.update("certificates",{id:t},{user_email:r.user_email,user_name:r.user_name,course_id:r.course_id,course_title:n,carga_horaria:r.carga_horaria,updated_at:new Date().toISOString()}),e.json({success:!0})}catch(t){return console.error("Update certificate error:",t),e.json({error:t.message||"Failed to update certificate"},500)}});I.delete("/api/admin/certificates/:id",L,async e=>{try{const t=e.req.param("id");return await q(e).delete("certificates",{id:t}),e.json({success:!0})}catch(t){return console.error("Delete certificate error:",t),e.json({error:t.message||"Failed to delete certificate"},500)}});function Io(e){const t=!!e.templateImageUrl,r=!!e.versoImageUrl,s=e.modules&&e.modules.length>0;if(t){const u=s?e.modules.map((f,d)=>`<div class="mod-item"><span class="mod-num">${String(d+1).padStart(2,"0")}.</span> ${f}</div>`).join(""):"",l=r?`
...
<body>
  ...
  <div class="page">
    ...
    <div class="logo-section">
      <img class="logo-img" src="${ts}" alt="Ensino Plus"/>
    </div>
...
<body>
  ...
  <script>window.onload=function(){document.querySelectorAll('.qr-wrap svg').forEach(function(s){s.setAttribute('width','60');s.setAttribute('height','60');})}<\/script>
    ...
    `)}catch(t){return console.error("Verify certificate error:",t),e.json({error:t.message||"Failed to verify certificate"},500)}});I.get("/api/verify/:code",async e=>{try{const t=e.req.param("code"),r=q(e),s=await r.query("certificates",{select:"*",filters:{certificate_code:t}});if(!s||s.length===0)return e.json({valid:!1,message:"Certificate not found"},404);const n=s[0];try{await r.update("certificates",{id:n.id},{verification_count:(n.verification_count||0)+1})}catch{}return e.json({valid:!0,certificate:{student_name:n.user_name,course_title:n.course_title,workload:n.carga_horaria,completion_date:n.completion_date,issued_at:n.issued_at,certificate_code:n.certificate_code,verification_count:(n.verification_count||0)+1}})}catch(t){return console.error("Verify certificate API error:",t),e.json({error:t.message||"Failed to verify certificate"},500)}});I.get("/api/admin/member-subscriptions",L,async e=>{try{const r=await q(e).query("member_subscriptions",{select:"*",order:"created_at DESC"});return e.json({subscriptions:r||[]})}catch(t){return console.error("List member subscriptions error:",t),e.json({error:t.message||"Failed to list member subscriptions"},500)}});I.get("/api/admin/suiteplus-subscriptions",L,async e=>{try{const t=e.env.DATABASE_SUITEPLUS;if(!t)return e.json({error:"DATABASE_SUITEPLUS não configurada"},500);const s=await new wt(t).sql(`SELECT id, user_email, product_id, started_at, expires_at, status, payment_source, recurring_enabled
       FROM user_subscriptions
       ORDER BY expires_at DESC`);return e.json({subscriptions:s})}catch(t){return console.error("SuitePlus subscriptions error:",t),e.json({error:t.message||"Erro ao buscar assinaturas SuitePlus"},500)}});I.get("/api/admin/member-subscriptions/find",L,async e=>{try{const t=e.req.query("email");if(!t)return e.json({error:"Email parameter is required"},400);const s=await q(e).query("member_subscriptions",{select:"*",filters:{email_membro:t}});return e.json({subscriptions:s||[]})}catch(t){return console.error("Find member subscription error:",t),e.json({error:t.message||"Failed to find member subscription"},500)}});I.post("/api/admin/member-subscriptions",L,async e=>{try{const t=await e.req.json();if(!t.email_membro)return e.json({error:"Email is required"},400);const s=await q(e).insert("member_subscriptions",{email_membro:t.email_membro,data_expiracao:t.data_expiracao||null,detalhe:t.detalhe||null,origem:t.origem||null,teste_gratis:t.teste_gratis||!1,ativo:t.ativo!==void 0?t.ativo:!0});return e.json({success:!0,subscription_id:s&&s.length>0?s[0].id:null})}catch(t){return console.error("Create member subscription error:",t),e.json({error:t.message||"Failed to create member subscription"},500)}});I.put("/api/admin/member-subscriptions/:id",L,async e=>{try{const t=e.req.param("id"),r=await e.req.json();return await q(e).update("member_subscriptions",{id:t},{email_membro:r.email_membro,data_expiracao:r.data_expiracao,detalhe:r.detalhe,origem:r.origem,teste_gratis:r.teste_gratis,ativo:r.ativo,updated_at:new Date().toISOString()}),e.json({success:!0})}catch(t){return console.error("Update member subscription error:",t),e.json({error:t.message||"Failed to update member subscription"},500)}});I.delete("/api/admin/member-subscriptions/:id",L,async e=>{try{const t=e.req.param("id");return await q(e).delete("member_subscriptions",{id:t}),e.json({success:!0})}catch(t){return console.error("Delete user error:",t),e.json({error:t.message||"Failed to delete user"},500)}});I.get("/api/courses",async e=>{try{const t=q(e),r=$(e,"sb-access-token");let s=!1;if(r){const a=await J(r,e.env.SUPABASE_URL,e.env.SUPABASE_ANON_KEY);a&&(s=await Vr(a.email,e.env.SUPABASE_URL,e.env.SUPABASE_ANON_KEY,r))}const n=s?{}:{is_published:!0},i=s?"":"WHERE c.is_published = true",o=await t.sql(`
      SELECT c.*,
...
<body class="bg-gray-100 p-8">
  ...
  `));I.get("/admin",e=>e.html(`<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`)});I.get("/api/favorites",Y,async e=>{const t=e.get("user"),r=q(e);try{const s=await r.sql(`
...
<body class="bg-gray-50">
  ...
  `));const Is=new Gn,No=Object.assign({"/src/index.tsx":I});let si=!1;for(const[,e]of Object.entries(No))e&&(Is.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Is.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),si=!0);if(!si)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");var nr={exports:{}},ir={exports:{}},Oe={},or={},Ns;function ni(){if(Ns)return or;Ns=1,or.parse=function(r,s){return new e(r,s).parse()};class e{constructor(s,n){this.source=s,this.transform=n||t,this.position=0,this.entries=[],this.recorded=[],this.dimension=0}isEof(){return this.position>=this.source.length}nextCharacter(){var s=this.source[this.position++];return s==="\\"?{value:this.source[this.position++],escaped:!0}:{value:s,escaped:!1}}record(s){this.recorded.push(s)}newEntry(s){var n;(this.recorded.length>0||s)&&(n=this.recorded.join(""),n==="NULL"&&!s&&(n=null),n!==null&&(n=this.transform(n)),this.entries.push(n),this.recorded=[])}consumeDimensions(){if(this.source[0]==="[")for(;!this.isEof();){var s=this.nextCharacter();if(s.value==="=")break}}parse(s){var n,i,o;for(this.consumeDimensions();!this.isEof();)if(n=this.nextCharacter(),n.value==="{"&&!o)this.dimension++,this.dimension>1&&(i=new e(this.source.substr(this.position-1),this.transform),this.entries.push(i.parse(!0)),this.position+=i.position-2);else if(n.value==="}"&&!o){if(this.dimension--,!this.dimension&&(this.newEntry(),s))return this.entries}else n.value==='"'&&!n.escaped?(o&&this.newEntry(!0),o=!o):n.value===","&&!o?this.newEntry():this.record(n.value);if(this.dimension!==0)throw new Error("array dimension not balanced");return this.entries}}function t(r){return r}return or}var ar,qs;function ii(){if(qs)return ar;qs=1;var e=ni();return ar={create:function(t,r){return{parse:function(){return e.parse(t,r)}}}},ar}var lr,Os;function qo(){if(Os)return lr;Os=1;var e=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,t=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,r=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,s=/^-?infinity$/;lr=function(u){if(s.test(u))return Number(u.replace("i","I"));var l=e.exec(u);if(!l)return n(u)||null;var f=!!l[8],d=parseInt(l[1],10);f&&(d=o(d));var p=parseInt(l[2],10)-1,g=l[3],b=parseInt(l[4],10),v=parseInt(l[5],10),h=parseInt(l[6],10),y=l[7];y=y?1e3*parseFloat(y):0;var x,S=i(u);return S!=null?(x=new Date(Date.UTC(d,p,g,b,v,h,y)),a(d)&&x.setUTCFullYear(d),S!==0&&x.setTime(x.getTime()-S)):(x=new Date(d,p,g,b,v,h,y),a(d)&&x.setFullYear(d)),x};function n(c){var u=t.exec(c);if(u){var l=parseInt(u[1],10),f=!!u[4];f&&(l=o(l));var d=parseInt(u[2],10)-1,p=u[3],g=new Date(l,d,p);return a(l)&&g.setFullYear(l),g}}function i(c){if(c.endsWith("+00"))return 0;var u=r.exec(c.split(" ")[1]);if(u){var l=u[1];if(l==="Z")return 0;var f=l==="-"?-1:1,d=parseInt(u[2],10)*3600+parseInt(u[3]||0,10)*60+parseInt(u[4]||0,10);return d*f*1e3}}function o(c){return-(c-1)}function a(c){return c>=0&&c<100}return lr}var cr,Ls;function Oo(){if(Ls)return cr;Ls=1,cr=t;var e=Object.prototype.hasOwnProperty;function t(r){for(var s=1;s<arguments.length;s++){var n=arguments[s];for(var i in n)e.call(n,i)&&(r[i]=n[i])}return r}return cr}var ur,Ds;function Lo(){if(Ds)return ur;Ds=1;var e=Oo();ur=t;function t(v){if(!(this instanceof t))return new t(v);e(this,b(v))}var r=["seconds","minutes","hours","days","months","years"];t.prototype.toPostgres=function(){var v=r.filter(this.hasOwnProperty,this);return this.milliseconds&&v.indexOf("seconds")<0&&v.push("seconds"),v.length===0?"0":v.map(function(h){var y=this[h]||0;return h==="seconds"&&this.milliseconds&&(y=(y+this.milliseconds/1e3).toFixed(6).replace(/\.?0+$/,"")),y+" "+h},this).join(" ")};var s={years:"Y",months:"M",days:"D",hours:"H",minutes:"M",seconds:"S"},n=["years","months","days"],i=["hours","minutes","seconds"];t.prototype.toISOString=t.prototype.toISO=function(){var v=n.map(y,this).join(""),h=i.map(y,this).join("");return"P"+v+"T"+h;function y(x){var S=this[x]||0;return x==="seconds"&&this.milliseconds&&(S=(S+this.milliseconds/1e3).toFixed(6).replace(/0+$/,"")),S+s[x]}};var o="([+-]?\\d+)",a=o+"\\s+years?",c=o+"\\s+mons?",u=o+"\\s+days?",l="([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",f=new RegExp([a,c,u,l].map(function(v){return"("+v+")?"}).join("\\s*")),d={years:2,months:4,days:6,hours:9,minutes:10,seconds:11,milliseconds:12},p=["hours","minutes","seconds","milliseconds"];function g(v){var h=v+"000000".slice(v.length);return parseInt(h,10)/1e3}function b(v){if(!v)return{};var h=f.exec(v),y=h[8]==="-";return Object.keys(d).reduce(function(x,S){var O=d[S],A=h[O];return!A||(A=S==="milliseconds"?g(A):parseInt(A,10),!A)||(y&&~p.indexOf(S)&&(A*=-1),x[S]=A),x},{})}return ur}var dr,js;function Do(){if(js)return dr;js=1;var e=Buffer.from||Buffer;return dr=function(r){if(/^\\x/.test(r))return e(r.substr(2),"hex");for(var s="",n=0;n<r.length;)if(r[n]!=="\\")s+=r[n],++n;else if(/[0-7]{3}/.test(r.substr(n+1,3)))s+=String.fromCharCode(parseInt(r.substr(n+1,3),8)),n+=4;else{for(var i=1;n+i<r.length&&r[n+i]==="\\";)i++;for(var o=0;o<Math.floor(i/2);++o)s+="\\";n+=Math.floor(i/2)*2}return e(s,"binary")},dr}var fr,ks;function jo(){if(ks)return fr;ks=1;var e=ni(),t=ii(),r=qo(),s=Lo(),n=Do();function i(m){return function(w){return w===null?w:m(w)}}function o(m){return m===null?m:m==="TRUE"||m==="t"||m==="true"||m==="y"||m==="yes"||m==="on"||m==="1"}function a(m){return m?e.parse(m,o):null}function c(m){return parseInt(m,10)}function u(m){return m?e.parse(m,i(c)):null}function l(m){return m?e.parse(m,i(function(_){return y(_).trim()})):null}var f=function(m){if(!m)return null;var _=t.create(m,function(w){return w!==null&&(w=S(w)),w});return _.parse()},d=function(m){if(!m)return null;var _=t.create(m,function(w){return w!==null&&(w=parseFloat(w)),w});return _.parse()},p=function(m){if(!m)return null;var _=t.create(m);return _.parse()},g=function(m){if(!m)return null;var _=t.create(m,function(w){return w!==null&&(w=r(w)),w});return _.parse()},b=function(m){if(!m)return null;var _=t.create(m,function(w){return w!==null&&(w=s(w)),w});return _.parse()},v=function(m){return m?e.parse(m,i(n)):null},h=function(m){return parseInt(m,10)},y=function(m){var _=String(m);return/^\d+$/.test(_)?_:m},x=function(m){return m?e.parse(m,i(JSON.parse)):null},S=function(m){return m[0]!=="("?null:(m=m.substring(1,m.length-1).split(","),{x:parseFloat(m[0]),y:parseFloat(m[1])})},O=function(m){if(m[0]!=="<"&&m[1]!=="(")return null;for(var _="(",w="",C=!1,T=2;T<m.length-1;T++){if(C||(_+=m[T]),m[T]===")"){C=!0;continue}else if(!C)continue;m[T]!==","&&(w+=m[T])}var R=S(_);return R.radius=parseFloat(w),R},A=function(m){m(20,y),m(21,h),m(23,h),m(26,h),m(700,parseFloat),m(701,parseFloat),m(16,o),m(1082,r),m(1114,r),m(1184,r),m(600,S),m(651,p),m(718,O),m(1e3,a),m(1001,v),m(1005,u),m(1007,u),m(1028,u),m(1016,l),m(1017,f),m(1021,d),m(1022,d),m(1231,d),m(1014,p),m(1015,p),m(1008,p),m(1009,p),m(1040,p),m(1041,p),m(1115,g),m(1182,g),m(1185,g),m(1186,s),m(1187,b),m(17,n),m(114,JSON.parse.bind(JSON)),m(3802,JSON.parse.bind(JSON)),m(199,x),m(3807,x),m(3907,p),m(2951,p),m(791,p),m(1183,p),m(1270,p)};return fr={init:A},fr}var pr,Bs;function ko(){if(Bs)return pr;Bs=1;var e=1e6;function t(r){var s=r.readInt32BE(0),n=r.readUInt32BE(4),i="";s<0&&(s=~s+(n===0),n=~n+1>>>0,i="-");var o="",a,c,u,l,f,d;{if(a=s%e,s=s/e>>>0,c=4294967296*a+n,n=c/e>>>0,u=""+(c-e*n),n===0&&s===0)return i+u+o;for(l="",f=6-u.length,d=0;d<f;d++)l+="0";o=l+u+o}{if(a=s%e,s=s/e>>>0,c=4294967296*a+n,n=c/e>>>0,u=""+(c-e*n),n===0&&s===0)return i+u+o;for(l="",f=6-u.length,d=0;d<f;d++)l+="0";o=l+u+o}{if(a=s%e,s=s/e>>>0,c=4294967296*a+n,n=c/e>>>0,u=""+(c-e*n),n===0&&s===0)return i+u+o;for(l="",f=6-u.length,d=0;d<f;d++)l+="0";o=l+u+o}return a=s%e,c=4294967296*a+n,u=""+c%e,i+u+o}return pr=t,pr}var hr,Ms;function Bo(){if(Ms)return hr;Ms=1;var e=ko(),t=function(p,g,b,v,h){b=b||0,v=v||!1,h=h||function(C,T,R){return C*Math.pow(2,R)+T};var y=b>>3,x=function(C){return v?~C&255:C},S=255,O=8-b%8;g<O&&(S=255<<8-g&255,O=g),b&&(S=S>>b%8);var A=0;b%8+g>=8&&(A=h(0,x(p[y])&S,O));for(var m=g+b>>3,_=y+1;_<m;_++)A=h(A,x(p[_]),8);var w=(g+b)%8;return w>0&&(A=h(A,x(p[m])>>8-w,w)),A},r=function(p,g,b){var v=Math.pow(2,b-1)-1,h=t(p,1),y=t(p,b,1);if(y===0)return 0;var x=1,S=function(A,m,_){A===0&&(A=1);for(var w=1;w<=_;w++)x/=2,(m&1<<_-w)>0&&(A+=x);return A},O=t(p,g,b+1,!1,S);return y==Math.pow(2,b+1)-1?O===0?h===0?1/0:-1/0:NaN:(h===0?1:-1)*Math.pow(2,y-v)*O},s=function(p){return t(p,1)==1?-1*(t(p,15,1,!0)+1):t(p,15,1)},n=function(p){return t(p,1)==1?-1*(t(p,31,1,!0)+1):t(p,31,1)},i=function(p){return r(p,23,8)},o=function(p){return r(p,52,11)},a=function(p){var g=t(p,16,32);if(g==49152)return NaN;for(var b=Math.pow(1e4,t(p,16,16)),v=0,h=t(p,16),y=0;y<h;y++)v+=t(p,16,64+16*y)*b,b/=1e4;var x=Math.pow(10,t(p,16,48));return(g===0?1:-1)*Math.round(v*x)/x},c=function(p,g){var b=t(g,1),v=t(g,63,1),h=new Date((b===0?1:-1)*v/1e3+9466848e5);return p||h.setTime(h.getTime()+h.getTimezoneOffset()*6e4),h.usec=v%1e3,h.getMicroSeconds=function(){return this.usec},h.setMicroSeconds=function(y){this.usec=y},h.getUTCMicroSeconds=function(){return this.usec},h},u=function(p){var g=t(p,32);t(p,32,32);for(var b=t(p,32,64),v=96,h=[],y=0;y<g;y++)h[y]=t(p,32,v),v+=32,v+=32;var x=function(O){var A=t(p,32,v);if(v+=32,A==4294967295)return null;var m;if(O==23||O==20)return m=t(p,A*8,v),v+=A*8,m;if(O==25)return m=p.toString(this.encoding,v>>3,(v+=A<<3)>>3),m;console.log("ERROR: ElementType not implemented: "+O)},S=function(O,A){var m=[],_;if(O.length>1){var w=O.shift();for(_=0;_<w;_++)m[_]=S(O,A);O.unshift(w)}else for(_=0;_<O[0];_++)m[_]=x(A);return m};return S(h,b)},l=function(p){return p.toString("utf8")},f=function(p){return p===null?null:t(p,8)>0},d=function(p){p(20,e),p(21,s),p(23,n),p(26,n),p(1700,a),p(700,i),p(701,o),p(16,f),p(1114,c.bind(null,!1)),p(1184,c.bind(null,!0)),p(1e3,u),p(1007,u),p(1016,u),p(1008,u),p(1009,u),p(25,l)};return hr={init:d},hr}var mr,Us;function Mo(){return Us||(Us=1,mr={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,OID:26,TID:27,XID:28,CID:29,JSON:114,XML:142,PG_NODE_TREE:194,SMGR:210,PATH:602,POLYGON:604,CIDR:650,FLOAT4:700,FLOAT8:701,ABSTIME:702,RELTIME:703,TINTERVAL:704,CIRCLE:718,MACADDR8:774,MONEY:790,MACADDR:829,INET:869,ACLITEM:1033,BPCHAR:1042,VARCHAR:1043,DATE:1082,TIME:1083,TIMESTAMP:1114,TIMESTAMPTZ:1184,INTERVAL:1186,TIMETZ:1266,BIT:1560,VARBIT:1562,NUMERIC:1700,REFCURSOR:1790,REGPROCEDURE:2202,REGOPER:2203,REGOPERATOR:2204,REGCLASS:2205,REGTYPE:2206,UUID:2950,TXID_SNAPSHOT:2970,PG_LSN:3220,PG_NDISTINCT:3361,PG_DEPENDENCIES:3402,TSVECTOR:3614,TSQUERY:3615,GTSVECTOR:3642,REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}),mr}var Fs;function xt(){if(Fs)return Oe;Fs=1;var e=jo(),t=Bo(),r=ii(),s=Mo();Oe.getTypeParser=o,Oe.setTypeParser=a,Oe.arrayParser=r,Oe.builtins=s;var n={text:{},binary:{}};function i(c){return String(c)}function o(c,u){return u=u||"text",n[u]&&n[u][c]||i}function a(c,u,l){typeof u=="function"&&(l=u,u="text"),n[u][c]=l}return e.init(function(c,u){n.text[c]=u}),t.init(function(c,u){n.binary[c]=u}),Oe}var Hs;function Et(){return Hs||(Hs=1,(function(e){var t={};let r;try{r=process.platform==="win32"?t.USERNAME:t.USER}catch{}e.exports={host:"localhost",user:r,database:void 0,password:null,connectionString:void 0,port:5432,rows:0,binary:!1,max:10,idleTimeoutMillis:3e4,client_encoding:"",ssl:!1,application_name:void 0,fallback_application_name:void 0,options:void 0,parseInputDatesAsUTC:!1,statement_timeout:!1,lock_timeout:!1,idle_in_transaction_session_timeout:!1,query_timeout:!1,connect_timeout:0,keepalives:1,keepalives_idle:0};const s=xt(),n=s.getTypeParser(20,"text"),i=s.getTypeParser(1016,"text");e.exports.__defineSetter__("parseInt8",function(o){s.setTypeParser(20,"text",o?s.getTypeParser(23,"text"):n),s.setTypeParser(1016,"text",o?s.getTypeParser(1007,"text"):i)})})(ir)),ir.exports}var gr,zs;function Ze(){if(zs)return gr;zs=1;const e=Et(),t=He,{isDate:r}=t.types||t;function s(d){return'"'+d.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'}function n(d){let p="{";for(let g=0;g<d.length;g++)if(g>0&&(p=p+","),d[g]===null||typeof d[g]>"u")p=p+"NULL";else if(Array.isArray(d[g]))p=p+n(d[g]);else if(ArrayBuffer.isView(d[g])){let b=d[g];if(!(b instanceof Buffer)){const v=Buffer.from(b.buffer,b.byteOffset,b.byteLength);v.length===b.byteLength?b=v:b=v.slice(b.byteOffset,b.byteOffset+b.byteLength)}p+="\\\\x"+b.toString("hex")}else p+=s(i(d[g]));return p=p+"}",p}const i=function(d,p){if(d==null)return null;if(typeof d=="object"){if(d instanceof Buffer)return d;if(ArrayBuffer.isView(d)){const g=Buffer.from(d.buffer,d.byteOffset,d.byteLength);return g.length===d.byteLength?g:g.slice(d.byteOffset,d.byteOffset+d.byteLength)}return r(d)?e.parseInputDatesAsUTC?c(d):a(d):Array.isArray(d)?n(d):o(d,p)}return d.toString()};function o(d,p){if(d&&typeof d.toPostgres=="function"){if(p=p||[],p.indexOf(d)!==-1)throw new Error('circular reference detected while preparing "'+d+'" for query');return p.push(d),i(d.toPostgres(i),p)}return JSON.stringify(d)}function a(d){let p=-d.getTimezoneOffset(),g=d.getFullYear();const b=g<1;b&&(g=Math.abs(g)+1);let v=String(g).padStart(4,"0")+"-"+String(d.getMonth()+1).padStart(2,"0")+"-"+String(d.getDate()).padStart(2,"0")+"T"+String(d.getHours()).padStart(2,"0")+":"+String(d.getMinutes()).padStart(2,"0")+":"+String(d.getSeconds()).padStart(2,"0")+"."+String(d.getMilliseconds()).padStart(3,"0");return p<0?(v+="-",p*=-1):v+="+",v+=String(Math.floor(p/60)).padStart(2,"0")+":"+String(p%60).padStart(2,"0"),b&&(v+=" BC"),v}function c(d){let p=d.getUTCFullYear();const g=p<1;g&&(p=Math.abs(p)+1);let b=String(p).padStart(4,"0")+"-"+String(d.getUTCMonth()+1).padStart(2,"0")+"-"+String(d.getUTCDate()).padStart(2,"0")+"T"+String(d.getUTCHours()).padStart(2,"0")+":"+String(d.getUTCMinutes()).padStart(2,"0")+":"+String(d.getUTCSeconds()).padStart(2,"0")+"."+String(d.getUTCMilliseconds()).padStart(3,"0");return b+="+00:00",g&&(b+=" BC"),b}function u(d,p,g){return d=typeof d=="string"?{text:d}:d,p&&(typeof p=="function"?d.callback=p:d.values=p),g&&(d.callback=g),d}return gr={prepareValue:function(p){return i(p)},normalizeQueryConfig:u,escapeIdentifier:function(d){return'"'+d.replace(/"/g,'""')+'"'},escapeLiteral:function(d){let p=!1,g="'";if(d==null||typeof d!="string")return"''";for(let b=0;b<d.length;b++){const v=d[b];v==="'"?g+=v+v:v==="\\"?(g+=v+v,p=!0):g+=v}return g+="'",p===!0&&(g=" E"+g),g}},gr}var ct={exports:{}},br,Vs;function Uo(){if(Vs)return br;Vs=1;const e=Rn;function t(a){return e.createHash("md5").update(a,"utf-8").digest("hex")}function r(a,c,u){const l=t(c+a);return"md5"+t(Buffer.concat([Buffer.from(l),u]))}function s(a){return e.createHash("sha256").update(a).digest()}function n(a,c){return a=a.replace(/(\D)-/,"$1"),e.createHash(a).update(c).digest()}function i(a,c){return e.createHmac("sha256",a).update(c).digest()}async function o(a,c,u){return e.pbkdf2Sync(a,c,u,32,"sha256")}return br={postgresMd5PasswordHash:r,randomBytes:e.randomBytes,deriveKey:o,sha256:s,hashByName:n,hmacSha256:i,md5:t},br}var yr,Qs;function Fo(){if(Qs)return yr;Qs=1;const e=Rn;yr={postgresMd5PasswordHash:o,randomBytes:n,deriveKey:l,sha256:a,hashByName:c,hmacSha256:u,md5:i};const t=e.webcrypto||globalThis.crypto,r=t.subtle,s=new TextEncoder;function n(f){return t.getRandomValues(Buffer.alloc(f))}async function i(f){try{return e.createHash("md5").update(f,"utf-8").digest("hex")}catch{const p=typeof f=="string"?s.encode(f):f,g=await r.digest("MD5",p);return Array.from(new Uint8Array(g)).map(b=>b.toString(16).padStart(2,"0")).join("")}}async function o(f,d,p){const g=await i(d+f);return"md5"+await i(Buffer.concat([Buffer.from(g),p]))}async function a(f){return await r.digest("SHA-256",f)}async function c(f,d){return await r.digest(f,d)}async function u(f,d){const p=await r.importKey("raw",f,{name:"HMAC",hash:"SHA-256"},!1,["sign"]);return await r.sign("HMAC",p,s.encode(d))}async function l(f,d,p){const g=await r.importKey("raw",s.encode(f),"PBKDF2",!1,["deriveBits"]),b={name:"PBKDF2",hash:"SHA-256",salt:d,iterations:p};return await r.deriveBits(b,g,256,["deriveBits"])}return yr}var Xs;function oi(){return Xs||(Xs=1,parseInt(process.versions&&process.versions.node&&process.versions.node.split(".")[0])<15?ct.exports=Uo():ct.exports=Fo()),ct.exports}var vr,Ws;function Ho(){if(Ws)return vr;Ws=1;function e(i,o){return new Error("SASL channel binding: "+i+" when parsing public certificate "+o.toString("base64"))}function t(i,o){let a=i[o++];if(a<128)return{length:a,index:o};const c=a&127;if(c>4)throw e("bad length",i);a=0;for(let u=0;u<c;u++)a=a<<8|i[o++];return{length:a,index:o}}function r(i,o){if(i[o++]!==6)throw e("non-OID data",i);const{length:a,index:c}=t(i,o);o=c;const u=o+a,l=i[o++];let f=(l/40>>0)+"."+l%40;for(;o<u;){let d=0;for(;o<u;){const p=i[o++];if(d=d<<7|p&127,p<128)break}f+="."+d}return{oid:f,index:o}}function s(i,o){if(i[o++]!==48)throw e("non-sequence data",i);return t(i,o)}function n(i,o){o===void 0&&(o=0),o=s(i,o).index;const{length:a,index:c}=s(i,o);o=c+a,o=s(i,o).index;const{oid:u,index:l}=r(i,o);switch(u){case"1.2.840.113549.1.1.4":return"MD5";case"1.2.840.113549.1.1.5":return"SHA-1";case"1.2.840.113549.1.1.11":return"SHA-256";case"1.2.840.113549.1.1.12":return"SHA-384";case"1.2.840.113549.1.1.13":return"SHA-512";case"1.2.840.113549.1.1.14":return"SHA-224";case"1.2.840.113549.1.1.15":return"SHA512-224";case"1.2.840.113549.1.1.16":return"SHA512-256";case"1.2.840.10045.4.1":return"SHA-1";case"1.2.840.10045.4.3.1":return"SHA-224";case"1.2.840.10045.4.3.2":return"SHA-256";case"1.2.840.10045.4.3.3":return"SHA-384";case"1.2.840.10045.4.3.4":return"SHA-512";case"1.2.840.113549.1.1.10":{if(o=l,o=s(i,o).index,i[o++]!==160)throw e("non-tag data",i);o=t(i,o).index,o=s(i,o).index;const{oid:f}=r(i,o);switch(f){case"1.2.840.113549.2.5":return"MD5";case"1.3.14.3.2.26":return"SHA-1";case"2.16.840.1.101.3.4.2.1":return"SHA-256";case"2.16.840.1.101.3.4.2.2":return"SHA-384";case"2.16.840.1.101.3.4.2.3":return"SHA-512"}throw e("unknown hash OID "+f,i)}case"1.3.101.110":case"1.3.101.112":return"SHA-512";case"1.3.101.111":case"1.3.101.113":throw e("Ed448 certificate channel binding is not currently supported by Postgres")}throw e("unknown OID "+u,i)}return vr={signatureAlgorithmHashFromCertificate:n},vr}var wr,$s;function zo(){if($s)return wr;$s=1;const e=oi(),{signatureAlgorithmHashFromCertificate:t}=Ho();function r(f,d){const p=["SCRAM-SHA-256"];d&&p.unshift("SCRAM-SHA-256-PLUS");const g=p.find(h=>f.includes(h));if(!g)throw new Error("SASL: Only mechanism(s) "+p.join(" and ")+" are supported");if(g==="SCRAM-SHA-256-PLUS"&&typeof d.getPeerCertificate!="function")throw new Error("SASL: Mechanism SCRAM-SHA-256-PLUS requires a certificate");const b=e.randomBytes(18).toString("base64");return{mechanism:g,clientNonce:b,response:(g==="SCRAM-SHA-256-PLUS"?"p=tls-server-end-point":d?"y":"n")+",,n=*,r="+b,message:"SASLInitialResponse"}}async function s(f,d,p,g){if(f.message!=="SASLInitialResponse")throw new Error("SASL: Last message was not SASLInitialResponse");if(typeof d!="string")throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: client password must be a string");if(d==="")throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: client password must be a non-empty string");if(typeof p!="string")throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: serverData must be a string");const b=c(p);if(b.nonce.startsWith(f.clientNonce)){if(b.nonce.length===f.clientNonce.length)throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce is too short")}else throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce does not start with client nonce");const v="n=*,r="+f.clientNonce,h="r="+b.nonce+",s="+b.salt+",i="+b.iteration;let y=g?"eSws":"biws";if(f.mechanism==="SCRAM-SHA-256-PLUS"){const E=g.getPeerCertificate().raw;let N=t(E);(N==="MD5"||N==="SHA-1")&&(N="SHA-256");const D=await e.hashByName(N,E);y=Buffer.concat([Buffer.from("p=tls-server-end-point,,"),Buffer.from(D)]).toString("base64")}const x="c="+y+",r="+b.nonce,S=v+","+h+","+x,O=Buffer.from(b.salt,"base64"),A=await e.deriveKey(d,O,b.iteration),m=await e.hmacSha256(A,"Client Key"),_=await e.sha256(m),w=await e.hmacSha256(_,S),C=l(Buffer.from(m),Buffer.from(w)).toString("base64"),T=await e.hmacSha256(A,"Server Key"),R=await e.hmacSha256(T,S);f.message="SASLResponse",f.serverSignature=Buffer.from(R).toString("base64"),f.response=x+",p="+C}function n(f,d){if(f.message!=="SASLResponse")throw new Error("SASL: Last message was not SASLResponse");if(typeof d!="string")throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: serverData must be a string");const{serverSignature:p}=u(d);if(p!==f.serverSignature)throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature does not match")}function i(f){if(typeof f!="string")throw new TypeError("SASL: text must be a string");return f.split("").map((d,p)=>f.charCodeAt(p)).every(d=>d>=33&&d<=43||d>=45&&d<=126)}function o(f){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.test(f)}function a(f){if(typeof f!="string")throw new TypeError("SASL: attribute pairs text must be a string");return new Map(f.split(",").map(d=>{if(!/^.=/.test(d))throw new Error("SASL: Invalid attribute pair entry");const p=d[0],g=d.substring(2);return[p,g]}))}function c(f){const d=a(f),p=d.get("r");if(p){if(!i(p))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: nonce must only contain printable characters")}else throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: nonce missing");const g=d.get("s");if(g){if(!o(g))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: salt must be base64")}else throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: salt missing");const b=d.get("i");if(b){if(!/^[1-9][0-9]*$/.test(b))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: invalid iteration count")}else throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: iteration missing");const v=parseInt(b,10);return{nonce:p,salt:g,iteration:v}}function u(f){const p=a(f).get("v");if(p){if(!o(p))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature is missing");return{serverSignature:p}}function l(f,d){if(!Buffer.isBuffer(f))throw new TypeError("first argument must be a Buffer");if(!Buffer.isBuffer(d))throw new TypeError("second argument must be a Buffer");if(f.length!==d.length)throw new Error("Buffer lengths must match");if(f.length===0)throw new Error("Buffers cannot be empty");return Buffer.from(f.map((p,g)=>f[g]^d[g]))}return wr={startSession:r,continueSession:s,finalizeSession:n},wr}var xr,Gs;function Xr(){if(Gs)return xr;Gs=1;const e=xt();function t(r){this._types=r||e,this.text={},this.binary={}}return t.prototype.getOverrides=function(r){switch(r){case"text":return this.text;case"binary":return this.binary;default:return{}}},t.prototype.setTypeParser=function(r,s,n){typeof s=="function"&&(n=s,s="text"),this.getOverrides(s)[r]=n},t.prototype.getTypeParser=function(r,s){return s=s||"text",this.getOverrides(s)[r]||this._types.getTypeParser(r,s)},xr=t,xr}var Er,Js;function Vo(){if(Js)return Er;Js=1;function e(i,o={}){if(i.charAt(0)==="/"){const p=i.split(" ");return{host:p[0],database:p[1]}}const a={};let c,u=!1;/ |%[^a-f0-9]|%[a-f0-9][^a-f0-9]/i.test(i)&&(i=encodeURI(i).replace(/%25(\d\d)/g,"%$1"));try{try{c=new URL(i,"postgres://base")}catch{c=new URL(i.replace("@/","@___DUMMY___/"),"postgres://base"),u=!0}}catch(p){throw p.input&&(p.input="*****REDACTED*****"),p}for(const p of c.searchParams.entries())a[p[0]]=p[1];if(a.user=a.user||decodeURIComponent(c.username),a.password=a.password||decodeURIComponent(c.password),c.protocol=="socket:")return a.host=decodeURI(c.pathname),a.database=c.searchParams.get("db"),a.client_encoding=c.searchParams.get("encoding"),a;const l=u?"":c.hostname;a.host?l&&/^%2f/i.test(l)&&(c.pathname=l+c.pathname):a.host=decodeURIComponent(l),a.port||(a.port=c.port);const f=c.pathname.slice(1)||null;a.database=f?decodeURI(f):null,(a.ssl==="true"||a.ssl==="1")&&(a.ssl=!0),a.ssl==="0"&&(a.ssl=!1),(a.sslcert||a.sslkey||a.sslrootcert||a.sslmode)&&(a.ssl={});const d=a.sslcert||a.sslkey||a.sslrootcert?In:null;if(a.sslcert&&(a.ssl.cert=d.readFileSync(a.sslcert).toString()),a.sslkey&&(a.ssl.key=d.readFileSync(a.sslkey).toString()),a.sslrootcert&&(a.ssl.ca=d.readFileSync(a.sslrootcert).toString()),o.useLibpqCompat&&a.uselibpqcompat)throw new Error("Both useLibpqCompat and uselibpqcompat are set. Please use only one of them.");if(a.uselibpqcompat==="true"||o.useLibpqCompat)switch(a.sslmode){case"disable":{a.ssl=!1;break}case"prefer":{a.ssl.rejectUnauthorized=!1;break}case"require":{a.sslrootcert?a.ssl.checkServerIdentity=function(){}:a.ssl.rejectUnauthorized=!1;break}case"verify-ca":{if(!a.ssl.ca)throw new Error("SECURITY WARNING: Using sslmode=verify-ca requires specifying a CA with sslrootcert. If a public CA is used, verify-ca allows connections to a server that somebody else may have registered with the CA, making you vulnerable to Man-in-the-Middle attacks. Either specify a custom CA certificate with sslrootcert parameter or use sslmode=verify-full for proper security.");a.ssl.checkServerIdentity=function(){};break}}else switch(a.sslmode){case"disable":{a.ssl=!1;break}case"prefer":case"require":case"verify-ca":case"verify-full":{a.sslmode!=="verify-full"&&n(a.sslmode);break}case"no-verify":{a.ssl.rejectUnauthorized=!1;break}}return a}function t(i){return Object.entries(i).reduce((a,[c,u])=>(u!=null&&(a[c]=u),a),{})}function r(i){return Object.entries(i).reduce((a,[c,u])=>{if(c==="ssl"){const l=u;typeof l=="boolean"&&(a[c]=l),typeof l=="object"&&(a[c]=t(l))}else if(u!=null)if(c==="port"){if(u!==""){const l=parseInt(u,10);if(isNaN(l))throw new Error(`Invalid ${c}: ${u}`);a[c]=l}}else a[c]=u;return a},{})}function s(i){return r(e(i))}function n(i){!n.warned&&typeof process<"u"&&process.emitWarning&&(n.warned=!0,process.emitWarning(`SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
...
See https://www.postgresql.org/docs/current/libpq-ssl.html for libpq SSL mode definitions.`))}return Er=e,e.parse=e,e.toClientConfig=r,e.parseIntoClientConfig=s,Er}var _r,Ys;function ai(){if(Ys)return _r;Ys=1;var e={};const t=gi,r=Et(),s=Vo().parse,n=function(u,l,f){return l[u]?l[u]:(f===void 0?f=e["PG"+u.toUpperCase()]:f===!1||(f=e[f]),f||r[u])},i=function(){switch(e.PGSSLMODE){case"disable":return!1;case"prefer":case"require":case"verify-ca":case"verify-full":return!0;case"no-verify":return{rejectUnauthorized:!1}}return r.ssl},o=function(u){return"'"+(""+u).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},a=function(u,l,f){const d=l[f];d!=null&&u.push(f+"="+o(d))};class c{constructor(l){l=typeof l=="string"?s(l):l||{},l.connectionString&&(l=Object.assign({},l,s(l.connectionString))),this.user=n("user",l),this.database=n("database",l),this.database===void 0&&(this.database=this.user),this.port=parseInt(n("port",l),10),this.host=n("host",l),Object.defineProperty(this,"password",{configurable:!0,enumerable:!1,writable:!0,value:n("password",l)}),this.binary=n("binary",l),this.options=n("options",l),this.ssl=typeof l.ssl>"u"?i():l.ssl,typeof this.ssl=="string"&&this.ssl==="true"&&(this.ssl=!0),this.ssl==="no-verify"&&(this.ssl={rejectUnauthorized:!1}),this.ssl&&this.ssl.key&&Object.defineProperty(this.ssl,"key",{enumerable:!1}),this.client_encoding=n("client_encoding",l),this.replication=n("replication",l),this.isDomainSocket=!(this.host||"").indexOf("/"),this.application_name=n("application_name",l,"PGAPPNAME"),this.fallback_application_name=n("fallback_application_name",l,!1),this.statement_timeout=n("statement_timeout",l,!1),this.lock_timeout=n("lock_timeout",l,!1),this.idle_in_transaction_session_timeout=n("idle_in_transaction_session_timeout",l,!1),this.query_timeout=n("query_timeout",l,!1),l.connectionTimeoutMillis===void 0?this.connect_timeout=e.PGCONNECT_TIMEOUT||0:this.connect_timeout=Math.floor(l.connectionTimeoutMillis/1e3),l.keepAlive===!1?this.keepalives=0:l.keepAlive===!0&&(this.keepalives=1),typeof l.keepAliveInitialDelayMillis=="number"&&(this.keepalives_idle=Math.floor(l.keepAliveInitialDelayMillis/1e3))}getLibpqConnectionString(l){const f=[];a(f,this,"user"),a(f,this,"password"),a(f,this,"port"),a(f,this,"application_name"),a(f,this,"fallback_application_name"),a(f,this,"connect_timeout"),a(f,this,"options");const d=typeof this.ssl=="object"?this.ssl:this.ssl?{sslmode:this.ssl}:{};if(a(f,d,"sslmode"),a(f,d,"sslca"),a(f,d,"sslkey"),a(f,d,"sslcert"),a(f,d,"sslrootcert"),this.database&&f.push("dbname="+o(this.database)),this.replication&&f.push("replication="+o(this.replication)),this.host&&f.push("host="+o(this.host)),this.isDomainSocket)return l(null,f.join(" "));this.client_encoding&&f.push("client_encoding="+o(this.client_encoding)),t.lookup(this.host,function(p,g){return p?l(p,null):(f.push("hostaddr="+o(g)),l(null,f.join(" ")))})}}return _r=c,_r}var Sr,Ks;function li(){if(Ks)return Sr;Ks=1;const e=xt(),t=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/;class r{constructor(n,i){this.command=null,this.rowCount=null,this.oid=null,this.rows=[],this.fields=[],this._parsers=void 0,this._types=i,this.RowCtor=null,this.rowAsArray=n==="array",this.rowAsArray&&(this.parseRow=this._parseRowAsArray),this._prebuiltEmptyResultObject=null}addCommandComplete(n){let i;n.text?i=t.exec(n.text):i=t.exec(n.command),i&&(this.command=i[1],i[3]?(this.oid=parseInt(i[2],10),this.rowCount=parseInt(i[3],10)):i[2]&&(this.rowCount=parseInt(i[2],10)))}_parseRowAsArray(n){const i=new Array(n.length);for(let o=0,a=n.length;o<a;o++){const c=n[o];c!==null?i[o]=this._parsers[o](c):i[o]=null}return i}parseRow(n){const i={...this._prebuiltEmptyResultObject};for(let o=0,a=n.length;o<a;o++){const c=n[o],u=this.fields[o].name;if(c!==null){const l=this.fields[o].format==="binary"?Buffer.from(c):c;i[u]=this._parsers[o](l)}else i[u]=null}return i}addRow(n){this.rows.push(n)}addFields(n){this.fields=n,this.fields.length&&(this._parsers=new Array(n.length));const i={};for(let o=0;o<n.length;o++){const a=n[o];i[a.name]=null,this._types?this._parsers[o]=this._types.getTypeParser(a.dataTypeID,a.format||"text"):this._parsers[o]=e.getTypeParser(a.dataTypeID,a.format||"text")}this._prebuiltEmptyResultObject={...i}}}return Sr=r,Sr}var Ar,Zs;function Qo(){if(Zs)return Ar;Zs=1;const{EventEmitter:e}=ze,t=li(),r=Ze();class s extends e{constructor(i,o,a){super(),i=r.normalizeQueryConfig(i,o,a),this.text=i.text,this.values=i.values,this.rows=i.rows,this.types=i.types,this.name=i.name,this.queryMode=i.queryMode,this.binary=i.binary,this.portal=i.portal||"",this.callback=i.callback,this._rowMode=i.rowMode,process.domain&&i.callback&&(this.callback=process.domain.bind(i.callback)),this._result=new t(this._rowMode,this.types),this._results=this._result,this._canceledDueToError=!1}requiresPreparation(){return this.queryMode==="extended"||this.name||this.rows?!0:!this.text||!this.values?!1:this.values.length>0}_checkForMultirow(){this._result.command&&(Array.isArray(this._results)||(this._results=[this._result]),this._result=new t(this._rowMode,this._result._types),this._results.push(this._result))}handleRowDescription(i){this._checkForMultirow(),this._result.addFields(i.fields),this._accumulateRows=this.callback||!this.listeners("row").length}handleDataRow(i){let o;if(!this._canceledDueToError){try{o=this._result.parseRow(i.fields)}catch(a){this._canceledDueToError=a;return}this.emit("row",o,this._result),this._accumulateRows&&this._result.addRow(o)}}handleCommandComplete(i,o){this._checkForMultirow(),this._result.addCommandComplete(i),this.rows&&o.sync()}handleEmptyQuery(i){this.rows&&i.sync()}handleError(i,o){if(this._canceledDueToError&&(i=this._canceledDueToError,this._canceledDueToError=!1),this.callback)return this.callback(i);this.emit("error",i)}handleReadyForQuery(i){if(this._canceledDueToError)return this.handleError(this._canceledDueToError,i);if(this.callback)try{this.callback(null,this._results)}catch(o){process.nextTick(()=>{throw o})}this.emit("end",this._results)}submit(i){if(typeof this.text!="string"&&typeof this.name!="string")return new Error("A query must have either text or a name. Supplying neither is unsupported.");const o=i.parsedStatements[this.name];if(this.text&&o&&this.text!==o)return new Error(`Prepared statements must be unique - '${this.name}' was used for a different statement`);if(this.values&&!Array.isArray(this.values))return new Error("Query values must be an array");if(this.requiresPreparation()){i.stream.cork&&i.stream.cork();try{this.prepare(i)}finally{i.stream.uncork&&i.stream.uncork()}}else i.query(this.text);return null}hasBeenParsed(i){return this.name&&i.parsedStatements[this.name]}handlePortalSuspended(i){this._getRows(i,this.rows)}_getRows(i,o){i.execute({portal:this.portal,rows:o}),o?i.flush():i.sync()}prepare(i){this.hasBeenParsed(i)||i.parse({text:this.text,name:this.name,types:this.types});try{i.bind({portal:this.portal,statement:this.name,values:this.values,binary:this.binary,valueMapper:r.prepareValue})}catch(o){this.handleError(o,i);return}i.describe({type:"P",name:this.portal||""}),this._getRows(i,this.rows)}handleCopyInResponse(i){i.sendCopyFail("No source stream defined")}handleCopyData(i,o){}}return Ar=s,Ar}var Cr={},B={},en;function ci(){if(en)return B;en=1,Object.defineProperty(B,"__esModule",{value:!0}),B.NoticeMessage=B.DataRowMessage=B.CommandCompleteMessage=B.ReadyForQueryMessage=B.NotificationResponseMessage=B.BackendKeyDataMessage=B.AuthenticationMD5Password=B.ParameterStatusMessage=B.ParameterDescriptionMessage=B.RowDescriptionMessage=B.Field=B.CopyResponse=B.CopyDataMessage=B.DatabaseError=B.copyDone=B.emptyQuery=B.replicationStart=B.portalSuspended=B.noData=B.closeComplete=B.bindComplete=B.parseComplete=void 0,B.parseComplete={name:"parseComplete",length:5},B.bindComplete={name:"bindComplete",length:5},B.closeComplete={name:"closeComplete",length:5},B.noData={name:"noData",length:5},B.portalSuspended={name:"portalSuspended",length:5},B.replicationStart={name:"replicationStart",length:4},B.emptyQuery={name:"emptyQuery",length:4},B.copyDone={name:"copyDone",length:4};class e extends Error{constructor(b,v,h){super(b),this.length=v,this.name=h}}B.DatabaseError=e;class t{constructor(b,v){this.length=b,this.chunk=v,this.name="copyData"}}B.CopyDataMessage=t;class r{constructor(b,v,h,y){this.length=b,this.name=v,this.binary=h,this.columnTypes=new Array(y)}}B.CopyResponse=r;class s{constructor(b,v,h,y,x,S,O){this.name=b,this.tableID=v,this.columnID=h,this.dataTypeID=y,this.dataTypeSize=x,this.dataTypeModifier=S,this.format=O}}B.Field=s;class n{constructor(b,v){this.length=b,this.fieldCount=v,this.name="rowDescription",this.fields=new Array(this.fieldCount)}}B.RowDescriptionMessage=n;class i{constructor(b,v){this.length=b,this.parameterCount=v,this.name="parameterDescription",this.dataTypeIDs=new Array(this.parameterCount)}}B.ParameterDescriptionMessage=i;class o{constructor(b,v,h){this.length=b,this.parameterName=v,this.parameterValue=h,this.name="parameterStatus"}}B.ParameterStatusMessage=o;class a{constructor(b,v){this.length=b,this.salt=v,this.name="authenticationMD5Password"}}B.AuthenticationMD5Password=a;class c{constructor(b,v,h){this.length=b,this.processID=v,this.secretKey=h,this.name="backendKeyData"}}B.BackendKeyDataMessage=c;class u{constructor(b,v,h,y){this.length=b,this.processId=v,this.channel=h,this.payload=y,this.name="notification"}}B.NotificationResponseMessage=u;class l{constructor(b,v){this.length=b,this.status=v,this.name="readyForQuery"}}B.ReadyForQueryMessage=l;class f{constructor(b,v){this.length=b,this.text=v,this.name="commandComplete"}}B.CommandCompleteMessage=f;class d{constructor(b,v){this.length=b,this.fields=v,this.name="dataRow",this.fieldCount=v.length}}B.DataRowMessage=d;class p{constructor(b,v){this.length=b,this.message=v,this.name="notice"}}return B.NoticeMessage=p,B}var We={},$e={},tn;function Xo(){if(tn)return $e;tn=1,Object.defineProperty($e,"__esModule",{value:!0}),$e.Writer=void 0;class e{constructor(r=256){this.size=r,this.offset=5,this.headerPosition=0,this.buffer=Buffer.allocUnsafe(r)}ensure(r){if(this.buffer.length-this.offset<r){const n=this.buffer,i=n.length+(n.length>>1)+r;this.buffer=Buffer.allocUnsafe(i),n.copy(this.buffer)}}addInt32(r){return this.ensure(4),this.buffer[this.offset++]=r>>>24&255,this.buffer[this.offset++]=r>>>16&255,this.buffer[this.offset++]=r>>>8&255,this.buffer[this.offset++]=r>>>0&255,this}addInt16(r){return this.ensure(2),this.buffer[this.offset++]=r>>>8&255,this.buffer[this.offset++]=r>>>0&255,this}addCString(r){if(!r)this.ensure(1);else{const s=Buffer.byteLength(r);this.ensure(s+1),this.buffer.write(r,this.offset,"utf-8"),this.offset+=s}return this.buffer[this.offset++]=0,this}addString(r=""){const s=Buffer.byteLength(r);return this.ensure(s),this.buffer.write(r,this.offset),this.offset+=s,this}add(r){return this.ensure(r.length),r.copy(this.buffer,this.offset),this.offset+=r.length,this}join(r){if(r){this.buffer[this.headerPosition]=r;const s=this.offset-(this.headerPosition+1);this.buffer.writeInt32BE(s,this.headerPosition+1)}return this.buffer.slice(r?0:5,this.offset)}flush(r){const s=this.join(r);return this.offset=5,this.headerPosition=0,this.buffer=Buffer.allocUnsafe(this.size),s}}return $e.Writer=e,$e}var rn;function Wo(){if(rn)return We;rn=1,Object.defineProperty(We,"__esModule",{value:!0}),We.serialize=void 0;const e=Xo(),t=new e.Writer,r=E=>{t.addInt16(3).addInt16(0);for(const M of Object.keys(E))t.addCString(M).addCString(E[M]);t.addCString("client_encoding").addCString("UTF8");const N=t.addCString("").flush(),D=N.length+4;return new e.Writer().addInt32(D).add(N).flush()},s=()=>{const E=Buffer.allocUnsafe(8);return E.writeInt32BE(8,0),E.writeInt32BE(80877103,4),E},n=E=>t.addCString(E).flush(112),i=function(E,N){return t.addCString(E).addInt32(Buffer.byteLength(N)).addString(N),t.flush(112)},o=function(E){return t.addString(E).flush(112)},a=E=>t.addCString(E).flush(81),c=[],u=E=>{const N=E.name||"";N.length>63&&(console.error("Warning! Postgres only supports 63 characters for query names."),console.error("You supplied %s (%s)",N,N.length),console.error("This can cause conflicts and silent errors executing queries"));const D=E.types||c,M=D.length,F=t.addCString(N).addCString(E.text).addInt16(M);for(let z=0;z<M;z++)F.addInt32(D[z]);return t.flush(80)},l=new e.Writer,f=function(E,N){for(let D=0;D<E.length;D++){const M=N?N(E[D],D):E[D];M==null?(t.addInt16(0),l.addInt32(-1)):M instanceof Buffer?(t.addInt16(1),l.addInt32(M.length),l.add(M)):(t.addInt16(0),l.addInt32(Buffer.byteLength(M)),l.addString(M))}},d=(E={})=>{const N=E.portal||"",D=E.statement||"",M=E.binary||!1,F=E.values||c,z=F.length;return t.addCString(N).addCString(D),t.addInt16(z),f(F,E.valueMapper),t.addInt16(z),t.add(l.flush()),t.addInt16(1),t.addInt16(M?1:0),t.flush(66)},p=Buffer.from([69,0,0,0,9,0,0,0,0,0]),g=E=>{if(!E||!E.portal&&!E.rows)return p;const N=E.portal||"",D=E.rows||0,M=Buffer.byteLength(N),F=4+M+1+4,z=Buffer.allocUnsafe(1+F);return z[0]=69,z.writeInt32BE(F,1),z.write(N,5,"utf-8"),z[M+5]=0,z.writeUInt32BE(D,z.length-4),z},b=(E,N)=>{const D=Buffer.allocUnsafe(16);return D.writeInt32BE(16,0),D.writeInt16BE(1234,4),D.writeInt16BE(5678,6),D.writeInt32BE(E,8),D.writeInt32BE(N,12),D},v=(E,N)=>{const M=4+Buffer.byteLength(N)+1,F=Buffer.allocUnsafe(1+M);return F[0]=E,F.writeInt32BE(M,1),F.write(N,5,"utf-8"),F[M]=0,F},h=t.addCString("P").flush(68),y=t.addCString("S").flush(68),x=E=>E.name?v(68,`${E.type}${E.name||""}`):E.type==="P"?h:y,S=E=>{const N=`${E.type}${E.name||""}`;return v(67,N)},O=E=>t.add(E).flush(100),A=E=>v(102,E),m=E=>Buffer.from([E,0,0,0,4]),_=m(72),w=m(83),C=m(88),T=m(99),R={startup:r,password:n,requestSsl:s,sendSASLInitialResponseMessage:i,sendSCRAMClientFinalMessage:o,query:a,parse:u,bind:d,execute:g,describe:x,close:S,flush:()=>_,sync:()=>w,end:()=>C,copyData:O,copyDone:()=>T,copyFail:A,cancel:b};return We.serialize=R,We}var Ge={},Je={},sn;function $o(){if(sn)return Je;sn=1,Object.defineProperty(Je,"__esModule",{value:!0}),Je.BufferReader=void 0;class e{constructor(r=0){this.offset=r,this.buffer=Buffer.allocUnsafe(0),this.encoding="utf-8"}setBuffer(r,s){this.offset=r,this.buffer=s}int16(){const r=this.buffer.readInt16BE(this.offset);return this.offset+=2,r}byte(){const r=this.buffer[this.offset];return this.offset++,r}int32(){const r=this.buffer.readInt32BE(this.offset);return this.offset+=4,r}uint32(){const r=this.buffer.readUInt32BE(this.offset);return this.offset+=4,r}string(r){const s=this.buffer.toString(this.encoding,this.offset,this.offset+r);return this.offset+=r,s}cstring(){const r=this.offset;let s=r;for(;this.buffer[s++]!==0;);return this.offset=s,this.buffer.toString(this.encoding,r,s-1)}bytes(r){const s=this.buffer.slice(this.offset,this.offset+r);return this.offset+=r,s}}return Je.BufferReader=e,Je}var nn;function Go(){if(nn)return Ge;nn=1,Object.defineProperty(Ge,"__esModule",{value:!0}),Ge.Parser=void 0;const e=ci(),t=$o(),r=1,n=r+4,i=-1,o=Buffer.allocUnsafe(0);class a{constructor(_){if(this.buffer=o,this.bufferLength=0,this.bufferOffset=0,this.reader=new t.BufferReader,(_==null?void 0:_.mode)==="binary")throw new Error("Binary mode not supported yet");this.mode=(_==null?void 0:_.mode)||"text"}parse(_,w){this.mergeBuffer(_);const C=this.bufferOffset+this.bufferLength;let T=this.bufferOffset;for(;T+n<=C;){const R=this.buffer[T],E=this.buffer.readUInt32BE(T+r),N=r+E;if(N+T<=C){const D=this.handlePacket(T+n,R,E,this.buffer);w(D),T+=N}else break}T===C?(this.buffer=o,this.bufferLength=0,this.bufferOffset=0):(this.bufferLength=C-T,this.bufferOffset=T)}mergeBuffer(_){if(this.bufferLength>0){const w=this.bufferLength+_.byteLength;if(w+this.bufferOffset>this.buffer.byteLength){let T;if(w<=this.buffer.byteLength&&this.bufferOffset>=this.bufferLength)T=this.buffer;else{let R=this.buffer.byteLength*2;for(;w>=R;)R*=2;T=Buffer.allocUnsafe(R)}this.buffer.copy(T,0,this.bufferOffset,this.bufferOffset+this.bufferLength),this.buffer=T,this.bufferOffset=0}_.copy(this.buffer,this.bufferOffset+this.bufferLength),this.bufferLength=w}else this.buffer=_,this.bufferOffset=0,this.bufferLength=_.byteLength}handlePacket(_,w,C,T){const{reader:R}=this;R.setBuffer(_,T);let E;switch(w){case 50:E=e.bindComplete;break;case 49:E=e.parseComplete;break;case 51:E=e.closeComplete;break;case 110:E=e.noData;break;case 115:E=e.portalSuspended;break;case 99:E=e.copyDone;break;case 87:E=e.replicationStart;break;case 73:E=e.emptyQuery;break;case 68:E=y(R);break;case 67:E=u(R);break;case 90:E=c(R);break;case 65:E=g(R);break;case 82:E=O(R,C);break;case 83:E=x(R);break;case 75:E=S(R);break;case 69:E=A(R,"error");break;case 78:E=A(R,"notice");break;case 84:E=b(R);break;case 116:E=h(R);break;case 71:E=f(R);break;case 72:E=d(R);break;case 100:E=l(R,C);break;default:return new e.DatabaseError("received invalid response: "+w.toString(16),C,"error")}return R.setBuffer(0,o),E.length=C,E}}Ge.Parser=a;const c=m=>{const _=m.string(1);return new e.ReadyForQueryMessage(i,_)},u=m=>{const _=m.cstring();return new e.CommandCompleteMessage(i,_)},l=(m,_)=>{const w=m.bytes(_-4);return new e.CopyDataMessage(i,w)},f=m=>p(m,"copyInResponse"),d=m=>p(m,"copyOutResponse"),p=(m,_)=>{const w=m.byte()!==0,C=m.int16(),T=new e.CopyResponse(i,_,w,C);for(let R=0;R<C;R++)T.columnTypes[R]=m.int16();return T},g=m=>{const _=m.int32(),w=m.cstring(),C=m.cstring();return new e.NotificationResponseMessage(i,_,w,C)},b=m=>{const _=m.int16(),w=new e.RowDescriptionMessage(i,_);for(let C=0;C<_;C++)w.fields[C]=v(m);return w},v=m=>{const _=m.cstring(),w=m.uint32(),C=m.int16(),T=m.uint32(),R=m.int16(),E=m.int32(),N=m.int16()===0?"text":"binary";return new e.Field(_,w,C,T,R,E,N)},h=m=>{const _=m.int16(),w=new e.ParameterDescriptionMessage(i,_);for(let C=0;C<_;C++)w.dataTypeIDs[C]=m.int32();return w},y=m=>{const _=m.int16(),w=new Array(_);for(let C=0;C<_;C++){const T=m.int32();w[C]=T===-1?null:m.string(T)}return new e.DataRowMessage(i,w)},x=m=>{const _=m.cstring(),w=m.cstring();return new e.ParameterStatusMessage(i,_,w)},S=m=>{const _=m.int32(),w=m.int32();return new e.BackendKeyDataMessage(i,_,w)},O=(m,_)=>{const w=m.int32(),C={name:"authenticationOk",length:_};switch(w){case 0:break;case 3:C.length===8&&(C.name="authenticationCleartextPassword");break;case 5:if(C.length===12){C.name="authenticationMD5Password";const T=m.bytes(4);return new e.AuthenticationMD5Password(i,T)}break;case 10:{C.name="authenticationSASL",C.mechanisms=[];let T;do T=m.cstring(),T&&C.mechanisms.push(T);while(T)}break;case 11:C.name="authenticationSASLContinue",C.data=m.string(_-8);break;case 12:C.name="authenticationSASLFinal",C.data=m.string(_-8);break;default:throw new Error("Unknown authenticationOk message type "+w)}return C},A=(m,_)=>{const w={};let C=m.string(1);for(;C!=="\0";)w[C]=m.cstring(),C=m.string(1);const T=w.M,R=_==="notice"?new e.NoticeMessage(i,T):new e.DatabaseError(T,i,_);return R.severity=w.S,R.code=w.C,R.detail=w.D,R.hint=w.H,R.position=w.P,R.internalPosition=w.p,R.internalQuery=w.q,R.where=w.W,R.schema=w.s,R.table=w.t,R.column=w.c,R.dataType=w.d,R.constraint=w.n,R.file=w.F,R.line=w.L,R.routine=w.R,R};return Ge}var on;function ui(){return on||(on=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.DatabaseError=e.serialize=e.parse=void 0;const t=ci();Object.defineProperty(e,"DatabaseError",{enumerable:!0,get:function(){return t.DatabaseError}});const r=Wo();Object.defineProperty(e,"serialize",{enumerable:!0,get:function(){return r.serialize}});const s=Go();function n(i,o){const a=new s.Parser;return i.on("data",c=>a.parse(c,o)),new Promise(c=>i.on("end",()=>c()))}e.parse=n})(Cr)),Cr}var ut={},an;function Jo(){return an||(an=1,Object.defineProperty(ut,"__esModule",{value:!0}),ut.default={}),ut}var Tr,ln;function Yo(){if(ln)return Tr;ln=1;const{getStream:e,getSecureStream:t}=i();Tr={getStream:e,getSecureStream:t};function r(){function o(c){const u=Nn;return new u.Socket}function a(c){return bi.connect(c)}return{getStream:o,getSecureStream:a}}function s(){function o(c){const{CloudflareSocket:u}=Jo();return new u(c)}function a(c){return c.socket.startTls(c),c.socket}return{getStream:o,getSecureStream:a}}function n(){if(typeof navigator=="object"&&navigator!==null&&typeof navigator.userAgent=="string")return navigator.userAgent==="Cloudflare-Workers";if(typeof Response=="function"){const o=new Response(null,{cf:{thing:!0}});if(typeof o.cf=="object"&&o.cf!==null&&o.cf.thing)return!0}return!1}function i(){return n()?s():r()}return Tr}var Pr,cn;function di(){if(cn)return Pr;cn=1;const e=ze.EventEmitter,{parse:t,serialize:r}=ui(),{getStream:s,getSecureStream:n}=Yo(),i=r.flush(),o=r.sync(),a=r.end();class c extends e{constructor(l){super(),l=l||{},this.stream=l.stream||s(l.ssl),typeof this.stream=="function"&&(this.stream=this.stream(l)),this._keepAlive=l.keepAlive,this._keepAliveInitialDelayMillis=l.keepAliveInitialDelayMillis,this.parsedStatements={},this.ssl=l.ssl||!1,this._ending=!1,this._emitMessage=!1;const f=this;this.on("newListener",function(d){d==="message"&&(f._emitMessage=!0)})}connect(l,f){const d=this;this._connecting=!0,this.stream.setNoDelay(!0),this.stream.connect(l,f),this.stream.once("connect",function(){d._keepAlive&&d.stream.setKeepAlive(!0,d._keepAliveInitialDelayMillis),d.emit("connect")});const p=function(g){d._ending&&(g.code==="ECONNRESET"||g.code==="EPIPE")||d.emit("error",g)};if(this.stream.on("error",p),this.stream.on("close",function(){d.emit("end")}),!this.ssl)return this.attachListeners(this.stream);this.stream.once("data",function(g){switch(g.toString("utf8")){case"S":break;case"N":return d.stream.end(),d.emit("error",new Error("The server does not support SSL connections"));default:return d.stream.end(),d.emit("error",new Error("There was an error establishing an SSL connection"))}const v={socket:d.stream};d.ssl!==!0&&(Object.assign(v,d.ssl),"key"in d.ssl&&(v.key=d.ssl.key));const h=Nn;h.isIP&&h.isIP(f)===0&&(v.servername=f);try{d.stream=n(v)}catch(y){return d.emit("error",y)}d.attachListeners(d.stream),d.stream.on("error",p),d.emit("sslconnect")})}attachListeners(l){t(l,f=>{const d=f.name==="error"?"errorMessage":f.name;this._emitMessage&&this.emit("message",f),this.emit(d,f)})}requestSsl(){this.stream.write(r.requestSsl())}startup(l){this.stream.write(r.startup(l))}cancel(l,f){this._send(r.cancel(l,f))}password(l){this._send(r.password(l))}sendSASLInitialResponseMessage(l,f){this._send(r.sendSASLInitialResponseMessage(l,f))}sendSCRAMClientFinalMessage(l){this._send(r.sendSCRAMClientFinalMessage(l))}_send(l){return this.stream.writable?this.stream.write(l):!1}query(l){this._send(r.query(l))}parse(l){this._send(r.parse(l))}bind(l){this._send(r.bind(l))}execute(l){this._send(r.execute(l))}flush(){this.stream.writable&&this.stream.write(i)}sync(){this._ending=!0,this._send(o)}ref(){this.stream.ref()}unref(){this.stream.unref()}end(){if(this._ending=!0,!this._connecting||!this.stream.writable){this.stream.end();return}return this.stream.write(a,()=>{this.stream.end()})}close(l){this._send(r.close(l))}describe(l){this._send(r.describe(l))}sendCopyFromChunk(l){this._send(r.copyData(l))}endCopyFrom(){this._send(r.copyDone())}sendCopyFail(l){this._send(r.copyFail(l))}}return Pr=c,Pr}var dt={exports:{}},Rr={exports:{}},Ir,un;function Ko(){if(un)return Ir;un=1;const{Transform:e}=qn,{StringDecoder:t}=vi,r=Symbol("last"),s=Symbol("decoder");function n(u,l,f){let d;if(this.overflow){if(d=this[s].write(u).split(this.matcher),d.length===1)return f();d.shift(),this.overflow=!1}else this[r]+=this[s].write(u),d=this[r].split(this.matcher);this[r]=d.pop();for(let p=0;p<d.length;p++)try{o(this,this.mapper(d[p]))}catch(g){return f(g)}if(this.overflow=this[r].length>this.maxLength,this.overflow&&!this.skipOverflow){f(new Error("maximum buffer reached"));return}f()}function i(u){if(this[r]+=this[s].end(),this[r])try{o(this,this.mapper(this[r]))}catch(l){return u(l)}u()}function o(u,l){l!==void 0&&u.push(l)}function a(u){return u}function c(u,l,f){switch(u=u||/\r?\n/,l=l||a,f=f||{},arguments.length){case 1:typeof u=="function"?(l=u,u=/\r?\n/):typeof u=="object"&&!(u instanceof RegExp)&&!u[Symbol.split]&&(f=u,u=/\r?\n/);break;case 2:typeof u=="function"?(f=l,l=u,u=/\r?\n/):typeof l=="object"&&(f=l,l=a)}f=Object.assign({},f),f.autoDestroy=!0,f.transform=n,f.flush=i,f.readableObjectMode=!0;const d=new e(f);return d[r]="",d[s]=new t("utf8"),d.matcher=u,d.mapper=l,d.maxLength=f.maxLength,d.skipOverflow=f.skipOverflow||!1,d.overflow=!1,d._destroy=function(p,g){this._writableState.errorEmitted=!1,g(p)},d}return Ir=c,Ir}var dn;function Zo(){return dn||(dn=1,(function(e){var t={},r=yi,s=qn.Stream,n=Ko(),i=He,o=5432,a=process.platform==="win32",c=process.stderr,u=56,l=7,f=61440,d=32768;function p(O){return(O&f)==d}var g=["host","port","database","user","password"],b=g.length,v=g[b-1];function h(){var O=c instanceof s&&c.writable===!0;if(O){var A=Array.prototype.slice.call(arguments).concat(`
`);c.write(i.format.apply(i,A))}}Object.defineProperty(e.exports,"isWin",{get:function(){return a},set:function(O){a=O}}),e.exports.warnTo=function(O){var A=c;return c=O,A},e.exports.getFileName=function(O){var A=O||t,m=A.PGPASSFILE||(a?r.join(A.APPDATA||"./","postgresql","pgpass.conf"):r.join(A.HOME||"./",".pgpass"));return m},e.exports.usePgPass=function(O,A){return Object.prototype.hasOwnProperty.call(t,"PGPASSWORD")?!1:a?!0:(A=A||"<unkn>",p(O.mode)?O.mode&(u|l)?(h('WARNING: password file "%s" has group or world access; permissions should be u=rw (0600) or less',A),!1):!0:(h('WARNING: password file "%s" is not a plain file',A),!1))};var y=e.exports.match=function(O,A){return g.slice(0,-1).reduce(function(m,_,w){return w==1&&Number(O[_]||o)===Number(A[_])?m&&!0:m&&(A[_]==="*"||A[_]===O[_])},!0)};e.exports.getPassword=function(O,A,m){var _,w=A.pipe(n());function C(E){var N=x(E);N&&S(N)&&y(O,N)&&(_=N[v],w.end())}var T=function(){A.destroy(),m(_)},R=function(E){A.destroy(),h("WARNING: error on reading file: %s",E),m(void 0)};A.on("error",R),w.on("data",C).on("end",T).on("error",R)};var x=e.exports.parseLine=function(O){if(O.length<11||O.match(/^\s+#/))return null;for(var A="",m="",_=0,w=0,C={},T=!1,R=function(N,D,M){var F=O.substring(D,M);Object.hasOwnProperty.call(t,"PGPASS_NO_DEESCAPE")||(F=F.replace(/\\([:\\])/g,"$1")),C[g[N]]=F},E=0;E<O.length-1;E+=1){if(A=O.charAt(E+1),m=O.charAt(E),T=_==b-1,T){R(_,w);break}E>=0&&A==":"&&m!=="\\"&&(R(_,w,E+1),w=E+2,_+=1)}return C=Object.keys(C).length===b?C:null,C},S=e.exports.isValidEntry=function(O){for(var A={0:function(T){return T.length>0},1:function(T){return T==="*"?!0:(T=Number(T),isFinite(T)&&T>0&&T<9007199254740992&&Math.floor(T)===T)},2:function(T){return T.length>0},3:function(T){return T.length>0},4:function(T){return T.length>0}},m=0;m<g.length;m+=1){var _=A[m],w=O[g[m]]||"",C=_(w);if(!C)return!1}return!0}})(Rr)),Rr.exports}var fn;function ea(){if(fn)return dt.exports;fn=1;var e=In,t=Zo();return dt.exports=function(r,s){var n=t.getFileName();e.stat(n,function(i,o){if(i||!t.usePgPass(o,n))return s(void 0);var a=e.createReadStream(n);t.getPassword(r,a,s)})},dt.exports.warnTo=t.warnTo,dt.exports}var Nr,pn;function ta(){if(pn)return Nr;pn=1;const e=ze.EventEmitter,t=Ze(),r=He,s=zo(),n=Xr(),i=ai(),o=Qo(),a=Et(),c=di(),u=oi(),l=r.deprecate(()=>{},"Client.activeQuery is deprecated and will be removed in pg@9.0"),f=r.deprecate(()=>{},"Client.queryQueue is deprecated and will be removed in pg@9.0."),d=r.deprecate(()=>{},"pgpass support is deprecated and will be removed in pg@9.0. You can provide an async function as the password property to the Client/Pool constructor that returns a password instead. Within this function you can call the pgpass module in your own code."),p=r.deprecate(()=>{},"Passing a custom Promise implementation to the Client/Pool constructor is deprecated and will be removed in pg@9.0."),g=r.deprecate(()=>{},"Calling client.query() when the client is already executing a query is deprecated and will be removed in pg@9.0. Use async/await or an external async flow control mechanism instead.");class b extends e{constructor(h){super(),this.connectionParameters=new i(h),this.user=this.connectionParameters.user,this.database=this.connectionParameters.database,this.port=this.connectionParameters.port,this.host=this.connectionParameters.host,Object.defineProperty(this,"password",{configurable:!0,enumerable:!1,writable:!0,value:this.connectionParameters.password}),this.replication=this.connectionParameters.replication;const y=h||{};y.Promise&&p(),this._Promise=y.Promise||Ur.Promise,this._types=new n(y.types),this._ending=!1,this._ended=!1,this._connecting=!1,this._connected=!1,this._connectionError=!1,this._queryable=!0,this._activeQuery=null,this.enableChannelBinding=!!y.enableChannelBinding,this.connection=y.connection||new c({stream:y.stream,ssl:this.connectionParameters.ssl,keepAlive:y.keepAlive||!1,keepAliveInitialDelayMillis:y.keepAliveInitialDelayMillis||0,encoding:this.connectionParameters.client_encoding||"utf8"}),this._queryQueue=[],this.binary=y.binary||a.binary,this.processID=null,this.secretKey=null,this.ssl=this.connectionParameters.ssl||!1,this.ssl&&this.ssl.key&&Object.defineProperty(this.ssl,"key",{enumerable:!1}),this._connectionTimeoutMillis=y.connectionTimeoutMillis||0}get activeQuery(){return l(),this._activeQuery}set activeQuery(h){l(),this._activeQuery=h}_getActiveQuery(){return this._activeQuery}_errorAllQueries(h){const y=S=>{process.nextTick(()=>{S.handleError(h,this.connection)})},x=this._getActiveQuery();x&&(y(x),this._activeQuery=null),this._queryQueue.forEach(y),this._queryQueue.length=0}_connect(h){const y=this,x=this.connection;if(this._connectionCallback=h,this._connecting||this._connected){const S=new Error("Client has already been connected. You cannot reuse a client.");process.nextTick(()=>{h(S)});return}this._connecting=!0,this._connectionTimeoutMillis>0&&(this.connectionTimeoutHandle=setTimeout(()=>{x._ending=!0,x.stream.destroy(new Error("timeout expired"))},this._connectionTimeoutMillis),this.connectionTimeoutHandle.unref&&this.connectionTimeoutHandle.unref()),this.host&&this.host.indexOf("/")===0?x.connect(this.host+"/.s.PGSQL."+this.port):x.connect(this.port,this.host),x.on("connect",function(){y.ssl?x.requestSsl():x.startup(y.getStartupConf())}),x.on("sslconnect",function(){x.startup(y.getStartupConf())}),this._attachListeners(x),x.once("end",()=>{const S=this._ending?new Error("Connection terminated"):new Error("Connection terminated unexpectedly");clearTimeout(this.connectionTimeoutHandle),this._errorAllQueries(S),this._ended=!0,this._ending||(this._connecting&&!this._connectionError?this._connectionCallback?this._connectionCallback(S):this._handleErrorEvent(S):this._connectionError||this._handleErrorEvent(S)),process.nextTick(()=>{this.emit("end")})})}connect(h){if(h){this._connect(h);return}return new this._Promise((y,x)=>{this._connect(S=>{S?x(S):y(this)})})}_attachListeners(h){h.on("authenticationCleartextPassword",this._handleAuthCleartextPassword.bind(this)),h.on("authenticationMD5Password",this._handleAuthMD5Password.bind(this)),h.on("authenticationSASL",this._handleAuthSASL.bind(this)),h.on("authenticationSASLContinue",this._handleAuthSASLContinue.bind(this)),h.on("authenticationSASLFinal",this._handleAuthSASLFinal.bind(this)),h.on("backendKeyData",this._handleBackendKeyData.bind(this)),h.on("error",this._handleErrorEvent.bind(this)),h.on("errorMessage",this._handleErrorMessage.bind(this)),h.on("readyForQuery",this._handleReadyForQuery.bind(this)),h.on("notice",this._handleNotice.bind(this)),h.on("rowDescription",this._handleRowDescription.bind(this)),h.on("dataRow",this._handleDataRow.bind(this)),h.on("portalSuspended",this._handlePortalSuspended.bind(this)),h.on("emptyQuery",this._handleEmptyQuery.bind(this)),h.on("commandComplete",this._handleCommandComplete.bind(this)),h.on("parseComplete",this._handleParseComplete.bind(this)),h.on("copyInResponse",this._handleCopyInResponse.bind(this)),h.on("copyData",this._handleCopyData.bind(this)),h.on("notification",this._handleNotification.bind(this))}_getPassword(h){const y=this.connection;if(typeof this.password=="function")this._Promise.resolve().then(()=>this.password(this.connectionParameters)).then(x=>{if(x!==void 0){if(typeof x!="string"){y.emit("error",new TypeError("Password must be a string"));return}this.connectionParameters.password=this.password=x}else this.connectionParameters.password=this.password=null;h()}).catch(x=>{y.emit("error",x)});else if(this.password!==null)h();else try{ea()(this.connectionParameters,S=>{S!==void 0&&(d(),this.connectionParameters.password=this.password=S),h()})}catch(x){this.emit("error",x)}}_handleAuthCleartextPassword(h){this._getPassword(()=>{this.connection.password(this.password)})}_handleAuthMD5Password(h){this._getPassword(async()=>{try{const y=await u.postgresMd5PasswordHash(this.user,this.password,h.salt);this.connection.password(y)}catch(y){this.emit("error",y)}})}_handleAuthSASL(h){this._getPassword(()=>{try{this.saslSession=s.startSession(h.mechanisms,this.enableChannelBinding&&this.connection.stream),this.connection.sendSASLInitialResponseMessage(this.saslSession.mechanism,this.saslSession.response)}catch(y){this.connection.emit("error",y)}})}async _handleAuthSASLContinue(h){try{await s.continueSession(this.saslSession,this.password,h.data,this.enableChannelBinding&&this.connection.stream),this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}catch(y){this.connection.emit("error",y)}}_handleAuthSASLFinal(h){try{s.finalizeSession(this.saslSession,h.data),this.saslSession=null}catch(y){this.connection.emit("error",y)}}_handleBackendKeyData(h){this.processID=h.processID,this.secretKey=h.secretKey}_handleReadyForQuery(h){this._connecting&&(this._connecting=!1,this._connected=!0,clearTimeout(this.connectionTimeoutHandle),this._connectionCallback&&(this._connectionCallback(null,this),this._connectionCallback=null),this.emit("connect"));const y=this._getActiveQuery();this._activeQuery=null,this.readyForQuery=!0,y&&y.handleReadyForQuery(this.connection),this._pulseQueryQueue()}_handleErrorWhileConnecting(h){if(!this._connectionError){if(this._connectionError=!0,clearTimeout(this.connectionTimeoutHandle),this._connectionCallback)return this._connectionCallback(h);this.emit("error",h)}}_handleErrorEvent(h){if(this._connecting)return this._handleErrorWhileConnecting(h);this._queryable=!1,this._errorAllQueries(h),this.emit("error",h)}_handleErrorMessage(h){if(this._connecting)return this._handleErrorWhileConnecting(h);const y=this._getActiveQuery();if(!y){this._handleErrorEvent(h);return}this._activeQuery=null,y.handleError(h,this.connection)}_handleRowDescription(h){const y=this._getActiveQuery();if(y==null){const x=new Error("Received unexpected rowDescription message from backend.");this._handleErrorEvent(x);return}y.handleRowDescription(h)}_handleDataRow(h){const y=this._getActiveQuery();if(y==null){const x=new Error("Received unexpected dataRow message from backend.");this._handleErrorEvent(x);return}y.handleDataRow(h)}_handlePortalSuspended(h){const y=this._getActiveQuery();if(y==null){const x=new Error("Received unexpected portalSuspended message from backend.");this._handleErrorEvent(x);return}y.handlePortalSuspended(this.connection)}_handleEmptyQuery(h){const y=this._getActiveQuery();if(y==null){const x=new Error("Received unexpected emptyQuery message from backend.");this._handleErrorEvent(x);return}y.handleEmptyQuery(this.connection)}_handleCommandComplete(h){const y=this._getActiveQuery();if(y==null){const x=new Error("Received unexpected commandComplete message from backend.");this._handleErrorEvent(x);return}y.handleCommandComplete(h,this.connection)}_handleParseComplete(){const h=this._getActiveQuery();if(h==null){const y=new Error("Received unexpected parseComplete message from backend.");this._handleErrorEvent(y);return}h.name&&(this.connection.parsedStatements[h.name]=h.text)}_handleCopyInResponse(h){const y=this._getActiveQuery();if(y==null){const x=new Error("Received unexpected copyInResponse message from backend.");this._handleErrorEvent(x);return}y.handleCopyInResponse(this.connection)}_handleCopyData(h){const y=this._getActiveQuery();if(y==null){const x=new Error("Received unexpected copyData message from backend.");this._handleErrorEvent(x);return}y.handleCopyData(h,this.connection)}_handleNotification(h){this.emit("notification",h)}_handleNotice(h){this.emit("notice",h)}getStartupConf(){const h=this.connectionParameters,y={user:h.user,database:h.database},x=h.application_name||h.fallback_application_name;return x&&(y.application_name=x),h.replication&&(y.replication=""+h.replication),h.statement_timeout&&(y.statement_timeout=String(parseInt(h.statement_timeout,10))),h.lock_timeout&&(y.lock_timeout=String(parseInt(h.lock_timeout,10))),h.idle_in_transaction_session_timeout&&(y.idle_in_transaction_session_timeout=String(parseInt(h.idle_in_transaction_session_timeout,10))),h.options&&(y.options=h.options),y}cancel(h,y){if(h.activeQuery===y){const x=this.connection;this.host&&this.host.indexOf("/")===0?x.connect(this.host+"/.s.PGSQL."+this.port):x.connect(this.port,this.host),x.on("connect",function(){x.cancel(h.processID,h.secretKey)})}else h._queryQueue.indexOf(y)!==-1&&h._queryQueue.splice(h._queryQueue.indexOf(y),1)}setTypeParser(h,y,x){return this._types.setTypeParser(h,y,x)}getTypeParser(h,y){return this._types.getTypeParser(h,y)}escapeIdentifier(h){return t.escapeIdentifier(h)}escapeLiteral(h){return t.escapeLiteral(h)}_pulseQueryQueue(){if(this.readyForQuery===!0){this._activeQuery=this._queryQueue.shift();const h=this._getActiveQuery();if(h){this.readyForQuery=!1,this.hasExecuted=!0;const y=h.submit(this.connection);y&&process.nextTick(()=>{h.handleError(y,this.connection),this.readyForQuery=!0,this._pulseQueryQueue()})}else this.hasExecuted&&(this._activeQuery=null,this.emit("drain"))}}query(h,y,x){let S,O,A,m,_;if(h==null)throw new TypeError("Client was passed a null or undefined query");return typeof h.submit=="function"?(A=h.query_timeout||this.connectionParameters.query_timeout,O=S=h,S.callback||(typeof y=="function"?S.callback=y:x&&(S.callback=x))):(A=h.query_timeout||this.connectionParameters.query_timeout,S=new o(h,y,x),S.callback||(O=new this._Promise((w,C)=>{S.callback=(T,R)=>T?C(T):w(R)}).catch(w=>{throw Error.captureStackTrace(w),w}))),A&&(_=S.callback||(()=>{}),m=setTimeout(()=>{const w=new Error("Query read timeout");process.nextTick(()=>{S.handleError(w,this.connection)}),_(w),S.callback=()=>{};const C=this._queryQueue.indexOf(S);C>-1&&this._queryQueue.splice(C,1),this._pulseQueryQueue()},A),S.callback=(w,C)=>{clearTimeout(m),_(w,C)}),this.binary&&!S.binary&&(S.binary=!0),S._result&&!S._result._types&&(S._result._types=this._types),this._queryable?this._ending?(process.nextTick(()=>{S.handleError(new Error("Client was closed and is not queryable"),this.connection)}),O):(this._queryQueue.length>0&&g(),this._queryQueue.push(S),this._pulseQueryQueue(),O):(process.nextTick(()=>{S.handleError(new Error("Client has encountered a connection error and is not queryable"),this.connection)}),O)}ref(){this.connection.ref()}unref(){this.connection.unref()}end(h){if(this._ending=!0,!this.connection._connecting||this._ended)if(h)h();else return this._Promise.resolve();if(this._getActiveQuery()||!this._queryable?this.connection.stream.destroy():this.connection.end(),h)this.connection.once("end",h);else return new this._Promise(y=>{this.connection.once("end",y)})}get queryQueue(){return f(),this._queryQueue}}return b.Query=o,Nr=b,Nr}var qr,hn;function ra(){if(hn)return qr;hn=1;const e=ze.EventEmitter,t=function(){},r=(u,l)=>{const f=u.findIndex(l);return f===-1?void 0:u.splice(f,1)[0]};class s{constructor(l,f,d){this.client=l,this.idleListener=f,this.timeoutId=d}}class n{constructor(l){this.callback=l}}function i(){throw new Error("Release called on client which has already been released to the pool.")}function o(u,l){if(l)return{callback:l,result:void 0};let f,d;const p=function(b,v){b?f(b):d(v)},g=new u(function(b,v){d=b,f=v}).catch(b=>{throw Error.captureStackTrace(b),b});return{callback:p,result:g}}function a(u,l){return function f(d){d.client=l,l.removeListener("error",f),l.on("error",()=>{u.log("additional client error after disconnection due to error",d)}),u._remove(l),u.emit("error",d,l)}}class c extends e{constructor(l,f){super(),this.options=Object.assign({},l),l!=null&&"password"in l&&Object.defineProperty(this.options,"password",{configurable:!0,enumerable:!1,writable:!0,value:l.password}),l!=null&&l.ssl&&l.ssl.key&&Object.defineProperty(this.options.ssl,"key",{enumerable:!1}),this.options.max=this.options.max||this.options.poolSize||10,this.options.min=this.options.min||0,this.options.maxUses=this.options.maxUses||1/0,this.options.allowExitOnIdle=this.options.allowExitOnIdle||!1,this.options.maxLifetimeSeconds=this.options.maxLifetimeSeconds||0,this.log=this.options.log||function(){},this.Client=this.options.Client||f||fi().Client,this.Promise=this.options.Promise||Ur.Promise,typeof this.options.idleTimeoutMillis>"u"&&(this.options.idleTimeoutMillis=1e4),this._clients=[],this._idle=[],this._expired=new WeakSet,this._pendingQueue=[],this._endCallback=void 0,this.ending=!1,this.ended=!1}_promiseTry(l){const f=this.Promise;return typeof f.try=="function"?f.try(l):new f(d=>d(l()))}_isFull(){return this._clients.length>=this.options.max}_isAboveMin(){return this._clients.length>this.options.min}_pulseQueue(){if(this.log("pulse queue"),this.ended){this.log("pulse queue ended");return}if(this.ending){this.log("pulse queue on ending"),this._idle.length&&this._idle.slice().map(f=>{this._remove(f.client)}),this._clients.length||(this.ended=!0,this._endCallback());return}if(!this._pendingQueue.length){this.log("no queued requests");return}if(!this._idle.length&&this._isFull())return;const l=this._pendingQueue.shift();if(this._idle.length){const f=this._idle.pop();clearTimeout(f.timeoutId);const d=f.client;d.ref&&d.ref();const p=f.idleListener;return this._acquireClient(d,l,p,!1)}if(!this._isFull())return this.newClient(l);throw new Error("unexpected condition")}_remove(l,f){const d=r(this._idle,g=>g.client===l);d!==void 0&&clearTimeout(d.timeoutId),this._clients=this._clients.filter(g=>g!==l);const p=this;l.end(()=>{p.emit("remove",l),typeof f=="function"&&f()})}connect(l){if(this.ending){const p=new Error("Cannot use a pool after calling end on the pool");return l?l(p):this.Promise.reject(p)}const f=o(this.Promise,l),d=f.result;if(this._isFull()||this._idle.length){if(this._idle.length&&process.nextTick(()=>this._pulseQueue()),!this.options.connectionTimeoutMillis)return this._pendingQueue.push(new n(f.callback)),d;const p=(v,h,y)=>{clearTimeout(b),f.callback(v,h,y)},g=new n(p),b=setTimeout(()=>{r(this._pendingQueue,v=>v.callback===p),g.timedOut=!0,f.callback(new Error("timeout exceeded when trying to connect"))},this.options.connectionTimeoutMillis);return b.unref&&b.unref(),this._pendingQueue.push(g),d}return this.newClient(new n(f.callback)),d}newClient(l){const f=new this.Client(this.options);this._clients.push(f);const d=a(this,f);this.log("checking client timeout");let p,g=!1;this.options.connectionTimeoutMillis&&(p=setTimeout(()=>{f.connection?(this.log("ending client due to timeout"),g=!0,f.connection.stream.destroy()):f.isConnected()||(this.log("ending client due to timeout"),g=!0,f.end())},this.options.connectionTimeoutMillis)),this.log("connecting new client"),f.connect(b=>{if(p&&clearTimeout(p),f.on("error",d),b)this.log("client failed to connect",b),this._clients=this._clients.filter(v=>v!==f),g&&(b=new Error("Connection terminated due to connection timeout",{cause:b})),this._pulseQueue(),l.timedOut||l.callback(b,void 0,t);else{if(this.log("new client connected"),this.options.onConnect){this._promiseTry(()=>this.options.onConnect(f)).then(()=>{this._afterConnect(f,l,d)},v=>{this._clients=this._clients.filter(h=>h!==f),f.end(()=>{this._pulseQueue(),l.timedOut||l.callback(v,void 0,t)})});return}return this._afterConnect(f,l,d)}})}_afterConnect(l,f,d){if(this.options.maxLifetimeSeconds!==0){const p=setTimeout(()=>{this.log("ending client due to expired lifetime"),this._expired.add(l),this._idle.findIndex(b=>b.client===l)!==-1&&this._acquireClient(l,new n((b,v,h)=>h()),d,!1)},this.options.maxLifetimeSeconds*1e3);p.unref(),l.once("end",()=>clearTimeout(p))}return this._acquireClient(l,f,d,!0)}_acquireClient(l,f,d,p){p&&this.emit("connect",l),this.emit("acquire",l),l.release=this._releaseOnce(l,d),l.removeListener("error",d),f.timedOut?p&&this.options.verify?this.options.verify(l,l.release):l.release():p&&this.options.verify?this.options.verify(l,g=>{if(g)return l.release(g),f.callback(g,void 0,t);f.callback(void 0,l,l.release)}):f.callback(void 0,l,l.release)}_releaseOnce(l,f){let d=!1;return p=>{d&&i(),d=!0,this._release(l,f,p)}}_release(l,f,d){if(l.on("error",f),l._poolUseCount=(l._poolUseCount||0)+1,this.emit("release",d,l),d||this.ending||!l._queryable||l._ending||l._poolUseCount>=this.options.maxUses)return l._poolUseCount>=this.options.maxUses&&this.log("remove expended client"),this._remove(l,this._pulseQueue.bind(this));if(this._expired.has(l))return this.log("remove expired client"),this._expired.delete(l),this._remove(l,this._pulseQueue.bind(this));let g;this.options.idleTimeoutMillis&&this._isAboveMin()&&(g=setTimeout(()=>{this._isAboveMin()&&(this.log("remove idle client"),this._remove(l,this._pulseQueue.bind(this)))},this.options.idleTimeoutMillis),this.options.allowExitOnIdle&&g.unref()),this.options.allowExitOnIdle&&l.unref(),this._idle.push(new s(l,f,g)),this._pulseQueue()}query(l,f,d){if(typeof l=="function"){const g=o(this.Promise,l);return setImmediate(function(){return g.callback(new Error("Passing a function as the first parameter to pool.query is not supported"))}),g.result}typeof f=="function"&&(d=f,f=void 0);const p=o(this.Promise,d);return d=p.callback,this.connect((g,b)=>{if(g)return d(g);let v=!1;const h=y=>{v||(v=!0,b.release(y),d(y))};b.once("error",h),this.log("dispatching query");try{b.query(l,f,(y,x)=>{if(this.log("query dispatched"),b.removeListener("error",h),!v)return v=!0,b.release(y),y?d(y):d(void 0,x)})}catch(y){return b.release(y),d(y)}}),p.result}end(l){if(this.log("ending"),this.ending){const d=new Error("Called end on pool more than once");return l?l(d):this.Promise.reject(d)}this.ending=!0;const f=o(this.Promise,l);return this._endCallback=f.callback,this._pulseQueue(),f.result}get waitingCount(){return this._pendingQueue.length}get idleCount(){return this._idle.length}get expiredCount(){return this._clients.reduce((l,f)=>l+(this._expired.has(f)?1:0),0)}get totalCount(){return this._clients.length}}return qr=c,qr}var Or={exports:{}};const sa={},na=Object.freeze(Object.defineProperty({__proto__:null,default:sa},Symbol.toStringTag,{value:"Module"})),ia=so(na);var Lr={exports:{}},mn;function oa(){if(mn)return Lr.exports;mn=1;const e=ze.EventEmitter,t=He,r=Ze(),s=Lr.exports=function(i,o,a){e.call(this),i=r.normalizeQueryConfig(i,o,a),this.text=i.text,this.values=i.values,this.name=i.name,this.queryMode=i.queryMode,this.callback=i.callback,this.state="new",this._arrayMode=i.rowMode==="array",this._emitRowEvents=!1,this.on("newListener",(function(c){c==="row"&&(this._emitRowEvents=!0)}).bind(this))};t.inherits(s,e);const n={sqlState:"code",statementPosition:"position",messagePrimary:"message",context:"where",schemaName:"schema",tableName:"table",columnName:"column",dataTypeName:"dataType",constraintName:"constraint",sourceFile:"file",sourceLine:"line",sourceFunction:"routine"};return s.prototype.handleError=function(i){const o=this.native.pq.resultErrorFields();if(o)for(const a in o){const c=n[a]||a;i[c]=o[a]}this.callback?this.callback(i):this.emit("error",i),this.state="error"},s.prototype.then=function(i,o){return this._getPromise().then(i,o)},s.prototype.catch=function(i){return this._getPromise().catch(i)},s.prototype._getPromise=function(){return this._promise?this._promise:(this._promise=new Promise((function(i,o){this._once("end",i),this._once("error",o)}).bind(this)),this._promise)},s.prototype.submit=function(i){this.state="running";const o=this;this.native=i.native,i.native.arrayMode=this._arrayMode;let a=function(c,u,l){if(i.native.arrayMode=!1,setImmediate(function(){o.emit("_done")}),c)return o.handleError(c);o._emitRowEvents&&(l.length>1?u.forEach((f,d)=>{f.forEach(p=>{o.emit("row",p,l[d])})}):u.forEach(function(f){o.emit("row",f,l)})),o.state="end",o.emit("end",l),o.callback&&o.callback(null,l)};if(process.domain&&(a=process.domain.bind(a)),this.name){this.name.length>63&&(console.error("Warning! Postgres only supports 63 characters for query names."),console.error("You supplied %s (%s)",this.name,this.name.length),console.error("This can cause conflicts and silent errors executing queries"));const c=(this.values||[]).map(r.prepareValue);if(i.namedQueries[this.name]){if(this.text&&i.namedQueries[this.name]!==this.text){const u=new Error(`Prepared statements must be unique - '${this.name}' was used for a different statement`);return a(u)}return i.native.execute(this.name,c,a)}return i.native.prepare(this.name,this.text,c.length,function(u){return u?a(u):(i.namedQueries[o.name]=o.text,o.native.execute(o.name,c,a))})}else if(this.values){if(!Array.isArray(this.values)){const u=new Error("Query values must be an array");return a(u)}const c=this.values.map(r.prepareValue);i.native.query(this.text,c,a)}else this.queryMode==="extended"?i.native.query(this.text,[],a):i.native.query(this.text,a)},Lr.exports}var gn;function aa(){if(gn)return Or.exports;gn=1;const e=He;var t;try{t=ia}catch(u){throw u}const r=Xr(),s=ze.EventEmitter,n=He,i=ai(),o=oa(),a=e.deprecate(()=>{},"Calling client.query() when the client is already executing a query is deprecated and will be removed in pg@9.0. Use async/await or an external async flow control mechanism instead."),c=Or.exports=function(u){s.call(this),u=u||{},this._Promise=u.Promise||Ur.Promise,this._types=new r(u.types),this.native=new t({types:this._types}),this._queryQueue=[],this._ending=!1,this._connecting=!1,this._connected=!1,this._queryable=!0;const l=this.connectionParameters=new i(u);u.nativeConnectionString&&(l.nativeConnectionString=u.nativeConnectionString),this.user=l.user,Object.defineProperty(this,"password",{configurable:!0,enumerable:!1,writable:!0,value:l.password}),this.database=l.database,this.host=l.host,this.port=l.port,this.namedQueries={}};return c.Query=o,n.inherits(c,s),c.prototype._errorAllQueries=function(u){const l=f=>{process.nextTick(()=>{f.native=this.native,f.handleError(u)})};this._hasActiveQuery()&&(l(this._activeQuery),this._activeQuery=null),this._queryQueue.forEach(l),this._queryQueue.length=0},c.prototype._connect=function(u){const l=this;if(this._connecting){process.nextTick(()=>u(new Error("Client has already been connected. You cannot reuse a client.")));return}this._connecting=!0,this.connectionParameters.getLibpqConnectionString(function(f,d){if(l.connectionParameters.nativeConnectionString&&(d=l.connectionParameters.nativeConnectionString),f)return u(f);l.native.connect(d,function(p){if(p)return l.native.end(),u(p);l._connected=!0,l.native.on("error",function(g){l._queryable=!1,l._errorAllQueries(g),l.emit("error",g)}),l.native.on("notification",function(g){l.emit("notification",{channel:g.relname,payload:g.extra})}),l.emit("connect"),l._pulseQueryQueue(!0),u(null,this)})})},c.prototype.connect=function(u){if(u){this._connect(u);return}return new this._Promise((l,f)=>{this._connect(d=>{d?f(d):l(this)})})},c.prototype.query=function(u,l,f){let d,p,g,b,v;if(u==null)throw new TypeError("Client was passed a null or undefined query");if(typeof u.submit=="function")g=u.query_timeout||this.connectionParameters.query_timeout,p=d=u,typeof l=="function"&&(u.callback=l);else if(g=u.query_timeout||this.connectionParameters.query_timeout,d=new o(u,l,f),!d.callback){let h,y;p=new this._Promise((x,S)=>{h=x,y=S}).catch(x=>{throw Error.captureStackTrace(x),x}),d.callback=(x,S)=>x?y(x):h(S)}return g&&(v=d.callback||(()=>{}),b=setTimeout(()=>{const h=new Error("Query read timeout");process.nextTick(()=>{d.handleError(h,this.connection)}),v(h),d.callback=()=>{};const y=this._queryQueue.indexOf(d);y>-1&&this._queryQueue.splice(y,1),this._pulseQueryQueue()},g),d.callback=(h,y)=>{clearTimeout(b),v(h,y)}),this._queryable?this._ending?(d.native=this.native,process.nextTick(()=>{d.handleError(new Error("Client was closed and is not queryable"))}),p):(this._queryQueue.length>0&&a(),this._queryQueue.push(d),this._pulseQueryQueue(),p):(d.native=this.native,process.nextTick(()=>{d.handleError(new Error("Client has encountered a connection error and is not queryable"))}),p)},c.prototype.end=function(u){const l=this;this._ending=!0,this._connected||this.once("connect",this.end.bind(this,u));let f;return u||(f=new this._Promise(function(d,p){u=g=>g?p(g):d()})),this.native.end(function(){l._connected=!1,l._errorAllQueries(new Error("Connection terminated")),process.nextTick(()=>{l.emit("end"),u&&u()})}),f},c.prototype._hasActiveQuery=function(){return this._activeQuery&&this._activeQuery.state!=="error"&&this._activeQuery.state!=="end"},c.prototype._pulseQueryQueue=function(u){if(!this._connected||this._hasActiveQuery())return;const l=this._queryQueue.shift();if(!l){u||this.emit("drain");return}this._activeQuery=l,l.submit(this);const f=this;l.once("_done",function(){f._pulseQueryQueue()})},c.prototype.cancel=function(u){this._activeQuery===u?this.native.cancel(function(){}):this._queryQueue.indexOf(u)!==-1&&this._queryQueue.splice(this._queryQueue.indexOf(u),1)},c.prototype.ref=function(){},c.prototype.unref=function(){},c.prototype.setTypeParser=function(u,l,f){return this._types.setTypeParser(u,l,f)},c.prototype.getTypeParser=function(u,l){return this._types.getTypeParser(u,l)},c.prototype.isConnected=function(){return this._connected},Or.exports}var Dr,bn;function yn(){return bn||(bn=1,Dr=aa()),Dr}var vn;function fi(){return vn||(vn=1,(function(e){var t={};const r=ta(),s=Et(),n=di(),i=li(),o=Ze(),a=ra(),c=Xr(),{DatabaseError:u}=ui(),{escapeIdentifier:l,escapeLiteral:f}=Ze(),d=v=>class extends a{constructor(y){super(y,v)}},p=function(v){this.defaults=s,this.Client=v,this.Query=this.Client.Query,this.Pool=d(this.Client),this._pools=[],this.Connection=n,this.types=xt(),this.DatabaseError=u,this.TypeOverrides=c,this.escapeIdentifier=l,this.escapeLiteral=f,this.Result=i,this.utils=o};let g=r,b=!1;try{b=!!t.NODE_PG_FORCE_NATIVE}catch{}b&&(g=yn()),e.exports=new p(g),Object.defineProperty(e.exports,"native",{configurable:!0,enumerable:!1,get(){let v=null;try{v=new p(yn())}catch(h){if(h.code!=="MODULE_NOT_FOUND")throw h}return Object.defineProperty(e.exports,"native",{value:v}),v}})})(nr)),nr.exports}var la=fi();const Z=Jn(la);Z.Client;const ca=Z.Pool;Z.Connection;Z.types;Z.Query;Z.DatabaseError;Z.escapeIdentifier;Z.escapeLiteral;Z.Result;Z.TypeOverrides;Z.defaults;const ua=Object.freeze(Object.defineProperty({__proto__:null,Pool:ca,default:Z},Symbol.toStringTag,{value:"Module"}));export{Is as default};
