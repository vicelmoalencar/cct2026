...
Make sure your charset is UTF-8`);n=(n>>>8&255)*192+(n&255),s.put(n,13)}},Zt=r,Zt}var er={exports:{}},Rs;function xo(){return Rs||(Rs=1,(function(e){var t={single_source_shortest_paths:function(r,s,i){var n={},o={};o[s]=0;var l=t.PriorityQueue.make();l.push(s,0);for(var u,d,a,f,c,p,h,b,v;!l.empty();){u=l.pop(),d=u.value,f=u.cost,c=r[d]||{};for(a in c)c.hasOwnProperty(a)&&(p=c[a],h=f+p,b=o[a],v=typeof o[a]>"u",(v||b>h)&&(o[a]=h,l.push(a,h),n[a]=d))}if(typeof i<"u"&&typeof o[i]>"u"){var m=["Could not find a path from ",s," to ",i,"."].join("");throw new Error(m)}return n},extract_shortest_path_from_predecessor_list:function(r,s){for(var i=[],n=s;n;)i.push(n),r[n],n=r[n];return i.reverse(),i},find_path:function(r,s,i){var n=t.single_source_shortest_paths(r,s,i);return t.extract_shortest_path_from_predecessor_list(n,i)},PriorityQueue:{make:function(r){var s=t.PriorityQueue,i={},n;r=r||{};for(n in s)s.hasOwnProperty(n)&&(i[n]=s[n]);return i.queue=[],i.sorter=r.sorter||s.default_sorter,i},default_sorter:function(r,s){return r.cost-s.cost},push:function(r,s){var i={value:r,cost:s};this.queue.push(i),this.queue.sort(this.sorter)},pop:function(){return this.queue.shift()},empty:function(){return this.queue.length===0}}};e.exports=t})(er)),er.exports}var Ns;function So(){return Ns||(Ns=1,(function(e){const t=Re(),r=vo(),s=_o(),i=wo(),n=Eo(),o=sn(),l=Ce(),u=xo();function d(m){return unescape(encodeURIComponent(m)).length}function a(m,y,_){const x=[];let I;for(;(I=m.exec(_))!==null;)x.push({data:I[0],index:I.index,mode:y,length:I[0].length});return x}function f(m){const y=a(o.NUMERIC,t.NUMERIC,m),_=a(o.ALPHANUMERIC,t.ALPHANUMERIC,m);let x,I;return l.isKanjiModeEnabled()?(x=a(o.BYTE,t.BYTE,m),I=a(o.KANJI,t.KANJI,m)):(x=a(o.BYTE_KANJI,t.BYTE,m),I=[]),y.concat(_,x,I).sort(function(g,w){return g.index-w.index}).map(function(g){return{data:g.data,mode:g.mode,length:g.length}})}function c(m,y){switch(y){case t.NUMERIC:return r.getBitsLength(m);case t.ALPHANUMERIC:return s.getBitsLength(m);case t.KANJI:return n.getBitsLength(m);case t.BYTE:return i.getBitsLength(m)}}function p(m){return m.reduce(function(y,_){const x=y.length-1>=0?y[y.length-1]:null;return x&&x.mode===_.mode?(y[y.length-1].data+=_.data,y):(y.push(_),y)},[])}function h(m){const y=[];for(let _=0;_<m.length;_++){const x=m[_];switch(x.mode){case t.NUMERIC:y.push([x,{data:x.data,mode:t.ALPHANUMERIC,length:x.length},{data:x.data,mode:t.BYTE,length:x.length}]);break;case t.ALPHANUMERIC:y.push([x,{data:x.data,mode:t.BYTE,length:x.length}]);break;case t.KANJI:y.push([x,{data:x.data,mode:t.BYTE,length:d(x.data)}]);break;case t.BYTE:y.push([{data:x.data,mode:t.BYTE,length:d(x.data)}])}}return y}function b(m,y){const _={},x={start:{}};let I=["start"];for(let A=0;A<m.length;A++){const g=m[A],w=[];for(let E=0;E<g.length;E++){const T=g[E],C=""+A+E;w.push(C),_[C]={node:T,lastCount:0},x[C]={};for(let O=0;O<I.length;O++){const S=I[O];_[S]&&_[S].node.mode===T.mode?(x[S][C]=c(_[S].lastCount+T.length,T.mode)-c(_[S].lastCount,T.mode),_[S].lastCount+=T.length):(_[S]&&(_[S].lastCount=T.length),x[S][C]=c(T.length,T.mode)+4+t.getCharCountIndicator(T.mode,y))}}I=w}for(let A=0;A<I.length;A++)x[I[A]].end=0;return{map:x,table:_}}function v(m,y){let _;const x=t.getBestModeForData(m);if(_=t.from(y,x),_!==t.BYTE&&_.bit<x.bit)throw new Error('"'+m+'" cannot be encoded with mode '+t.toString(_)+`.
 Suggested mode is: `+t.toString(x));switch(_===t.KANJI&&!l.isKanjiModeEnabled()&&(_=t.BYTE),_){case t.NUMERIC:return new r(m);case t.ALPHANUMERIC:return new s(m);case t.KANJI:return new n(m);case t.BYTE:return new i(m)}}e.fromArray=function(y){return y.reduce(function(_,x){return typeof x=="string"?_.push(v(x,null)):x.data&&_.push(v(x.data,x.mode)),_},[])},e.fromString=function(y,_){const x=f(y,l.isKanjiModeEnabled()),I=h(x),A=b(I,_),g=u.find_path(A.map,"start","end"),w=[];for(let E=1;E<g.length-1;E++)w.push(A.table[g[E]].node);return e.fromArray(p(w))},e.rawSplit=function(y){return e.fromArray(f(y,l.isKanjiModeEnabled()))}})(Jt)),Jt}var Os;function Ao(){if(Os)return jt;Os=1;const e=Ce(),t=Vr(),r=lo(),s=co(),i=uo(),n=fo(),o=po(),l=tn(),u=go(),d=bo(),a=yo(),f=Re(),c=So();function p(A,g){const w=A.size,E=n.getPositions(g);for(let T=0;T<E.length;T++){const C=E[T][0],O=E[T][1];for(let S=-1;S<=7;S++)if(!(C+S<=-1||w<=C+S))for(let q=-1;q<=7;q++)O+q<=-1||w<=O+q||(S>=0&&S<=6&&(q===0||q===6)||q>=0&&q<=6&&(S===0||S===6)||S>=2&&S<=4&&q>=2&&q<=4?A.set(C+S,O+q,!0,!0):A.set(C+S,O+q,!1,!0))}}function h(A){const g=A.size;for(let w=8;w<g-8;w++){const E=w%2===0;A.set(w,6,E,!0),A.set(6,w,E,!0)}}function b(A,g){const w=i.getPositions(g);for(let E=0;E<w.length;E++){const T=w[E][0],C=w[E][1];for(let O=-2;O<=2;O++)for(let S=-2;S<=2;S++)O===-2||O===2||S===-2||S===2||O===0&&S===0?A.set(T+O,C+S,!0,!0):A.set(T+O,C+S,!1,!0)}}function v(A,g){const w=A.size,E=d.getEncodedBits(g);let T,C,O;for(let S=0;S<18;S++)T=Math.floor(S/3),C=S%3+w-8-3,O=(E>>S&1)===1,A.set(T,C,O,!0),A.set(C,T,O,!0)}function m(A,g,w){const E=A.size,T=a.getEncodedBits(g,w);let C,O;for(C=0;C<15;C++)O=(T>>C&1)===1,C<6?A.set(C,8,O,!0):C<8?A.set(C+1,8,O,!0):A.set(E-15+C,8,O,!0),C<8?A.set(8,E-C-1,O,!0):C<9?A.set(8,15-C-1+1,O,!0):A.set(8,15-C-1,O,!0);A.set(E-8,8,1,!0)}function y(A,g){const w=A.size;let E=-1,T=w-1,C=7,O=0;for(let S=w-1;S>0;S-=2)for(S===6&&S--;;){for(let q=0;q<2;q++)if(!A.isReserved(T,S-q)){let D=!1;O<g.length&&(D=(g[O]>>>C&1)===1),A.set(T,S-q,D),C--,C===-1&&(O++,C=7)}if(T+=E,T<0||w<=T){T-=E,E=-E;break}}}function _(A,g,w){const E=new r;w.forEach(function(q){E.put(q.mode.bit,4),E.put(q.getLength(),f.getCharCountIndicator(q.mode,A)),q.write(E)});const T=e.getSymbolTotalCodewords(A),C=l.getTotalCodewordsCount(A,g),O=(T-C)*8;for(E.getLengthInBits()+4<=O&&E.put(0,4);E.getLengthInBits()%8!==0;)E.putBit(0);const S=(O-E.getLengthInBits())/8;for(let q=0;q<S;q++)E.put(q%2?17:236,8);return x(E,A,g)}function x(A,g,w){const E=e.getSymbolTotalCodewords(g),T=l.getTotalCodewordsCount(g,w),C=E-T,O=l.getBlocksCount(g,w),S=E%O,q=O-S,D=Math.floor(E/O),M=Math.floor(C/O),F=M+1,$=D-M,Tt=new u($);let Ct=0;const lt=new Array(O),Kr=new Array(O);let Rt=0;const gn=new Uint8Array(A.buffer);for(let Oe=0;Oe<O;Oe++){const Ot=Oe<q?M:F;lt[Oe]=gn.slice(Ct,Ct+Ot),Kr[Oe]=Tt.encode(lt[Oe]),Ct+=Ot,Rt=Math.max(Rt,Ot)}const Nt=new Uint8Array(E);let Zr=0,oe,ae;for(oe=0;oe<Rt;oe++)for(ae=0;ae<O;ae++)oe<lt[ae].length&&(Nt[Zr++]=lt[ae][oe]);for(oe=0;oe<$;oe++)for(ae=0;ae<O;ae++)Nt[Zr++]=Kr[ae][oe];return Nt}function I(A,g,w,E){let T;if(Array.isArray(A))T=c.fromArray(A);else if(typeof A=="string"){let D=g;if(!D){const M=c.rawSplit(A);D=d.getBestVersionForData(M,w)}T=c.fromString(A,D||40)}else throw new Error("Invalid data");const C=d.getBestVersionForData(T,w);if(!C)throw new Error("The amount of data is too big to be stored in a QR Code");if(!g)g=C;else if(g<C)throw new Error(`
The chosen QR Code version cannot contain this amount of data.
Minimum version required to store current data is: `+C+`.
`);const O=_(g,w,T),S=e.getSymbolSize(g),q=new s(S);return p(q,g),h(q),b(q,g),m(q,w,0),g>=7&&v(q,g),y(q,O),isNaN(E)&&(E=o.getBestMask(q,m.bind(null,q,w))),o.applyMask(E,q),m(q,w,E),{modules:q,version:g,errorCorrectionLevel:w,maskPattern:E,segments:T}}return jt.create=function(g,w){if(typeof g>"u"||g==="")throw new Error("No input text");let E=t.M,T,C;return typeof w<"u"&&(E=t.from(w.errorCorrectionLevel,t.M),T=d.from(w.version),C=o.from(w.maskPattern),w.toSJISFunc&&e.setToSJISFunction(w.toSJISFunc)),I(g,T,E,C)},jt}var tr={},rr={},Is;function nn(){return Is||(Is=1,(function(e){function t(r){if(typeof r=="number"&&(r=r.toString()),typeof r!="string")throw new Error("Color should be defined as hex string");let s=r.slice().replace("#","").split("");if(s.length<3||s.length===5||s.length>8)throw new Error("Invalid hex color: "+r);(s.length===3||s.length===4)&&(s=Array.prototype.concat.apply([],s.map(function(n){return[n,n]}))),s.length===6&&s.push("F","F");const i=parseInt(s.join(""),16);return{r:i>>24&255,g:i>>16&255,b:i>>8&255,a:i&255,hex:"#"+s.slice(0,6).join("")}}e.getOptions=function(s){s||(s={}),s.color||(s.color={});const i=typeof s.margin>"u"||s.margin===null||s.margin<0?4:s.margin,n=s.width&&s.width>=21?s.width:void 0,o=s.scale||4;return{width:n,scale:n?4:o,margin:i,color:{dark:t(s.color.dark||"#000000ff"),light:t(s.color.light||"#ffffffff")},type:s.type,rendererOpts:s.rendererOpts||{}}},e.getScale=function(s,i){return i.width&&i.width>=s+i.margin*2?i.width/(s+i.margin*2):i.scale},e.getImageWidth=function(s,i){const n=e.getScale(s,i);return Math.floor((s+i.margin*2)*n)},e.qrToImageData=function(s,i,n){const o=i.modules.size,l=i.modules.data,u=e.getScale(o,n),d=Math.floor((o+n.margin*2)*u),a=n.margin*u,f=[n.color.light,n.color.dark];for(let c=0;c<d;c++)for(let p=0;p<d;p++){let h=(c*d+p)*4,b=n.color.light;if(c>=a&&p>=a&&c<d-a&&p<d-a){const v=Math.floor((c-a)/u),m=Math.floor((p-a)/u);b=f[l[v*o+m]?1:0]}s[h++]=b.r,s[h++]=b.g,s[h++]=b.b,s[h]=b.a}}})(rr)),rr}var Ls;function To(){return Ls||(Ls=1,(function(e){const t=nn();function r(i,n,o){i.clearRect(0,0,n.width,n.height),n.style||(n.style={}),n.height=o,n.width=o,n.style.height=o+"px",n.style.width=o+"px"}function s(){try{return document.createElement("canvas")}catch{throw new Error("You need to specify a canvas element")}}e.render=function(n,o,l){let u=l,d=o;typeof u>"u"&&(!o||!o.getContext)&&(u=o,o=void 0),o||(d=s()),u=t.getOptions(u);const a=t.getImageWidth(n.modules.size,u),f=d.getContext("2d"),c=f.createImageData(a,a);return t.qrToImageData(c.data,n,u),r(f,d,a),f.putImageData(c,0,0),d},e.renderToDataURL=function(n,o,l){let u=l;typeof u>"u"&&(!o||!o.getContext)&&(u=o,o=void 0),u||(u={});const d=e.render(n,o,u),a=u.type||"image/png",f=u.rendererOpts||{};return d.toDataURL(a,f.quality)}})(tr)),tr}var sr={},qs;function Co(){if(qs)return sr;qs=1;const e=nn();function t(i,n){const o=i.a/255,l=n+'="'+i.hex+'"';return o<1?l+" "+n+'-opacity="'+o.toFixed(2).slice(1)+'"':l}function r(i,n,o){let l=i+n;return typeof o<"u"&&(l+=" "+o),l}function s(i,n,o){let l="",u=0,d=!1,a=0;for(let f=0;f<i.length;f++){const c=Math.floor(f%n),p=Math.floor(f/n);!c&&!d&&(d=!0),i[f]?(a++,f>0&&c>0&&i[f-1]||(l+=d?r("M",c+o,.5+p+o):r("m",u,0),u=0,d=!1),c+1<n&&i[f+1]||(l+=r("h",a),a=0)):u++}return l}return sr.render=function(n,o,l){const u=e.getOptions(o),d=n.modules.size,a=n.modules.data,f=d+u.margin*2,c=u.color.light.a?"<path "+t(u.color.light,"fill")+' d="M0 0h'+f+"v"+f+'H0z"/>':"",p="<path "+t(u.color.dark,"stroke")+' d="'+s(a,d,u.margin)+'"/>',h='viewBox="0 0 '+f+" "+f+'"',v='<svg xmlns="http://www.w3.org/2000/svg" '+(u.width?'width="'+u.width+'" height="'+u.width+'" ':"")+h+' shape-rendering="crispEdges">'+c+p+`</svg>
...
${w}`,pendingAction:{tool:I,args:A,description:w}})}const g=await jo(I,A,u,e);p.push({role:"assistant",content:y.content||null,tool_calls:_}),p.push({role:"tool",content:JSON.stringify(g),tool_call_id:x.id})}return e.json({reply:"Não consegui completar a consulta. Tente reformular sua pergunta."})}catch(i){return console.error("Agent error:",i),e.json({error:i.message||"Erro no agente"},500)}});const Bo=[{type:"function",function:{name:"list_courses",description:"Lista todos os cursos publicados disponíveis na plataforma, com id, título e carga horária.",parameters:{type:"object",properties:{}}}},{type:"function",function:{name:"get_course_details",description:"Retorna os módulos e a quantidade de aulas de um curso publicado.",parameters:{type:"object",properties:{course_id:{type:"number",description:"ID do curso"}},required:["course_id"]}}},{type:"function",function:{name:"get_my_progress",description:"Retorna o progresso do aluno autenticado em todos os cursos que ele já iniciou: % concluído, aulas completadas e aulas totais por curso.",parameters:{type:"object",properties:{}}}},{type:"function",function:{name:"recommend_next_lessons",description:"Recomenda as próximas aulas que o aluno autenticado ainda não assistiu. Se course_id for informado, recomenda dentro daquele curso; caso contrário, considera todos os cursos que o aluno já iniciou.",parameters:{type:"object",properties:{course_id:{type:"number",description:"ID do curso (opcional)"},limit:{type:"number",description:"Máximo de aulas a recomendar (padrão 5)"}}}}},{type:"function",function:{name:"search_lessons",description:"Busca aulas por título/palavra-chave em cursos publicados.",parameters:{type:"object",properties:{query:{type:"string",description:"Termo de busca no título da aula"},limit:{type:"number",description:"Máximo de resultados (padrão 10)"}},required:["query"]}}},{type:"function",function:{name:"get_my_certificates",description:"Lista os certificados já emitidos para o aluno autenticado.",parameters:{type:"object",properties:{}}}}];async function Mo(e,t,r,s){switch(e){case"list_courses":return{courses:await r.sql("SELECT id, title, instructor, duration_hours FROM courses WHERE is_published = true ORDER BY title")};case"get_course_details":{const[i,n]=await Promise.all([r.sql("SELECT id, title, description, instructor, duration_hours FROM courses WHERE id = $1 AND is_published = true",[t.course_id]),r.sql(`SELECT m.id, m.title, m.order_index, COUNT(l.id)::int as lesson_count
         ...
         LIMIT ${i}`,o)).map(d=>({...d,lesson_url:`/aula/${d.lesson_id}`}));return{recommended_lessons:u,count:u.length}}case"search_lessons":{const i=Math.min(t.limit||10,50),o=(await r.sql(`SELECT l.id, l.title, m.title as module_title, c.title as course_title, c.id as course_id
         FROM lessons l JOIN modules m ON m.id = l.module_id JOIN courses c ON c.id = m.course_id
         WHERE l.title ILIKE $1 AND c.is_published = true
         ORDER BY l.title LIMIT $2`,[`%${t.query}%`,i])).map(l=>({...l,lesson_url:`/aula/${l.id}`}));return{lessons:o,count:o.length}}case"get_my_certificates":return{certificates:await r.sql(`SELECT id, course_title, carga_horaria, certificate_code, completion_date FROM certificates
