...
`;return typeof l=="function"&&l(null,v),v},Yt}var Es;function vo(){if(Es)return Ie;Es=1;const e=Zi(),t=go(),r=bo(),s=yo();function n(i,o,l,c,u){const a=[].slice.call(arguments,1),f=a.length,d=typeof a[f-1]=="function";if(!d&&!e())throw new Error("Callback required as last argument");if(d){if(f<2)throw new Error("Too few arguments provided");f===2?(u=l,l=o,o=c=void 0):f===3&&(o.getContext&&typeof u>"u"?(u=c,c=void 0):(u=c,c=l,l=o,o=void 0))}else{if(f<1)throw new Error("Too few arguments provided");return f===1?(l=o,o=c=void 0):f===2&&!o.getContext&&(c=l,l=o,o=void 0),new Promise(function(h,m){try{const y=t.create(l,c);h(i(y,o,c))}catch(y){m(y)}})}try{const h=t.create(l,c);u(null,i(h,o,c))}catch(h){u(h)}}return Ie.create=t.create,Ie.toCanvas=n.bind(null,r.render),Ie.toDataURL=n.bind(null,r.renderToDataURL),Ie.toString=n.bind(null,function(i,o,l){return s.render(i,l)}),Ie}var wo=vo();const xo=zn(wo),I=new Fn;function q(e){const t=e.env.DATABASE_CCT;if(!t)throw new Error("DATABASE_CCT não configurado nas variáveis de ambiente");return new qr(t)}function Gn(e){const t=e.env.DATABASE_URL_CREDITOS||e.env.DATABASE_SUITEPLUS;if(!t)throw new Error("DATABASE_URL_CREDITOS não configurado");return new qr(t)}async function Jn(e){await e.sql(`
