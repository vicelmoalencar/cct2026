...
`;return typeof a=="function"&&a(null,v),v},Kt}var Ss;function wo(){if(Ss)return Ne;Ss=1;const e=$i(),t=bo(),r=yo(),s=vo();function n(i,o,a,c,u){const l=[].slice.call(arguments,1),f=l.length,d=typeof l[f-1]=="function";if(!d&&!e())throw new Error("Callback required as last argument");if(d){if(f<2)throw new Error("Too few arguments provided");f===2?(u=a,a=o,o=c=void 0):f===3&&(o.getContext&&typeof u>"u"?(u=c,c=void 0):(u=c,c=a,a=o,o=void 0))}else{if(f<1)throw new Error("Too few arguments provided");return f===1?(a=o,o=c=void 0):f===2&&!o.getContext&&(c=a,a=o,o=void 0),new Promise(function(h,m){try{const y=t.create(a,c);h(i(y,o,c))}catch(y){m(y)}})}try{const h=t.create(a,c);u(null,i(h,o,c))}catch(h){u(h)}}return Ne.create=t.create,Ne.toCanvas=n.bind(null,r.render),Ne.toDataURL=n.bind(null,r.renderToDataURL),Ne.toString=n.bind(null,function(i,o,a){return s.render(i,a)}),Ne}var xo=wo();const Eo=Qn(xo),I=new zn;function q(e){const t=e.env.DATABASE_CCT;if(!t)throw new Error("DATABASE_CCT não configurado nas variáveis de ambiente");return new Or(t)}function Jn(e){const t=e.env.DATABASE_URL_CREDITOS||e.env.DATABASE_SUITEPLUS;if(!t)throw new Error("DATABASE_URL_CREDITOS não configurado");return new Or(t)}async function Yn(e){await e.sql(`
  ...
  `),await e.sql("CREATE INDEX IF NOT EXISTS idx_users_credits_email ON users_credits(lower(user_email))")}async function Dr(e,t){await Yn(e);const r=await e.sql("SELECT credits_balance FROM users_credits WHERE lower(user_email) = lower($1)",[t]);return r.length>0?parseInt(r[0].credits_balance):0}async function So(e,t,r){return await Yn(e),(await e.sql(`UPDATE users_credits
     SET credits_balance = credits_balance - $1,
         total_credits_used = COALESCE(total_credits_used, 0) + $1,
         updated_at = NOW()
     WHERE lower(user_email) = lower($2)
       AND credits_balance >= $1
     RETURNING credits_balance`,[r,t])).length>0}async function jr(e){await e.sql("ALTER TABLE lessons ADD COLUMN IF NOT EXISTS rentable BOOLEAN DEFAULT FALSE"),await e.sql("ALTER TABLE lessons ADD COLUMN IF NOT EXISTS rental_credits INTEGER DEFAULT 0"),await e.sql(`
...
<body>
  ...
  <div class="page">
    ...
    <div class="logo-section">
      <img class="logo-img" src="${Jr}" alt="Ensino Plus"/>
    </div>
...
<body class="bg-gray-100 p-8">
  ...
  `));I.get("/",e=>e.html(`
    ...
    <body class="bg-gray-50">
        ...
        <script defer src="/static/app.js?v=8"><\/script>
        <script defer src="/static/search.js?v=2"><\/script>
    </body>
    </html>
  `));I.get("/api/favorites",K,async e=>{const t=e.get("user"),r=q(e);try{const s=await r.sql(`
