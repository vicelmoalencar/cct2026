...
Crie alternativas plausiveis, gabarito comentado e fundamentacao tecnica. Tipos desejados: ${a.join(", ")}. Dificuldade: ${u}. Quantidade: ${o}.
...
${(t.emails||[]).join(`
`)}`;default:return`Executar ação **${e}** com args: ${JSON.stringify(t)}`}}async function jo(e,t,r,s){var n,i,o,a,u,d,l;switch(e){case"search_users":{const f=`%${t.query}%`,c=Math.min(t.limit||10,50),p=await r.sql(`SELECT u.id, u.email, u.nome, u.ativo, u.dt_expiracao,
         ...
         WHERE l.id = $1`,[t.lesson_id]))[0]||null};case"list_comments":{const f=Math.min(t.limit||20,100);return{comments:t.lesson_id?await r.sql("SELECT * FROM comments WHERE lesson_id = $1 ORDER BY created_at DESC LIMIT $2",[t.lesson_id,f]):await r.sql("SELECT * FROM comments ORDER BY created_at DESC LIMIT $1",[f])}}case"dashboard_stats":{const[f,c,p,h,b,v,m]=await Promise.all([r.sql("SELECT COUNT(*)::int as total FROM users"),r.sql("SELECT COUNT(*)::int as total FROM member_subscriptions WHERE data_expiracao > NOW() AND ativo = true"),r.sql("SELECT COUNT(*)::int as total FROM certificates"),r.sql("SELECT COUNT(*)::int as total FROM comments WHERE admin_reply IS NULL"),r.sql("SELECT COUNT(*)::int as total FROM courses"),r.sql("SELECT COUNT(*)::int as total FROM lessons"),(()=>{const y=s.env.DATABASE_SUITEPLUS;return y?new $e(y).sql("SELECT COUNT(*)::int as total FROM user_subscriptions WHERE status = 'active' AND product_id = 4 AND expires_at > NOW()").catch(()=>[{total:null}]):Promise.resolve([{total:null}])})()]);return{total_users:(n=f[0])==null?void 0:n.total,active_subscriptions_cct:(i=c[0])==null?void 0:i.total,active_subscriptions_suiteplus:(o=m[0])==null?void 0:o.total,total_certificates:(a=p[0])==null?void 0:a.total,pending_comments:(u=h[0])==null?void 0:u.total,total_courses:(d=b[0])==null?void 0:d.total,total_lessons:(l=v[0])==null?void 0:l.total}}case"get_user_progress":{const c=(await r.sql(`SELECT c.id as course_id, c.title as course_title,
         ...
         ORDER BY created_at DESC LIMIT $1`,[c]);return{signups:p,count:p.length,days:f}}case"search_lessons":{const f=Math.min(t.limit||20,50),c=`%${t.query}%`,p=t.course_id?await r.sql(`SELECT l.id, l.title, l.duration_minutes, l.teste_gratis, l.rentable, l.order_index,
             ...
             ORDER BY c.title, m.order_index, l.order_index LIMIT $3`,[c,t.course_id,f]):await r.sql(`SELECT l.id, l.title, l.duration_minutes, l.teste_gratis, l.rentable, l.order_index,
                    m.title as module_title, c.title as course_title, c.id as course_id
             FROM lessons l JOIN modules m ON m.id = l.module_id JOIN courses c ON c.id = m.course_id
             WHERE l.title ILIKE $1
             ORDER BY c.title, m.order_index, l.order_index LIMIT $2`,[c,f]);return{lessons:p,count:p.length}}case"search_suiteplus_subscriptions":{const f=s.env.DATABASE_SUITEPLUS;if(!f)return{error:"DATABASE_SUITEPLUS não configurada"};const c=new $e(f),p=Math.min(t.limit||20,100);let h;return t.email?h=await c.sql(`SELECT id, user_email, product_id, started_at, expires_at, status, payment_source, recurring_enabled
...
<body>
  ...
  <script>window.onload=function(){document.querySelectorAll('.qr-wrap svg').forEach(function(s){s.setAttribute('width','60');s.setAttribute('height','60');})}<\/script>
    ...
    <script src="https://cdn.tailwindcss.com"><\/script>
      ...
      `);const n=s[0];try{await r.update("certificates",{id:n.id},{verification_count:(n.verification_count||0)+1})}catch{}const i=n.start_date?new Date(n.start_date).toLocaleDateString("pt-BR"):void 0,o=n.completion_date?new Date(n.completion_date).toLocaleDateString("pt-BR"):void 0,a=n.generated_at?new Date(n.generated_at).toLocaleDateString("pt-BR"):new Date().toLocaleDateString("pt-BR");let u=[];if(n.course_modules)try{u=JSON.parse(n.course_modules).map(f=>f.title||f)}catch(l){console.log("Error parsing course_modules:",l)}if(u.length===0&&n.course_id)try{const l=await r.query("modules",{select:"title, order_index",filters:{course_id:n.course_id},order:"order_index ASC"});l&&l.length>0&&(u=l.map(f=>f.title))}catch(l){console.log("Error fetching modules:",l)}const d=u.length>0?`
    ...
    `);return e.json({courses:o})}catch(t){return console.error("❌ /api/courses error:",(t==null?void 0:t.message)||t),e.json({error:(t==null?void 0:t.message)||"Failed to fetch courses"},500)}});R.get("/api/courses/:id",async e=>{try{const t=e.req.param("id"),r=P(e),s=await r.query("courses",{select:"*",filters:{id:t},single:!0});if(!s)return e.json({error:"Course not found"},404);const n=await r.query("modules",{select:"*",filters:{course_id:t},order:"order_index"}),i=await r.sql(`SELECT l.* FROM lessons l
       JOIN modules m ON m.id = l.module_id
       WHERE m.course_id = $1
       ORDER BY m.order_index, l.order_index`,[t]),o=new Map;for(const a of i){const u=o.get(a.module_id)||[];u.push(a),o.set(a.module_id,u)}for(const a of n)a.lessons=o.get(a.id)||[];return e.json({course:s,modules:n})}catch(t){return console.error("❌ /api/courses/:id error:",(t==null?void 0:t.message)||t),e.json({error:(t==null?void 0:t.message)||"Failed to fetch course"},500)}});R.get("/api/lessons/:id",async e=>{var t,r,s,n;try{const i=e.req.param("id"),o=V(e,"sb-access-token");let a=null;if(o){const m=await G(o,e.env.SUPABASE_URL,e.env.SUPABASE_ANON_KEY);m&&(a=m.email)}const u=P(e);let d=!1,l=!1;if(a)try{if(d=!!((t=(await u.sql("SELECT user_has_lesson_access($1::text, $2::integer) AS has_access",[a,parseInt(i)]))[0])!=null&&t.has_access),console.log("Has access:",d,"User:",a,"Lesson:",i),!d){const y=e.env.DATABASE_SUITEPLUS,[w,S,I]=await Promise.all([u.sql("SELECT expires_at FROM lesson_rentals WHERE user_email = $1 AND lesson_id = $2 AND expires_at > NOW()",[a,parseInt(i)]),u.sql("SELECT id FROM member_subscriptions WHERE email_membro = $1 AND data_expiracao > NOW() AND ativo = true LIMIT 1",[a]),y?Et(a,y):Promise.resolve(null)]);if((w.length>0||S.length>0||I&&I>new Date)&&(d=!0),!d){const A=await u.sql("SELECT rentable, rental_credits, title FROM lessons WHERE id = $1",[parseInt(i)]);return console.log("❌ Access denied for user:",a,"lesson:",i),e.json({error:"Access denied",message:"Você não tem permissão para acessar esta aula.",needsUpgrade:!0,rentable:((r=A[0])==null?void 0:r.rentable)||!1,rental_credits:((s=A[0])==null?void 0:s.rental_credits)||0,lesson_title:((n=A[0])==null?void 0:n.title)||""},403)}}console.log("✅ Access granted for user:",a,"lesson:",i)}catch(m){console.error("❌ Error checking access via RPC:",m),console.log("⚠️ Allowing access due to RPC error (fallback mode)"),l=!0,d=!0}if(!a||!d&&!l){const m=await u.query("lessons",{select:"teste_gratis",filters:{id:i},single:!0});if(!(m!=null&&m.teste_gratis))return e.json({error:"Access denied",message:"Esta é uma aula premium. Faça login e tenha um plano ativo para acessar.",needsLogin:!0},403)}await _t(u);const f=`
    ...
    `,[p,h,b]=await Promise.all([u.sql(f,[parseInt(i)]),u.sql("SELECT * FROM comments WHERE lesson_id = $1 ORDER BY created_at DESC",[i]),u.sql(c,[parseInt(i)])]);if(!p||p.length===0)return e.json({error:"Lesson not found"},404);const v=p[0];return e.json({lesson:v,comments:h,trails:b})}catch(i){return console.error("Error fetching lesson:",i),e.json({error:"Failed to fetch lesson"},500)}});R.get("/api/admin/comments",q,async e=>{try{const t=e.req.query("status")||"all",r=(e.req.query("search")||"").trim(),s=P(e);await _t(s);const n=[],i=[];t==="pending"?n.push("NULLIF(TRIM(COALESCE(c.admin_reply, '')), '') IS NULL"):t==="answered"&&n.push("NULLIF(TRIM(COALESCE(c.admin_reply, '')), '') IS NOT NULL"),r&&(i.push(`%${r}%`),n.push(`(
...
<body class="bg-gray-50">
  ...
  `));const Ds=new ei,Mo=Object.assign({"/src/index.tsx":R});let oi=!1;for(const[,e]of Object.entries(Mo))e&&(Ds.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Ds.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),oi=!0);if(!oi)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");var ar={exports:{}},lr={exports:{}},Pe={},cr={},js;function ai(){if(js)return cr;js=1,cr.parse=function(r,s){return new e(r,s).parse()};class e{constructor(s,n){this.source=s,this.transform=n||t,this.position=0,this.entries=[],this.recorded=[],this.dimension=0}isEof(){return this.position>=this.source.length}nextCharacter(){var s=this.source[this.position++];return s==="\\"?{value:this.source[this.position++],escaped:!0}:{value:s,escaped:!1}}record(s){this.recorded.push(s)}newEntry(s){var n;(this.recorded.length>0||s)&&(n=this.recorded.join(""),n==="NULL"&&!s&&(n=null),n!==null&&(n=this.transform(n)),this.entries.push(n),this.recorded=[])}consumeDimensions(){if(this.source[0]==="[")for(;!this.isEof();){var s=this.nextCharacter();if(s.value==="=")break}}parse(s){var n,i,o;for(this.consumeDimensions();!this.isEof();)if(n=this.nextCharacter(),n.value==="{"&&!o)this.dimension++,this.dimension>1&&(i=new e(this.source.substr(this.position-1),this.transform),this.entries.push(i.parse(!0)),this.position+=i.position-2);else if(n.value==="}"&&!o){if(this.dimension--,!this.dimension&&(this.newEntry(),s))return this.entries}else n.value==='"'&&!n.escaped?(o&&this.newEntry(!0),o=!o):n.value===","&&!o?this.newEntry():this.record(n.value);if(this.dimension!==0)throw new Error("array dimension not balanced");return this.entries}}function t(r){return r}return cr}var ur,ks;function li(){if(ks)return ur;ks=1;var e=ai();return ur={create:function(t,r){return{parse:function(){return e.parse(t,r)}}}},ur}var dr,Bs;function Uo(){if(Bs)return dr;Bs=1;var e=/(\d{1,})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})(\.\d{1,})?.*?( BC)?$/,t=/^(\d{1,})-(\d{2})-(\d{2})( BC)?$/,r=/([Z+-])(\d{2})?:?(\d{2})?:?(\d{2})?/,s=/^-?infinity$/;dr=function(d){if(s.test(d))return Number(d.replace("i","I"));var l=e.exec(d);if(!l)return n(d)||null;var f=!!l[8],c=parseInt(l[1],10);f&&(c=o(c));var p=parseInt(l[2],10)-1,h=l[3],b=parseInt(l[4],10),v=parseInt(l[5],10),m=parseInt(l[6],10),y=l[7];y=y?1e3*parseFloat(y):0;var w,S=i(d);return S!=null?(w=new Date(Date.UTC(c,p,h,b,v,m,y)),a(c)&&w.setUTCFullYear(c),S!==0&&w.setTime(w.getTime()-S)):(w=new Date(c,p,h,b,v,m,y),a(c)&&w.setFullYear(c)),w};function n(u){var d=t.exec(u);if(d){var l=parseInt(d[1],10),f=!!d[4];f&&(l=o(l));var c=parseInt(d[2],10)-1,p=d[3],h=new Date(l,c,p);return a(l)&&h.setFullYear(l),h}}function i(u){if(u.endsWith("+00"))return 0;var d=r.exec(u.split(" ")[1]);if(d){var l=d[1];if(l==="Z")return 0;var f=l==="-"?-1:1,c=parseInt(d[2],10)*3600+parseInt(d[3]||0,10)*60+parseInt(d[4]||0,10);return c*f*1e3}}function o(u){return-(u-1)}function a(u){return u>=0&&u<100}return dr}var fr,Ms;function Fo(){if(Ms)return fr;Ms=1,fr=t;var e=Object.prototype.hasOwnProperty;function t(r){for(var s=1;s<arguments.length;s++){var n=arguments[s];for(var i in n)e.call(n,i)&&(r[i]=n[i])}return r}return fr}var pr,Us;function Ho(){if(Us)return pr;Us=1;var e=Fo();pr=t;function t(v){if(!(this instanceof t))return new t(v);e(this,b(v))}var r=["seconds","minutes","hours","days","months","years"];t.prototype.toPostgres=function(){var v=r.filter(this.hasOwnProperty,this);return this.milliseconds&&v.indexOf("seconds")<0&&v.push("seconds"),v.length===0?"0":v.map(function(m){var y=this[m]||0;return m==="seconds"&&this.milliseconds&&(y=(y+this.milliseconds/1e3).toFixed(6).replace(/\.?0+$/,"")),y+" "+m},this).join(" ")};var s={years:"Y",months:"M",days:"D",hours:"H",minutes:"M",seconds:"S"},n=["years","months","days"],i=["hours","minutes","seconds"];t.prototype.toISOString=t.prototype.toISO=function(){var v=n.map(y,this).join(""),m=i.map(y,this).join("");return"P"+v+"T"+m;function y(w){var S=this[w]||0;return w==="seconds"&&this.milliseconds&&(S=(S+this.milliseconds/1e3).toFixed(6).replace(/0+$/,"")),S+s[w]}};var o="([+-]?\\d+)",a=o+"\\s+years?",u=o+"\\s+mons?",d=o+"\\s+days?",l="([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",f=new RegExp([a,u,d,l].map(function(v){return"("+v+")?"}).join("\\s*")),c={years:2,months:4,days:6,hours:9,minutes:10,seconds:11,milliseconds:12},p=["hours","minutes","seconds","milliseconds"];function h(v){var m=v+"000000".slice(v.length);return parseInt(m,10)/1e3}function b(v){if(!v)return{};var m=f.exec(v),y=m[8]==="-";return Object.keys(c).reduce(function(w,S){var I=c[S],A=m[I];return!A||(A=S==="milliseconds"?h(A):parseInt(A,10),!A)||(y&&~p.indexOf(S)&&(A*=-1),w[S]=A),w},{})}return pr}var mr,Fs;function $o(){if(Fs)return mr;Fs=1;var e=Buffer.from||Buffer;return mr=function(r){if(/^\\x/.test(r))return e(r.substr(2),"hex");for(var s="",n=0;n<r.length;)if(r[n]!=="\\")s+=r[n],++n;else if(/[0-7]{3}/.test(r.substr(n+1,3)))s+=String.fromCharCode(parseInt(r.substr(n+1,3),8)),n+=4;else{for(var i=1;n+i<r.length&&r[n+i]==="\\";)i++;for(var o=0;o<Math.floor(i/2);++o)s+="\\";n+=Math.floor(i/2)*2}return e(s,"binary")},mr}var hr,Hs;function zo(){if(Hs)return hr;Hs=1;var e=ai(),t=li(),r=Uo(),s=Ho(),n=$o();function i(g){return function(_){return _===null?_:g(_)}}function o(g){return g===null?g:g==="TRUE"||g==="t"||g==="true"||g==="y"||g==="yes"||g==="on"||g==="1"}function a(g){return g?e.parse(g,o):null}function u(g){return parseInt(g,10)}function d(g){return g?e.parse(g,i(u)):null}function l(g){return g?e.parse(g,i(function(x){return y(x).trim()})):null}var f=function(g){if(!g)return null;var x=t.create(g,function(_){return _!==null&&(_=S(_)),_});return x.parse()},c=function(g){if(!g)return null;var x=t.create(g,function(_){return _!==null&&(_=parseFloat(_)),_});return x.parse()},p=function(g){if(!g)return null;var x=t.create(g);return x.parse()},h=function(g){if(!g)return null;var x=t.create(g,function(_){return _!==null&&(_=r(_)),_});return x.parse()},b=function(g){if(!g)return null;var x=t.create(g,function(_){return _!==null&&(_=s(_)),_});return x.parse()},v=function(g){return g?e.parse(g,i(n)):null},m=function(g){return parseInt(g,10)},y=function(g){var x=String(g);return/^\d+$/.test(x)?x:g},w=function(g){return g?e.parse(g,i(JSON.parse)):null},S=function(g){return g[0]!=="("?null:(g=g.substring(1,g.length-1).split(","),{x:parseFloat(g[0]),y:parseFloat(g[1])})},I=function(g){if(g[0]!=="<"&&g[1]!=="(")return null;for(var x="(",_="",T=!1,C=2;C<g.length-1;C++){if(T||(x+=g[C]),g[C]===")"){T=!0;continue}else if(!T)continue;g[C]!==","&&(_+=g[C])}var O=S(x);return O.radius=parseFloat(_),O},A=function(g){g(20,y),g(21,m),g(23,m),g(26,m),g(700,parseFloat),g(701,parseFloat),g(16,o),g(1082,r),g(1114,r),g(1184,r),g(600,S),g(651,p),g(718,I),g(1e3,a),g(1001,v),g(1005,d),g(1007,d),g(1028,d),g(1016,l),g(1017,f),g(1021,c),g(1022,c),g(1231,c),g(1014,p),g(1015,p),g(1008,p),g(1009,p),g(1040,p),g(1041,p),g(1115,h),g(1182,h),g(1185,h),g(1186,s),g(1187,b),g(17,n),g(114,JSON.parse.bind(JSON)),g(3802,JSON.parse.bind(JSON)),g(199,w),g(3807,w),g(3907,p),g(2951,p),g(791,p),g(1183,p),g(1270,p)};return hr={init:A},hr}var gr,$s;function Wo(){if($s)return gr;$s=1;var e=1e6;function t(r){var s=r.readInt32BE(0),n=r.readUInt32BE(4),i="";s<0&&(s=~s+(n===0),n=~n+1>>>0,i="-");var o="",a,u,d,l,f,c;{if(a=s%e,s=s/e>>>0,u=4294967296*a+n,n=u/e>>>0,d=""+(u-e*n),n===0&&s===0)return i+d+o;for(l="",f=6-d.length,c=0;c<f;c++)l+="0";o=l+d+o}{if(a=s%e,s=s/e>>>0,u=4294967296*a+n,n=u/e>>>0,d=""+(u-e*n),n===0&&s===0)return i+d+o;for(l="",f=6-d.length,c=0;c<f;c++)l+="0";o=l+d+o}{if(a=s%e,s=s/e>>>0,u=4294967296*a+n,n=u/e>>>0,d=""+(u-e*n),n===0&&s===0)return i+d+o;for(l="",f=6-d.length,c=0;c<f;c++)l+="0";o=l+d+o}return a=s%e,u=4294967296*a+n,d=""+u%e,i+d+o}return gr=t,gr}var br,zs;function Vo(){if(zs)return br;zs=1;var e=Wo(),t=function(p,h,b,v,m){b=b||0,v=v||!1,m=m||function(T,C,O){return T*Math.pow(2,O)+C};var y=b>>3,w=function(T){return v?~T&255:T},S=255,I=8-b%8;h<I&&(S=255<<8-h&255,I=h),b&&(S=S>>b%8);var A=0;b%8+h>=8&&(A=m(0,w(p[y])&S,I));for(var g=h+b>>3,x=y+1;x<g;x++)A=m(A,w(p[x]),8);var _=(h+b)%8;return _>0&&(A=m(A,w(p[g])>>8-_,_)),A},r=function(p,h,b){var v=Math.pow(2,b-1)-1,m=t(p,1),y=t(p,b,1);if(y===0)return 0;var w=1,S=function(A,g,x){A===0&&(A=1);for(var _=1;_<=x;_++)w/=2,(g&1<<x-_)>0&&(A+=w);return A},I=t(p,h,b+1,!1,S);return y==Math.pow(2,b+1)-1?I===0?m===0?1/0:-1/0:NaN:(m===0?1:-1)*Math.pow(2,y-v)*I},s=function(p){return t(p,1)==1?-1*(t(p,15,1,!0)+1):t(p,15,1)},n=function(p){return t(p,1)==1?-1*(t(p,31,1,!0)+1):t(p,31,1)},i=function(p){return r(p,23,8)},o=function(p){return r(p,52,11)},a=function(p){var h=t(p,16,32);if(h==49152)return NaN;for(var b=Math.pow(1e4,t(p,16,16)),v=0,m=t(p,16),y=0;y<m;y++)v+=t(p,16,64+16*y)*b,b/=1e4;var w=Math.pow(10,t(p,16,48));return(h===0?1:-1)*Math.round(v*w)/w},u=function(p,h){var b=t(h,1),v=t(h,63,1),m=new Date((b===0?1:-1)*v/1e3+9466848e5);return p||m.setTime(m.getTime()+m.getTimezoneOffset()*6e4),m.usec=v%1e3,m.getMicroSeconds=function(){return this.usec},m.setMicroSeconds=function(y){this.usec=y},m.getUTCMicroSeconds=function(){return this.usec},m},d=function(p){var h=t(p,32);t(p,32,32);for(var b=t(p,32,64),v=96,m=[],y=0;y<h;y++)m[y]=t(p,32,v),v+=32,v+=32;var w=function(I){var A=t(p,32,v);if(v+=32,A==4294967295)return null;var g;if(I==23||I==20)return g=t(p,A*8,v),v+=A*8,g;if(I==25)return g=p.toString(this.encoding,v>>3,(v+=A<<3)>>3),g;console.log("ERROR: ElementType not implemented: "+I)},S=function(I,A){var g=[],x;if(I.length>1){var _=I.shift();for(x=0;x<_;x++)g[x]=S(I,A);I.unshift(_)}else for(x=0;x<I[0];x++)g[x]=w(A);return g};return S(m,b)},l=function(p){return p.toString("utf8")},f=function(p){return p===null?null:t(p,8)>0},c=function(p){p(20,e),p(21,s),p(23,n),p(26,n),p(1700,a),p(700,i),p(701,o),p(16,f),p(1114,u.bind(null,!1)),p(1184,u.bind(null,!0)),p(1e3,d),p(1007,d),p(1016,d),p(1008,d),p(1009,d),p(25,l)};return br={init:c},br}var yr,Ws;function Qo(){return Ws||(Ws=1,yr={BOOL:16,BYTEA:17,CHAR:18,INT8:20,INT2:21,INT4:23,REGPROC:24,TEXT:25,OID:26,TID:27,XID:28,CID:29,JSON:114,XML:142,PG_NODE_TREE:194,SMGR:210,PATH:602,POLYGON:604,CIDR:650,FLOAT4:700,FLOAT8:701,ABSTIME:702,RELTIME:703,TINTERVAL:704,CIRCLE:718,MACADDR8:774,MONEY:790,MACADDR:829,INET:869,ACLITEM:1033,BPCHAR:1042,VARCHAR:1043,DATE:1082,TIME:1083,TIMESTAMP:1114,TIMESTAMPTZ:1184,INTERVAL:1186,TIMETZ:1266,BIT:1560,VARBIT:1562,NUMERIC:1700,REFCURSOR:1790,REGPROCEDURE:2202,REGOPER:2203,REGOPERATOR:2204,REGCLASS:2205,REGTYPE:2206,UUID:2950,TXID_SNAPSHOT:2970,PG_LSN:3220,PG_NDISTINCT:3361,PG_DEPENDENCIES:3402,TSVECTOR:3614,TSQUERY:3615,GTSVECTOR:3642,REGCONFIG:3734,REGDICTIONARY:3769,JSONB:3802,REGNAMESPACE:4089,REGROLE:4096}),yr}var Vs;function xt(){if(Vs)return Pe;Vs=1;var e=zo(),t=Vo(),r=li(),s=Qo();Pe.getTypeParser=o,Pe.setTypeParser=a,Pe.arrayParser=r,Pe.builtins=s;var n={text:{},binary:{}};function i(u){return String(u)}function o(u,d){return d=d||"text",n[d]&&n[d][u]||i}function a(u,d,l){typeof d=="function"&&(l=d,d="text"),n[d][u]=l}return e.init(function(u,d){n.text[u]=d}),t.init(function(u,d){n.binary[u]=d}),Pe}var Qs;function St(){return Qs||(Qs=1,(function(e){var t={};let r;try{r=process.platform==="win32"?t.USERNAME:t.USER}catch{}e.exports={host:"localhost",user:r,database:void 0,password:null,connectionString:void 0,port:5432,rows:0,binary:!1,max:10,idleTimeoutMillis:3e4,client_encoding:"",ssl:!1,application_name:void 0,fallback_application_name:void 0,options:void 0,parseInputDatesAsUTC:!1,statement_timeout:!1,lock_timeout:!1,idle_in_transaction_session_timeout:!1,query_timeout:!1,connect_timeout:0,keepalives:1,keepalives_idle:0};const s=xt(),n=s.getTypeParser(20,"text"),i=s.getTypeParser(1016,"text");e.exports.__defineSetter__("parseInt8",function(o){s.setTypeParser(20,"text",o?s.getTypeParser(23,"text"):n),s.setTypeParser(1016,"text",o?s.getTypeParser(1007,"text"):i)})})(lr)),lr.exports}var vr,Xs;function tt(){if(Xs)return vr;Xs=1;const e=St(),t=He,{isDate:r}=t.types||t;function s(c){return'"'+c.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'}function n(c){let p="{";for(let h=0;h<c.length;h++)if(h>0&&(p=p+","),c[h]===null||typeof c[h]>"u")p=p+"NULL";else if(Array.isArray(c[h]))p=p+n(c[h]);else if(ArrayBuffer.isView(c[h])){let b=c[h];if(!(b instanceof Buffer)){const v=Buffer.from(b.buffer,b.byteOffset,b.byteLength);v.length===b.byteLength?b=v:b=v.slice(b.byteOffset,b.byteOffset+b.byteLength)}p+="\\\\x"+b.toString("hex")}else p+=s(i(c[h]));return p=p+"}",p}const i=function(c,p){if(c==null)return null;if(typeof c=="object"){if(c instanceof Buffer)return c;if(ArrayBuffer.isView(c)){const h=Buffer.from(c.buffer,c.byteOffset,c.byteLength);return h.length===c.byteLength?h:h.slice(c.byteOffset,c.byteOffset+c.byteLength)}return r(c)?e.parseInputDatesAsUTC?u(c):a(c):Array.isArray(c)?n(c):o(c,p)}return c.toString()};function o(c,p){if(c&&typeof c.toPostgres=="function"){if(p=p||[],p.indexOf(c)!==-1)throw new Error('circular reference detected while preparing "'+c+'" for query');return p.push(c),i(c.toPostgres(i),p)}return JSON.stringify(c)}function a(c){let p=-c.getTimezoneOffset(),h=c.getFullYear();const b=h<1;b&&(h=Math.abs(h)+1);let v=String(h).padStart(4,"0")+"-"+String(c.getMonth()+1).padStart(2,"0")+"-"+String(c.getDate()).padStart(2,"0")+"T"+String(c.getHours()).padStart(2,"0")+":"+String(c.getMinutes()).padStart(2,"0")+":"+String(c.getSeconds()).padStart(2,"0")+"."+String(c.getMilliseconds()).padStart(3,"0");return p<0?(v+="-",p*=-1):v+="+",v+=String(Math.floor(p/60)).padStart(2,"0")+":"+String(p%60).padStart(2,"0"),b&&(v+=" BC"),v}function u(c){let p=c.getUTCFullYear();const h=p<1;h&&(p=Math.abs(p)+1);let b=String(p).padStart(4,"0")+"-"+String(c.getUTCMonth()+1).padStart(2,"0")+"-"+String(c.getUTCDate()).padStart(2,"0")+"T"+String(c.getUTCHours()).padStart(2,"0")+":"+String(c.getUTCMinutes()).padStart(2,"0")+":"+String(c.getUTCSeconds()).padStart(2,"0")+"."+String(c.getUTCMilliseconds()).padStart(3,"0");return b+="+00:00",h&&(b+=" BC"),b}function d(c,p,h){return c=typeof c=="string"?{text:c}:c,p&&(typeof p=="function"?c.callback=p:c.values=p),h&&(c.callback=h),c}return vr={prepareValue:function(p){return i(p)},normalizeQueryConfig:d,escapeIdentifier:function(c){return'"'+c.replace(/"/g,'""')+'"'},escapeLiteral:function(c){let p=!1,h="'";if(c==null||typeof c!="string")return"''";for(let b=0;b<c.length;b++){const v=c[b];v==="'"?h+=v+v:v==="\\"?(h+=v+v,p=!0):h+=v}return h+="'",p===!0&&(h=" E"+h),h}},vr}var dt={exports:{}},wr,Ys;function Xo(){if(Ys)return wr;Ys=1;const e=qn;function t(a){return e.createHash("md5").update(a,"utf-8").digest("hex")}function r(a,u,d){const l=t(u+a);return"md5"+t(Buffer.concat([Buffer.from(l),d]))}function s(a){return e.createHash("sha256").update(a).digest()}function n(a,u){return a=a.replace(/(\D)-/,"$1"),e.createHash(a).update(u).digest()}function i(a,u){return e.createHmac("sha256",a).update(u).digest()}async function o(a,u,d){return e.pbkdf2Sync(a,u,d,32,"sha256")}return wr={postgresMd5PasswordHash:r,randomBytes:e.randomBytes,deriveKey:o,sha256:s,hashByName:n,hmacSha256:i,md5:t},wr}var _r,Js;function Yo(){if(Js)return _r;Js=1;const e=qn;_r={postgresMd5PasswordHash:o,randomBytes:n,deriveKey:l,sha256:a,hashByName:u,hmacSha256:d,md5:i};const t=e.webcrypto||globalThis.crypto,r=t.subtle,s=new TextEncoder;function n(f){return t.getRandomValues(Buffer.alloc(f))}async function i(f){try{return e.createHash("md5").update(f,"utf-8").digest("hex")}catch{const p=typeof f=="string"?s.encode(f):f,h=await r.digest("MD5",p);return Array.from(new Uint8Array(h)).map(b=>b.toString(16).padStart(2,"0")).join("")}}async function o(f,c,p){const h=await i(c+f);return"md5"+await i(Buffer.concat([Buffer.from(h),p]))}async function a(f){return await r.digest("SHA-256",f)}async function u(f,c){return await r.digest(f,c)}async function d(f,c){const p=await r.importKey("raw",f,{name:"HMAC",hash:"SHA-256"},!1,["sign"]);return await r.sign("HMAC",p,s.encode(c))}async function l(f,c,p){const h=await r.importKey("raw",s.encode(f),"PBKDF2",!1,["deriveBits"]),b={name:"PBKDF2",hash:"SHA-256",salt:c,iterations:p};return await r.deriveBits(b,h,256,["deriveBits"])}return _r}var Gs;function ci(){return Gs||(Gs=1,parseInt(process.versions&&process.versions.node&&process.versions.node.split(".")[0])<15?dt.exports=Xo():dt.exports=Yo()),dt.exports}var Er,Ks;function Jo(){if(Ks)return Er;Ks=1;function e(i,o){return new Error("SASL channel binding: "+i+" when parsing public certificate "+o.toString("base64"))}function t(i,o){let a=i[o++];if(a<128)return{length:a,index:o};const u=a&127;if(u>4)throw e("bad length",i);a=0;for(let d=0;d<u;d++)a=a<<8|i[o++];return{length:a,index:o}}function r(i,o){if(i[o++]!==6)throw e("non-OID data",i);const{length:a,index:u}=t(i,o);o=u;const d=o+a,l=i[o++];let f=(l/40>>0)+"."+l%40;for(;o<d;){let c=0;for(;o<d;){const p=i[o++];if(c=c<<7|p&127,p<128)break}f+="."+c}return{oid:f,index:o}}function s(i,o){if(i[o++]!==48)throw e("non-sequence data",i);return t(i,o)}function n(i,o){o===void 0&&(o=0),o=s(i,o).index;const{length:a,index:u}=s(i,o);o=u+a,o=s(i,o).index;const{oid:d,index:l}=r(i,o);switch(d){case"1.2.840.113549.1.1.4":return"MD5";case"1.2.840.113549.1.1.5":return"SHA-1";case"1.2.840.113549.1.1.11":return"SHA-256";case"1.2.840.113549.1.1.12":return"SHA-384";case"1.2.840.113549.1.1.13":return"SHA-512";case"1.2.840.113549.1.1.14":return"SHA-224";case"1.2.840.113549.1.1.15":return"SHA512-224";case"1.2.840.113549.1.1.16":return"SHA512-256";case"1.2.840.10045.4.1":return"SHA-1";case"1.2.840.10045.4.3.1":return"SHA-224";case"1.2.840.10045.4.3.2":return"SHA-256";case"1.2.840.10045.4.3.3":return"SHA-384";case"1.2.840.10045.4.3.4":return"SHA-512";case"1.2.840.113549.1.1.10":{if(o=l,o=s(i,o).index,i[o++]!==160)throw e("non-tag data",i);o=t(i,o).index,o=s(i,o).index;const{oid:f}=r(i,o);switch(f){case"1.2.840.113549.2.5":return"MD5";case"1.3.14.3.2.26":return"SHA-1";case"2.16.840.1.101.3.4.2.1":return"SHA-256";case"2.16.840.1.101.3.4.2.2":return"SHA-384";case"2.16.840.1.101.3.4.2.3":return"SHA-512"}throw e("unknown hash OID "+f,i)}case"1.3.101.110":case"1.3.101.112":return"SHA-512";case"1.3.101.111":case"1.3.101.113":throw e("Ed448 certificate channel binding is not currently supported by Postgres")}throw e("unknown OID "+d,i)}return Er={signatureAlgorithmHashFromCertificate:n},Er}var xr,Zs;function Go(){if(Zs)return xr;Zs=1;const e=ci(),{signatureAlgorithmHashFromCertificate:t}=Jo();function r(f,c){const p=["SCRAM-SHA-256"];c&&p.unshift("SCRAM-SHA-256-PLUS");const h=p.find(m=>f.includes(m));if(!h)throw new Error("SASL: Only mechanism(s) "+p.join(" and ")+" are supported");if(h==="SCRAM-SHA-256-PLUS"&&typeof c.getPeerCertificate!="function")throw new Error("SASL: Mechanism SCRAM-SHA-256-PLUS requires a certificate");const b=e.randomBytes(18).toString("base64");return{mechanism:h,clientNonce:b,response:(h==="SCRAM-SHA-256-PLUS"?"p=tls-server-end-point":c?"y":"n")+",,n=*,r="+b,message:"SASLInitialResponse"}}async function s(f,c,p,h){if(f.message!=="SASLInitialResponse")throw new Error("SASL: Last message was not SASLInitialResponse");if(typeof c!="string")throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: client password must be a string");if(c==="")throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: client password must be a non-empty string");if(typeof p!="string")throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: serverData must be a string");const b=u(p);if(b.nonce.startsWith(f.clientNonce)){if(b.nonce.length===f.clientNonce.length)throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce is too short")}else throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce does not start with client nonce");const v="n=*,r="+f.clientNonce,m="r="+b.nonce+",s="+b.salt+",i="+b.iteration;let y=h?"eSws":"biws";if(f.mechanism==="SCRAM-SHA-256-PLUS"){const E=h.getPeerCertificate().raw;let L=t(E);(L==="MD5"||L==="SHA-1")&&(L="SHA-256");const D=await e.hashByName(L,E);y=Buffer.concat([Buffer.from("p=tls-server-end-point,,"),Buffer.from(D)]).toString("base64")}const w="c="+y+",r="+b.nonce,S=v+","+m+","+w,I=Buffer.from(b.salt,"base64"),A=await e.deriveKey(c,I,b.iteration),g=await e.hmacSha256(A,"Client Key"),x=await e.sha256(g),_=await e.hmacSha256(x,S),T=l(Buffer.from(g),Buffer.from(_)).toString("base64"),C=await e.hmacSha256(A,"Server Key"),O=await e.hmacSha256(C,S);f.message="SASLResponse",f.serverSignature=Buffer.from(O).toString("base64"),f.response=w+",p="+T}function n(f,c){if(f.message!=="SASLResponse")throw new Error("SASL: Last message was not SASLResponse");if(typeof c!="string")throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: serverData must be a string");const{serverSignature:p}=d(c);if(p!==f.serverSignature)throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature does not match")}function i(f){if(typeof f!="string")throw new TypeError("SASL: text must be a string");return f.split("").map((c,p)=>f.charCodeAt(p)).every(c=>c>=33&&c<=43||c>=45&&c<=126)}function o(f){return/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.test(f)}function a(f){if(typeof f!="string")throw new TypeError("SASL: attribute pairs text must be a string");return new Map(f.split(",").map(c=>{if(!/^.=/.test(c))throw new Error("SASL: Invalid attribute pair entry");const p=c[0],h=c.substring(2);return[p,h]}))}function u(f){const c=a(f),p=c.get("r");if(p){if(!i(p))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: nonce must only contain printable characters")}else throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: nonce missing");const h=c.get("s");if(h){if(!o(h))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: salt must be base64")}else throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: salt missing");const b=c.get("i");if(b){if(!/^[1-9][0-9]*$/.test(b))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: invalid iteration count")}else throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: iteration missing");const v=parseInt(b,10);return{nonce:p,salt:h,iteration:v}}function d(f){const p=a(f).get("v");if(p){if(!o(p))throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature must be base64")}else throw new Error("SASL: SCRAM-SERVER-FINAL-MESSAGE: server signature is missing");return{serverSignature:p}}function l(f,c){if(!Buffer.isBuffer(f))throw new TypeError("first argument must be a Buffer");if(!Buffer.isBuffer(c))throw new TypeError("second argument must be a Buffer");if(f.length!==c.length)throw new Error("Buffer lengths must match");if(f.length===0)throw new Error("Buffers cannot be empty");return Buffer.from(f.map((p,h)=>f[h]^c[h]))}return xr={startSession:r,continueSession:s,finalizeSession:n},xr}var Sr,en;function Gr(){if(en)return Sr;en=1;const e=xt();function t(r){this._types=r||e,this.text={},this.binary={}}return t.prototype.getOverrides=function(r){switch(r){case"text":return this.text;case"binary":return this.binary;default:return{}}},t.prototype.setTypeParser=function(r,s,n){typeof s=="function"&&(n=s,s="text"),this.getOverrides(s)[r]=n},t.prototype.getTypeParser=function(r,s){return s=s||"text",this.getOverrides(s)[r]||this._types.getTypeParser(r,s)},Sr=t,Sr}var Ar,tn;function Ko(){if(tn)return Ar;tn=1;function e(i,o={}){if(i.charAt(0)==="/"){const p=i.split(" ");return{host:p[0],database:p[1]}}const a={};let u,d=!1;/ |%[^a-f0-9]|%[a-f0-9][^a-f0-9]/i.test(i)&&(i=encodeURI(i).replace(/%25(\d\d)/g,"%$1"));try{try{u=new URL(i,"postgres://base")}catch{u=new URL(i.replace("@/","@___DUMMY___/"),"postgres://base"),d=!0}}catch(p){throw p.input&&(p.input="*****REDACTED*****"),p}for(const p of u.searchParams.entries())a[p[0]]=p[1];if(a.user=a.user||decodeURIComponent(u.username),a.password=a.password||decodeURIComponent(u.password),u.protocol=="socket:")return a.host=decodeURI(u.pathname),a.database=u.searchParams.get("db"),a.client_encoding=u.searchParams.get("encoding"),a;const l=d?"":u.hostname;a.host?l&&/^%2f/i.test(l)&&(u.pathname=l+u.pathname):a.host=decodeURIComponent(l),a.port||(a.port=u.port);const f=u.pathname.slice(1)||null;a.database=f?decodeURI(f):null,(a.ssl==="true"||a.ssl==="1")&&(a.ssl=!0),a.ssl==="0"&&(a.ssl=!1),(a.sslcert||a.sslkey||a.sslrootcert||a.sslmode)&&(a.ssl={});const c=a.sslcert||a.sslkey||a.sslrootcert?Dn:null;if(a.sslcert&&(a.ssl.cert=c.readFileSync(a.sslcert).toString()),a.sslkey&&(a.ssl.key=c.readFileSync(a.sslkey).toString()),a.sslrootcert&&(a.ssl.ca=c.readFileSync(a.sslrootcert).toString()),o.useLibpqCompat&&a.uselibpqcompat)throw new Error("Both useLibpqCompat and uselibpqcompat are set. Please use only one of them.");if(a.uselibpqcompat==="true"||o.useLibpqCompat)switch(a.sslmode){case"disable":{a.ssl=!1;break}case"prefer":{a.ssl.rejectUnauthorized=!1;break}case"require":{a.sslrootcert?a.ssl.checkServerIdentity=function(){}:a.ssl.rejectUnauthorized=!1;break}case"verify-ca":{if(!a.ssl.ca)throw new Error("SECURITY WARNING: Using sslmode=verify-ca requires specifying a CA with sslrootcert. If a public CA is used, verify-ca allows connections to a server that somebody else may have registered with the CA, making you vulnerable to Man-in-the-Middle attacks. Either specify a custom CA certificate with sslrootcert parameter or use sslmode=verify-full for proper security.");a.ssl.checkServerIdentity=function(){};break}}else switch(a.sslmode){case"disable":{a.ssl=!1;break}case"prefer":case"require":case"verify-ca":case"verify-full":{a.sslmode!=="verify-full"&&n(a.sslmode);break}case"no-verify":{a.ssl.rejectUnauthorized=!1;break}}return a}function t(i){return Object.entries(i).reduce((a,[u,d])=>(d!=null&&(a[u]=d),a),{})}function r(i){return Object.entries(i).reduce((a,[u,d])=>{if(u==="ssl"){const l=d;typeof l=="boolean"&&(a[u]=l),typeof l=="object"&&(a[u]=t(l))}else if(d!=null)if(u==="port"){if(d!==""){const l=parseInt(d,10);if(isNaN(l))throw new Error(`Invalid ${u}: ${d}`);a[u]=l}}else a[u]=d;return a},{})}function s(i){return r(e(i))}function n(i){!n.warned&&typeof process<"u"&&process.emitWarning&&(n.warned=!0,process.emitWarning(`SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
...
See https://www.postgresql.org/docs/current/libpq-ssl.html for libpq SSL mode definitions.`))}return Ar=e,e.parse=e,e.toClientConfig=r,e.parseIntoClientConfig=s,Ar}var Tr,rn;function ui(){if(rn)return Tr;rn=1;var e={};const t=vi,r=St(),s=Ko().parse,n=function(d,l,f){return l[d]?l[d]:(f===void 0?f=e["PG"+d.toUpperCase()]:f===!1||(f=e[f]),f||r[d])},i=function(){switch(e.PGSSLMODE){case"disable":return!1;case"prefer":case"require":case"verify-ca":case"verify-full":return!0;case"no-verify":return{rejectUnauthorized:!1}}return r.ssl},o=function(d){return"'"+(""+d).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},a=function(d,l,f){const c=l[f];c!=null&&d.push(f+"="+o(c))};class u{constructor(l){l=typeof l=="string"?s(l):l||{},l.connectionString&&(l=Object.assign({},l,s(l.connectionString))),this.user=n("user",l),this.database=n("database",l),this.database===void 0&&(this.database=this.user),this.port=parseInt(n("port",l),10),this.host=n("host",l),Object.defineProperty(this,"password",{configurable:!0,enumerable:!1,writable:!0,value:n("password",l)}),this.binary=n("binary",l),this.options=n("options",l),this.ssl=typeof l.ssl>"u"?i():l.ssl,typeof this.ssl=="string"&&this.ssl==="true"&&(this.ssl=!0),this.ssl==="no-verify"&&(this.ssl={rejectUnauthorized:!1}),this.ssl&&this.ssl.key&&Object.defineProperty(this.ssl,"key",{enumerable:!1}),this.client_encoding=n("client_encoding",l),this.replication=n("replication",l),this.isDomainSocket=!(this.host||"").indexOf("/"),this.application_name=n("application_name",l,"PGAPPNAME"),this.fallback_application_name=n("fallback_application_name",l,!1),this.statement_timeout=n("statement_timeout",l,!1),this.lock_timeout=n("lock_timeout",l,!1),this.idle_in_transaction_session_timeout=n("idle_in_transaction_session_timeout",l,!1),this.query_timeout=n("query_timeout",l,!1),l.connectionTimeoutMillis===void 0?this.connect_timeout=e.PGCONNECT_TIMEOUT||0:this.connect_timeout=Math.floor(l.connectionTimeoutMillis/1e3),l.keepAlive===!1?this.keepalives=0:l.keepAlive===!0&&(this.keepalives=1),typeof l.keepAliveInitialDelayMillis=="number"&&(this.keepalives_idle=Math.floor(l.keepAliveInitialDelayMillis/1e3))}getLibpqConnectionString(l){const f=[];a(f,this,"user"),a(f,this,"password"),a(f,this,"port"),a(f,this,"application_name"),a(f,this,"fallback_application_name"),a(f,this,"connect_timeout"),a(f,this,"options");const c=typeof this.ssl=="object"?this.ssl:this.ssl?{sslmode:this.ssl}:{};if(a(f,c,"sslmode"),a(f,c,"sslca"),a(f,c,"sslkey"),a(f,c,"sslcert"),a(f,c,"sslrootcert"),this.database&&f.push("dbname="+o(this.database)),this.replication&&f.push("replication="+o(this.replication)),this.host&&f.push("host="+o(this.host)),this.isDomainSocket)return l(null,f.join(" "));this.client_encoding&&f.push("client_encoding="+o(this.client_encoding)),t.lookup(this.host,function(p,h){return p?l(p,null):(f.push("hostaddr="+o(h)),l(null,f.join(" ")))})}}return Tr=u,Tr}var Cr,sn;function di(){if(sn)return Cr;sn=1;const e=xt(),t=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/;class r{constructor(n,i){this.command=null,this.rowCount=null,this.oid=null,this.rows=[],this.fields=[],this._parsers=void 0,this._types=i,this.RowCtor=null,this.rowAsArray=n==="array",this.rowAsArray&&(this.parseRow=this._parseRowAsArray),this._prebuiltEmptyResultObject=null}addCommandComplete(n){let i;n.text?i=t.exec(n.text):i=t.exec(n.command),i&&(this.command=i[1],i[3]?(this.oid=parseInt(i[2],10),this.rowCount=parseInt(i[3],10)):i[2]&&(this.rowCount=parseInt(i[2],10)))}_parseRowAsArray(n){const i=new Array(n.length);for(let o=0,a=n.length;o<a;o++){const u=n[o];u!==null?i[o]=this._parsers[o](u):i[o]=null}return i}parseRow(n){const i={...this._prebuiltEmptyResultObject};for(let o=0,a=n.length;o<a;o++){const u=n[o],d=this.fields[o].name;if(u!==null){const l=this.fields[o].format==="binary"?Buffer.from(u):u;i[d]=this._parsers[o](l)}else i[d]=null}return i}addRow(n){this.rows.push(n)}addFields(n){this.fields=n,this.fields.length&&(this._parsers=new Array(n.length));const i={};for(let o=0;o<n.length;o++){const a=n[o];i[a.name]=null,this._types?this._parsers[o]=this._types.getTypeParser(a.dataTypeID,a.format||"text"):this._parsers[o]=e.getTypeParser(a.dataTypeID,a.format||"text")}this._prebuiltEmptyResultObject={...i}}}return Cr=r,Cr}var Rr,nn;function Zo(){if(nn)return Rr;nn=1;const{EventEmitter:e}=ze,t=di(),r=tt();class s extends e{constructor(i,o,a){super(),i=r.normalizeQueryConfig(i,o,a),this.text=i.text,this.values=i.values,this.rows=i.rows,this.types=i.types,this.name=i.name,this.queryMode=i.queryMode,this.binary=i.binary,this.portal=i.portal||"",this.callback=i.callback,this._rowMode=i.rowMode,process.domain&&i.callback&&(this.callback=process.domain.bind(i.callback)),this._result=new t(this._rowMode,this.types),this._results=this._result,this._canceledDueToError=!1}requiresPreparation(){return this.queryMode==="extended"||this.name||this.rows?!0:!this.text||!this.values?!1:this.values.length>0}_checkForMultirow(){this._result.command&&(Array.isArray(this._results)||(this._results=[this._result]),this._result=new t(this._rowMode,this._result._types),this._results.push(this._result))}handleRowDescription(i){this._checkForMultirow(),this._result.addFields(i.fields),this._accumulateRows=this.callback||!this.listeners("row").length}handleDataRow(i){let o;if(!this._canceledDueToError){try{o=this._result.parseRow(i.fields)}catch(a){this._canceledDueToError=a;return}this.emit("row",o,this._result),this._accumulateRows&&this._result.addRow(o)}}handleCommandComplete(i,o){this._checkForMultirow(),this._result.addCommandComplete(i),this.rows&&o.sync()}handleEmptyQuery(i){this.rows&&i.sync()}handleError(i,o){if(this._canceledDueToError&&(i=this._canceledDueToError,this._canceledDueToError=!1),this.callback)return this.callback(i);this.emit("error",i)}handleReadyForQuery(i){if(this._canceledDueToError)return this.handleError(this._canceledDueToError,i);if(this.callback)try{this.callback(null,this._results)}catch(o){process.nextTick(()=>{throw o})}this.emit("end",this._results)}submit(i){if(typeof this.text!="string"&&typeof this.name!="string")return new Error("A query must have either text or a name. Supplying neither is unsupported.");const o=i.parsedStatements[this.name];if(this.text&&o&&this.text!==o)return new Error(`Prepared statements must be unique - '${this.name}' was used for a different statement`);if(this.values&&!Array.isArray(this.values))return new Error("Query values must be an array");if(this.requiresPreparation()){i.stream.cork&&i.stream.cork();try{this.prepare(i)}finally{i.stream.uncork&&i.stream.uncork()}}else i.query(this.text);return null}hasBeenParsed(i){return this.name&&i.parsedStatements[this.name]}handlePortalSuspended(i){this._getRows(i,this.rows)}_getRows(i,o){i.execute({portal:this.portal,rows:o}),o?i.flush():i.sync()}prepare(i){this.hasBeenParsed(i)||i.parse({text:this.text,name:this.name,types:this.types});try{i.bind({portal:this.portal,statement:this.name,values:this.values,binary:this.binary,valueMapper:r.prepareValue})}catch(o){this.handleError(o,i);return}i.describe({type:"P",name:this.portal||""}),this._getRows(i,this.rows)}handleCopyInResponse(i){i.sendCopyFail("No source stream defined")}handleCopyData(i,o){}}return Rr=s,Rr}var Nr={},B={},on;function fi(){if(on)return B;on=1,Object.defineProperty(B,"__esModule",{value:!0}),B.NoticeMessage=B.DataRowMessage=B.CommandCompleteMessage=B.ReadyForQueryMessage=B.NotificationResponseMessage=B.BackendKeyDataMessage=B.AuthenticationMD5Password=B.ParameterStatusMessage=B.ParameterDescriptionMessage=B.RowDescriptionMessage=B.Field=B.CopyResponse=B.CopyDataMessage=B.DatabaseError=B.copyDone=B.emptyQuery=B.replicationStart=B.portalSuspended=B.noData=B.closeComplete=B.bindComplete=B.parseComplete=void 0,B.parseComplete={name:"parseComplete",length:5},B.bindComplete={name:"bindComplete",length:5},B.closeComplete={name:"closeComplete",length:5},B.noData={name:"noData",length:5},B.portalSuspended={name:"portalSuspended",length:5},B.replicationStart={name:"replicationStart",length:4},B.emptyQuery={name:"emptyQuery",length:4},B.copyDone={name:"copyDone",length:4};class e extends Error{constructor(b,v,m){super(b),this.length=v,this.name=m}}B.DatabaseError=e;class t{constructor(b,v){this.length=b,this.chunk=v,this.name="copyData"}}B.CopyDataMessage=t;class r{constructor(b,v,m,y){this.length=b,this.name=v,this.binary=m,this.columnTypes=new Array(y)}}B.CopyResponse=r;class s{constructor(b,v,m,y,w,S,I){this.name=b,this.tableID=v,this.columnID=m,this.dataTypeID=y,this.dataTypeSize=w,this.dataTypeModifier=S,this.format=I}}B.Field=s;class n{constructor(b,v){this.length=b,this.fieldCount=v,this.name="rowDescription",this.fields=new Array(this.fieldCount)}}B.RowDescriptionMessage=n;class i{constructor(b,v){this.length=b,this.parameterCount=v,this.name="parameterDescription",this.dataTypeIDs=new Array(this.parameterCount)}}B.ParameterDescriptionMessage=i;class o{constructor(b,v,m){this.length=b,this.parameterName=v,this.parameterValue=m,this.name="parameterStatus"}}B.ParameterStatusMessage=o;class a{constructor(b,v){this.length=b,this.salt=v,this.name="authenticationMD5Password"}}B.AuthenticationMD5Password=a;class u{constructor(b,v,m){this.length=b,this.processID=v,this.secretKey=m,this.name="backendKeyData"}}B.BackendKeyDataMessage=u;class d{constructor(b,v,m,y){this.length=b,this.processId=v,this.channel=m,this.payload=y,this.name="notification"}}B.NotificationResponseMessage=d;class l{constructor(b,v){this.length=b,this.status=v,this.name="readyForQuery"}}B.ReadyForQueryMessage=l;class f{constructor(b,v){this.length=b,this.text=v,this.name="commandComplete"}}B.CommandCompleteMessage=f;class c{constructor(b,v){this.length=b,this.fields=v,this.name="dataRow",this.fieldCount=v.length}}B.DataRowMessage=c;class p{constructor(b,v){this.length=b,this.message=v,this.name="notice"}}return B.NoticeMessage=p,B}var Xe={},Ye={},an;function ea(){if(an)return Ye;an=1,Object.defineProperty(Ye,"__esModule",{value:!0}),Ye.Writer=void 0;class e{constructor(r=256){this.size=r,this.offset=5,this.headerPosition=0,this.buffer=Buffer.allocUnsafe(r)}ensure(r){if(this.buffer.length-this.offset<r){const n=this.buffer,i=n.length+(n.length>>1)+r;this.buffer=Buffer.allocUnsafe(i),n.copy(this.buffer)}}addInt32(r){return this.ensure(4),this.buffer[this.offset++]=r>>>24&255,this.buffer[this.offset++]=r>>>16&255,this.buffer[this.offset++]=r>>>8&255,this.buffer[this.offset++]=r>>>0&255,this}addInt16(r){return this.ensure(2),this.buffer[this.offset++]=r>>>8&255,this.buffer[this.offset++]=r>>>0&255,this}addCString(r){if(!r)this.ensure(1);else{const s=Buffer.byteLength(r);this.ensure(s+1),this.buffer.write(r,this.offset,"utf-8"),this.offset+=s}return this.buffer[this.offset++]=0,this}addString(r=""){const s=Buffer.byteLength(r);return this.ensure(s),this.buffer.write(r,this.offset),this.offset+=s,this}add(r){return this.ensure(r.length),r.copy(this.buffer,this.offset),this.offset+=r.length,this}join(r){if(r){this.buffer[this.headerPosition]=r;const s=this.offset-(this.headerPosition+1);this.buffer.writeInt32BE(s,this.headerPosition+1)}return this.buffer.slice(r?0:5,this.offset)}flush(r){const s=this.join(r);return this.offset=5,this.headerPosition=0,this.buffer=Buffer.allocUnsafe(this.size),s}}return Ye.Writer=e,Ye}var ln;function ta(){if(ln)return Xe;ln=1,Object.defineProperty(Xe,"__esModule",{value:!0}),Xe.serialize=void 0;const e=ea(),t=new e.Writer,r=E=>{t.addInt16(3).addInt16(0);for(const M of Object.keys(E))t.addCString(M).addCString(E[M]);t.addCString("client_encoding").addCString("UTF8");const L=t.addCString("").flush(),D=L.length+4;return new e.Writer().addInt32(D).add(L).flush()},s=()=>{const E=Buffer.allocUnsafe(8);return E.writeInt32BE(8,0),E.writeInt32BE(80877103,4),E},n=E=>t.addCString(E).flush(112),i=function(E,L){return t.addCString(E).addInt32(Buffer.byteLength(L)).addString(L),t.flush(112)},o=function(E){return t.addString(E).flush(112)},a=E=>t.addCString(E).flush(81),u=[],d=E=>{const L=E.name||"";L.length>63&&(console.error("Warning! Postgres only supports 63 characters for query names."),console.error("You supplied %s (%s)",L,L.length),console.error("This can cause conflicts and silent errors executing queries"));const D=E.types||u,M=D.length,F=t.addCString(L).addCString(E.text).addInt16(M);for(let $=0;$<M;$++)F.addInt32(D[$]);return t.flush(80)},l=new e.Writer,f=function(E,L){for(let D=0;D<E.length;D++){const M=L?L(E[D],D):E[D];M==null?(t.addInt16(0),l.addInt32(-1)):M instanceof Buffer?(t.addInt16(1),l.addInt32(M.length),l.add(M)):(t.addInt16(0),l.addInt32(Buffer.byteLength(M)),l.addString(M))}},c=(E={})=>{const L=E.portal||"",D=E.statement||"",M=E.binary||!1,F=E.values||u,$=F.length;return t.addCString(L).addCString(D),t.addInt16($),f(F,E.valueMapper),t.addInt16($),t.add(l.flush()),t.addInt16(1),t.addInt16(M?1:0),t.flush(66)},p=Buffer.from([69,0,0,0,9,0,0,0,0,0]),h=E=>{if(!E||!E.portal&&!E.rows)return p;const L=E.portal||"",D=E.rows||0,M=Buffer.byteLength(L),F=4+M+1+4,$=Buffer.allocUnsafe(1+F);return $[0]=69,$.writeInt32BE(F,1),$.write(L,5,"utf-8"),$[M+5]=0,$.writeUInt32BE(D,$.length-4),$},b=(E,L)=>{const D=Buffer.allocUnsafe(16);return D.writeInt32BE(16,0),D.writeInt16BE(1234,4),D.writeInt16BE(5678,6),D.writeInt32BE(E,8),D.writeInt32BE(L,12),D},v=(E,L)=>{const M=4+Buffer.byteLength(L)+1,F=Buffer.allocUnsafe(1+M);return F[0]=E,F.writeInt32BE(M,1),F.write(L,5,"utf-8"),F[M]=0,F},m=t.addCString("P").flush(68),y=t.addCString("S").flush(68),w=E=>E.name?v(68,`${E.type}${E.name||""}`):E.type==="P"?m:y,S=E=>{const L=`${E.type}${E.name||""}`;return v(67,L)},I=E=>t.add(E).flush(100),A=E=>v(102,E),g=E=>Buffer.from([E,0,0,0,4]),x=g(72),_=g(83),T=g(88),C=g(99),O={startup:r,password:n,requestSsl:s,sendSASLInitialResponseMessage:i,sendSCRAMClientFinalMessage:o,query:a,parse:d,bind:c,execute:h,describe:w,close:S,flush:()=>x,sync:()=>_,end:()=>T,copyData:I,copyDone:()=>C,copyFail:A,cancel:b};return Xe.serialize=O,Xe}var Je={},Ge={},cn;function ra(){if(cn)return Ge;cn=1,Object.defineProperty(Ge,"__esModule",{value:!0}),Ge.BufferReader=void 0;class e{constructor(r=0){this.offset=r,this.buffer=Buffer.allocUnsafe(0),this.encoding="utf-8"}setBuffer(r,s){this.offset=r,this.buffer=s}int16(){const r=this.buffer.readInt16BE(this.offset);return this.offset+=2,r}byte(){const r=this.buffer[this.offset];return this.offset++,r}int32(){const r=this.buffer.readInt32BE(this.offset);return this.offset+=4,r}uint32(){const r=this.buffer.readUInt32BE(this.offset);return this.offset+=4,r}string(r){const s=this.buffer.toString(this.encoding,this.offset,this.offset+r);return this.offset+=r,s}cstring(){const r=this.offset;let s=r;for(;this.buffer[s++]!==0;);return this.offset=s,this.buffer.toString(this.encoding,r,s-1)}bytes(r){const s=this.buffer.slice(this.offset,this.offset+r);return this.offset+=r,s}}return Ge.BufferReader=e,Ge}var un;function sa(){if(un)return Je;un=1,Object.defineProperty(Je,"__esModule",{value:!0}),Je.Parser=void 0;const e=fi(),t=ra(),r=1,n=r+4,i=-1,o=Buffer.allocUnsafe(0);class a{constructor(x){if(this.buffer=o,this.bufferLength=0,this.bufferOffset=0,this.reader=new t.BufferReader,(x==null?void 0:x.mode)==="binary")throw new Error("Binary mode not supported yet");this.mode=(x==null?void 0:x.mode)||"text"}parse(x,_){this.mergeBuffer(x);const T=this.bufferOffset+this.bufferLength;let C=this.bufferOffset;for(;C+n<=T;){const O=this.buffer[C],E=this.buffer.readUInt32BE(C+r),L=r+E;if(L+C<=T){const D=this.handlePacket(C+n,O,E,this.buffer);_(D),C+=L}else break}C===T?(this.buffer=o,this.bufferLength=0,this.bufferOffset=0):(this.bufferLength=T-C,this.bufferOffset=C)}mergeBuffer(x){if(this.bufferLength>0){const _=this.bufferLength+x.byteLength;if(_+this.bufferOffset>this.buffer.byteLength){let C;if(_<=this.buffer.byteLength&&this.bufferOffset>=this.bufferLength)C=this.buffer;else{let O=this.buffer.byteLength*2;for(;_>=O;)O*=2;C=Buffer.allocUnsafe(O)}this.buffer.copy(C,0,this.bufferOffset,this.bufferOffset+this.bufferLength),this.buffer=C,this.bufferOffset=0}x.copy(this.buffer,this.bufferOffset+this.bufferLength),this.bufferLength=_}else this.buffer=x,this.bufferOffset=0,this.bufferLength=x.byteLength}handlePacket(x,_,T,C){const{reader:O}=this;O.setBuffer(x,C);let E;switch(_){case 50:E=e.bindComplete;break;case 49:E=e.parseComplete;break;case 51:E=e.closeComplete;break;case 110:E=e.noData;break;case 115:E=e.portalSuspended;break;case 99:E=e.copyDone;break;case 87:E=e.replicationStart;break;case 73:E=e.emptyQuery;break;case 68:E=y(O);break;case 67:E=d(O);break;case 90:E=u(O);break;case 65:E=h(O);break;case 82:E=I(O,T);break;case 83:E=w(O);break;case 75:E=S(O);break;case 69:E=A(O,"error");break;case 78:E=A(O,"notice");break;case 84:E=b(O);break;case 116:E=m(O);break;case 71:E=f(O);break;case 72:E=c(O);break;case 100:E=l(O,T);break;default:return new e.DatabaseError("received invalid response: "+_.toString(16),T,"error")}return O.setBuffer(0,o),E.length=T,E}}Je.Parser=a;const u=g=>{const x=g.string(1);return new e.ReadyForQueryMessage(i,x)},d=g=>{const x=g.cstring();return new e.CommandCompleteMessage(i,x)},l=(g,x)=>{const _=g.bytes(x-4);return new e.CopyDataMessage(i,_)},f=g=>p(g,"copyInResponse"),c=g=>p(g,"copyOutResponse"),p=(g,x)=>{const _=g.byte()!==0,T=g.int16(),C=new e.CopyResponse(i,x,_,T);for(let O=0;O<T;O++)C.columnTypes[O]=g.int16();return C},h=g=>{const x=g.int32(),_=g.cstring(),T=g.cstring();return new e.NotificationResponseMessage(i,x,_,T)},b=g=>{const x=g.int16(),_=new e.RowDescriptionMessage(i,x);for(let T=0;T<x;T++)_.fields[T]=v(g);return _},v=g=>{const x=g.cstring(),_=g.uint32(),T=g.int16(),C=g.uint32(),O=g.int16(),E=g.int32(),L=g.int16()===0?"text":"binary";return new e.Field(x,_,T,C,O,E,L)},m=g=>{const x=g.int16(),_=new e.ParameterDescriptionMessage(i,x);for(let T=0;T<x;T++)_.dataTypeIDs[T]=g.int32();return _},y=g=>{const x=g.int16(),_=new Array(x);for(let T=0;T<x;T++){const C=g.int32();_[T]=C===-1?null:g.string(C)}return new e.DataRowMessage(i,_)},w=g=>{const x=g.cstring(),_=g.cstring();return new e.ParameterStatusMessage(i,x,_)},S=g=>{const x=g.int32(),_=g.int32();return new e.BackendKeyDataMessage(i,x,_)},I=(g,x)=>{const _=g.int32(),T={name:"authenticationOk",length:x};switch(_){case 0:break;case 3:T.length===8&&(T.name="authenticationCleartextPassword");break;case 5:if(T.length===12){T.name="authenticationMD5Password";const C=g.bytes(4);return new e.AuthenticationMD5Password(i,C)}break;case 10:{T.name="authenticationSASL",T.mechanisms=[];let C;do C=g.cstring(),C&&T.mechanisms.push(C);while(C)}break;case 11:T.name="authenticationSASLContinue",T.data=g.string(x-8);break;case 12:T.name="authenticationSASLFinal",T.data=g.string(x-8);break;default:throw new Error("Unknown authenticationOk message type "+_)}return T},A=(g,x)=>{const _={};let T=g.string(1);for(;T!=="\0";)_[T]=g.cstring(),T=g.string(1);const C=_.M,O=x==="notice"?new e.NoticeMessage(i,C):new e.DatabaseError(C,i,x);return O.severity=_.S,O.code=_.C,O.detail=_.D,O.hint=_.H,O.position=_.P,O.internalPosition=_.p,O.internalQuery=_.q,O.where=_.W,O.schema=_.s,O.table=_.t,O.column=_.c,O.dataType=_.d,O.constraint=_.n,O.file=_.F,O.line=_.L,O.routine=_.R,O};return Je}var dn;function pi(){return dn||(dn=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.DatabaseError=e.serialize=e.parse=void 0;const t=fi();Object.defineProperty(e,"DatabaseError",{enumerable:!0,get:function(){return t.DatabaseError}});const r=ta();Object.defineProperty(e,"serialize",{enumerable:!0,get:function(){return r.serialize}});const s=sa();function n(i,o){const a=new s.Parser;return i.on("data",u=>a.parse(u,o)),new Promise(u=>i.on("end",()=>u()))}e.parse=n})(Nr)),Nr}var ft={},fn;function na(){return fn||(fn=1,Object.defineProperty(ft,"__esModule",{value:!0}),ft.default={}),ft}var Or,pn;function ia(){if(pn)return Or;pn=1;const{getStream:e,getSecureStream:t}=i();Or={getStream:e,getSecureStream:t};function r(){function o(u){const d=jn;return new d.Socket}function a(u){return wi.connect(u)}return{getStream:o,getSecureStream:a}}function s(){function o(u){const{CloudflareSocket:d}=na();return new d(u)}function a(u){return u.socket.startTls(u),u.socket}return{getStream:o,getSecureStream:a}}function n(){if(typeof navigator=="object"&&navigator!==null&&typeof navigator.userAgent=="string")return navigator.userAgent==="Cloudflare-Workers";if(typeof Response=="function"){const o=new Response(null,{cf:{thing:!0}});if(typeof o.cf=="object"&&o.cf!==null&&o.cf.thing)return!0}return!1}function i(){return n()?s():r()}return Or}var Ir,mn;function mi(){if(mn)return Ir;mn=1;const e=ze.EventEmitter,{parse:t,serialize:r}=pi(),{getStream:s,getSecureStream:n}=ia(),i=r.flush(),o=r.sync(),a=r.end();class u extends e{constructor(l){super(),l=l||{},this.stream=l.stream||s(l.ssl),typeof this.stream=="function"&&(this.stream=this.stream(l)),this._keepAlive=l.keepAlive,this._keepAliveInitialDelayMillis=l.keepAliveInitialDelayMillis,this.parsedStatements={},this.ssl=l.ssl||!1,this._ending=!1,this._emitMessage=!1;const f=this;this.on("newListener",function(c){c==="message"&&(f._emitMessage=!0)})}connect(l,f){const c=this;this._connecting=!0,this.stream.setNoDelay(!0),this.stream.connect(l,f),this.stream.once("connect",function(){c._keepAlive&&c.stream.setKeepAlive(!0,c._keepAliveInitialDelayMillis),c.emit("connect")});const p=function(h){c._ending&&(h.code==="ECONNRESET"||h.code==="EPIPE")||c.emit("error",h)};if(this.stream.on("error",p),this.stream.on("close",function(){c.emit("end")}),!this.ssl)return this.attachListeners(this.stream);this.stream.once("data",function(h){switch(h.toString("utf8")){case"S":break;case"N":return c.stream.end(),c.emit("error",new Error("The server does not support SSL connections"));default:return c.stream.end(),c.emit("error",new Error("There was an error establishing an SSL connection"))}const v={socket:c.stream};c.ssl!==!0&&(Object.assign(v,c.ssl),"key"in c.ssl&&(v.key=c.ssl.key));const m=jn;m.isIP&&m.isIP(f)===0&&(v.servername=f);try{c.stream=n(v)}catch(y){return c.emit("error",y)}c.attachListeners(c.stream),c.stream.on("error",p),c.emit("sslconnect")})}attachListeners(l){t(l,f=>{const c=f.name==="error"?"errorMessage":f.name;this._emitMessage&&this.emit("message",f),this.emit(c,f)})}requestSsl(){this.stream.write(r.requestSsl())}startup(l){this.stream.write(r.startup(l))}cancel(l,f){this._send(r.cancel(l,f))}password(l){this._send(r.password(l))}sendSASLInitialResponseMessage(l,f){this._send(r.sendSASLInitialResponseMessage(l,f))}sendSCRAMClientFinalMessage(l){this._send(r.sendSCRAMClientFinalMessage(l))}_send(l){return this.stream.writable?this.stream.write(l):!1}query(l){this._send(r.query(l))}parse(l){this._send(r.parse(l))}bind(l){this._send(r.bind(l))}execute(l){this._send(r.execute(l))}flush(){this.stream.writable&&this.stream.write(i)}sync(){this._ending=!0,this._send(o)}ref(){this.stream.ref()}unref(){this.stream.unref()}end(){if(this._ending=!0,!this._connecting||!this.stream.writable){this.stream.end();return}return this.stream.write(a,()=>{this.stream.end()})}close(l){this._send(r.close(l))}describe(l){this._send(r.describe(l))}sendCopyFromChunk(l){this._send(r.copyData(l))}endCopyFrom(){this._send(r.copyDone())}sendCopyFail(l){this._send(r.copyFail(l))}}return Ir=u,Ir}var pt={exports:{}},Lr={exports:{}},Pr,hn;function oa(){if(hn)return Pr;hn=1;const{Transform:e}=kn,{StringDecoder:t}=Ei,r=Symbol("last"),s=Symbol("decoder");function n(d,l,f){let c;if(this.overflow){if(c=this[s].write(d).split(this.matcher),c.length===1)return f();c.shift(),this.overflow=!1}else this[r]+=this[s].write(d),c=this[r].split(this.matcher);this[r]=c.pop();for(let p=0;p<c.length;p++)try{o(this,this.mapper(c[p]))}catch(h){return f(h)}if(this.overflow=this[r].length>this.maxLength,this.overflow&&!this.skipOverflow){f(new Error("maximum buffer reached"));return}f()}function i(d){if(this[r]+=this[s].end(),this[r])try{o(this,this.mapper(this[r]))}catch(l){return d(l)}d()}function o(d,l){l!==void 0&&d.push(l)}function a(d){return d}function u(d,l,f){switch(d=d||/\r?\n/,l=l||a,f=f||{},arguments.length){case 1:typeof d=="function"?(l=d,d=/\r?\n/):typeof d=="object"&&!(d instanceof RegExp)&&!d[Symbol.split]&&(f=d,d=/\r?\n/);break;case 2:typeof d=="function"?(f=l,l=d,d=/\r?\n/):typeof l=="object"&&(f=l,l=a)}f=Object.assign({},f),f.autoDestroy=!0,f.transform=n,f.flush=i,f.readableObjectMode=!0;const c=new e(f);return c[r]="",c[s]=new t("utf8"),c.matcher=d,c.mapper=l,c.maxLength=f.maxLength,c.skipOverflow=f.skipOverflow||!1,c.overflow=!1,c._destroy=function(p,h){this._writableState.errorEmitted=!1,h(p)},c}return Pr=u,Pr}var gn;function aa(){return gn||(gn=1,(function(e){var t={},r=_i,s=kn.Stream,n=oa(),i=He,o=5432,a=process.platform==="win32",u=process.stderr,d=56,l=7,f=61440,c=32768;function p(I){return(I&f)==c}var h=["host","port","database","user","password"],b=h.length,v=h[b-1];function m(){var I=u instanceof s&&u.writable===!0;if(I){var A=Array.prototype.slice.call(arguments).concat(`
`);u.write(i.format.apply(i,A))}}Object.defineProperty(e.exports,"isWin",{get:function(){return a},set:function(I){a=I}}),e.exports.warnTo=function(I){var A=u;return u=I,A},e.exports.getFileName=function(I){var A=I||t,g=A.PGPASSFILE||(a?r.join(A.APPDATA||"./","postgresql","pgpass.conf"):r.join(A.HOME||"./",".pgpass"));return g},e.exports.usePgPass=function(I,A){return Object.prototype.hasOwnProperty.call(t,"PGPASSWORD")?!1:a?!0:(A=A||"<unkn>",p(I.mode)?I.mode&(d|l)?(m('WARNING: password file "%s" has group or world access; permissions should be u=rw (0600) or less',A),!1):!0:(m('WARNING: password file "%s" is not a plain file',A),!1))};var y=e.exports.match=function(I,A){return h.slice(0,-1).reduce(function(g,x,_){return _==1&&Number(I[x]||o)===Number(A[x])?g&&!0:g&&(A[x]==="*"||A[x]===I[x])},!0)};e.exports.getPassword=function(I,A,g){var x,_=A.pipe(n());function T(E){var L=w(E);L&&S(L)&&y(I,L)&&(x=L[v],_.end())}var C=function(){A.destroy(),g(x)},O=function(E){A.destroy(),m("WARNING: error on reading file: %s",E),g(void 0)};A.on("error",O),_.on("data",T).on("end",C).on("error",O)};var w=e.exports.parseLine=function(I){if(I.length<11||I.match(/^\s+#/))return null;for(var A="",g="",x=0,_=0,T={},C=!1,O=function(L,D,M){var F=I.substring(D,M);Object.hasOwnProperty.call(t,"PGPASS_NO_DEESCAPE")||(F=F.replace(/\\([:\\])/g,"$1")),T[h[L]]=F},E=0;E<I.length-1;E+=1){if(A=I.charAt(E+1),g=I.charAt(E),C=x==b-1,C){O(x,_);break}E>=0&&A==":"&&g!=="\\"&&(O(x,_,E+1),_=E+2,x+=1)}return T=Object.keys(T).length===b?T:null,T},S=e.exports.isValidEntry=function(I){for(var A={0:function(C){return C.length>0},1:function(C){return C==="*"?!0:(C=Number(C),isFinite(C)&&C>0&&C<9007199254740992&&Math.floor(C)===C)},2:function(C){return C.length>0},3:function(C){return C.length>0},4:function(C){return C.length>0}},g=0;g<h.length;g+=1){var x=A[g],_=I[h[g]]||"",T=x(_);if(!T)return!1}return!0}})(Lr)),Lr.exports}var bn;function la(){if(bn)return pt.exports;bn=1;var e=Dn,t=aa();return pt.exports=function(r,s){var n=t.getFileName();e.stat(n,function(i,o){if(i||!t.usePgPass(o,n))return s(void 0);var a=e.createReadStream(n);t.getPassword(r,a,s)})},pt.exports.warnTo=t.warnTo,pt.exports}var qr,yn;function ca(){if(yn)return qr;yn=1;const e=ze.EventEmitter,t=tt(),r=He,s=Go(),n=Gr(),i=ui(),o=Zo(),a=St(),u=mi(),d=ci(),l=r.deprecate(()=>{},"Client.activeQuery is deprecated and will be removed in pg@9.0"),f=r.deprecate(()=>{},"Client.queryQueue is deprecated and will be removed in pg@9.0."),c=r.deprecate(()=>{},"pgpass support is deprecated and will be removed in pg@9.0. You can provide an async function as the password property to the Client/Pool constructor that returns a password instead. Within this function you can call the pgpass module in your own code."),p=r.deprecate(()=>{},"Passing a custom Promise implementation to the Client/Pool constructor is deprecated and will be removed in pg@9.0."),h=r.deprecate(()=>{},"Calling client.query() when the client is already executing a query is deprecated and will be removed in pg@9.0. Use async/await or an external async flow control mechanism instead.");class b extends e{constructor(m){super(),this.connectionParameters=new i(m),this.user=this.connectionParameters.user,this.database=this.connectionParameters.database,this.port=this.connectionParameters.port,this.host=this.connectionParameters.host,Object.defineProperty(this,"password",{configurable:!0,enumerable:!1,writable:!0,value:this.connectionParameters.password}),this.replication=this.connectionParameters.replication;const y=m||{};y.Promise&&p(),this._Promise=y.Promise||zr.Promise,this._types=new n(y.types),this._ending=!1,this._ended=!1,this._connecting=!1,this._connected=!1,this._connectionError=!1,this._queryable=!0,this._activeQuery=null,this.enableChannelBinding=!!y.enableChannelBinding,this.connection=y.connection||new u({stream:y.stream,ssl:this.connectionParameters.ssl,keepAlive:y.keepAlive||!1,keepAliveInitialDelayMillis:y.keepAliveInitialDelayMillis||0,encoding:this.connectionParameters.client_encoding||"utf8"}),this._queryQueue=[],this.binary=y.binary||a.binary,this.processID=null,this.secretKey=null,this.ssl=this.connectionParameters.ssl||!1,this.ssl&&this.ssl.key&&Object.defineProperty(this.ssl,"key",{enumerable:!1}),this._connectionTimeoutMillis=y.connectionTimeoutMillis||0}get activeQuery(){return l(),this._activeQuery}set activeQuery(m){l(),this._activeQuery=m}_getActiveQuery(){return this._activeQuery}_errorAllQueries(m){const y=S=>{process.nextTick(()=>{S.handleError(m,this.connection)})},w=this._getActiveQuery();w&&(y(w),this._activeQuery=null),this._queryQueue.forEach(y),this._queryQueue.length=0}_connect(m){const y=this,w=this.connection;if(this._connectionCallback=m,this._connecting||this._connected){const S=new Error("Client has already been connected. You cannot reuse a client.");process.nextTick(()=>{m(S)});return}this._connecting=!0,this._connectionTimeoutMillis>0&&(this.connectionTimeoutHandle=setTimeout(()=>{w._ending=!0,w.stream.destroy(new Error("timeout expired"))},this._connectionTimeoutMillis),this.connectionTimeoutHandle.unref&&this.connectionTimeoutHandle.unref()),this.host&&this.host.indexOf("/")===0?w.connect(this.host+"/.s.PGSQL."+this.port):w.connect(this.port,this.host),w.on("connect",function(){y.ssl?w.requestSsl():w.startup(y.getStartupConf())}),w.on("sslconnect",function(){w.startup(y.getStartupConf())}),this._attachListeners(w),w.once("end",()=>{const S=this._ending?new Error("Connection terminated"):new Error("Connection terminated unexpectedly");clearTimeout(this.connectionTimeoutHandle),this._errorAllQueries(S),this._ended=!0,this._ending||(this._connecting&&!this._connectionError?this._connectionCallback?this._connectionCallback(S):this._handleErrorEvent(S):this._connectionError||this._handleErrorEvent(S)),process.nextTick(()=>{this.emit("end")})})}connect(m){if(m){this._connect(m);return}return new this._Promise((y,w)=>{this._connect(S=>{S?w(S):y(this)})})}_attachListeners(m){m.on("authenticationCleartextPassword",this._handleAuthCleartextPassword.bind(this)),m.on("authenticationMD5Password",this._handleAuthMD5Password.bind(this)),m.on("authenticationSASL",this._handleAuthSASL.bind(this)),m.on("authenticationSASLContinue",this._handleAuthSASLContinue.bind(this)),m.on("authenticationSASLFinal",this._handleAuthSASLFinal.bind(this)),m.on("backendKeyData",this._handleBackendKeyData.bind(this)),m.on("error",this._handleErrorEvent.bind(this)),m.on("errorMessage",this._handleErrorMessage.bind(this)),m.on("readyForQuery",this._handleReadyForQuery.bind(this)),m.on("notice",this._handleNotice.bind(this)),m.on("rowDescription",this._handleRowDescription.bind(this)),m.on("dataRow",this._handleDataRow.bind(this)),m.on("portalSuspended",this._handlePortalSuspended.bind(this)),m.on("emptyQuery",this._handleEmptyQuery.bind(this)),m.on("commandComplete",this._handleCommandComplete.bind(this)),m.on("parseComplete",this._handleParseComplete.bind(this)),m.on("copyInResponse",this._handleCopyInResponse.bind(this)),m.on("copyData",this._handleCopyData.bind(this)),m.on("notification",this._handleNotification.bind(this))}_getPassword(m){const y=this.connection;if(typeof this.password=="function")this._Promise.resolve().then(()=>this.password(this.connectionParameters)).then(w=>{if(w!==void 0){if(typeof w!="string"){y.emit("error",new TypeError("Password must be a string"));return}this.connectionParameters.password=this.password=w}else this.connectionParameters.password=this.password=null;m()}).catch(w=>{y.emit("error",w)});else if(this.password!==null)m();else try{la()(this.connectionParameters,S=>{S!==void 0&&(c(),this.connectionParameters.password=this.password=S),m()})}catch(w){this.emit("error",w)}}_handleAuthCleartextPassword(m){this._getPassword(()=>{this.connection.password(this.password)})}_handleAuthMD5Password(m){this._getPassword(async()=>{try{const y=await d.postgresMd5PasswordHash(this.user,this.password,m.salt);this.connection.password(y)}catch(y){this.emit("error",y)}})}_handleAuthSASL(m){this._getPassword(()=>{try{this.saslSession=s.startSession(m.mechanisms,this.enableChannelBinding&&this.connection.stream),this.connection.sendSASLInitialResponseMessage(this.saslSession.mechanism,this.saslSession.response)}catch(y){this.connection.emit("error",y)}})}async _handleAuthSASLContinue(m){try{await s.continueSession(this.saslSession,this.password,m.data,this.enableChannelBinding&&this.connection.stream),this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}catch(y){this.connection.emit("error",y)}}_handleAuthSASLFinal(m){try{s.finalizeSession(this.saslSession,m.data),this.saslSession=null}catch(y){this.connection.emit("error",y)}}_handleBackendKeyData(m){this.processID=m.processID,this.secretKey=m.secretKey}_handleReadyForQuery(m){this._connecting&&(this._connecting=!1,this._connected=!0,clearTimeout(this.connectionTimeoutHandle),this._connectionCallback&&(this._connectionCallback(null,this),this._connectionCallback=null),this.emit("connect"));const y=this._getActiveQuery();this._activeQuery=null,this.readyForQuery=!0,y&&y.handleReadyForQuery(this.connection),this._pulseQueryQueue()}_handleErrorWhileConnecting(m){if(!this._connectionError){if(this._connectionError=!0,clearTimeout(this.connectionTimeoutHandle),this._connectionCallback)return this._connectionCallback(m);this.emit("error",m)}}_handleErrorEvent(m){if(this._connecting)return this._handleErrorWhileConnecting(m);this._queryable=!1,this._errorAllQueries(m),this.emit("error",m)}_handleErrorMessage(m){if(this._connecting)return this._handleErrorWhileConnecting(m);const y=this._getActiveQuery();if(!y){this._handleErrorEvent(m);return}this._activeQuery=null,y.handleError(m,this.connection)}_handleRowDescription(m){const y=this._getActiveQuery();if(y==null){const w=new Error("Received unexpected rowDescription message from backend.");this._handleErrorEvent(w);return}y.handleRowDescription(m)}_handleDataRow(m){const y=this._getActiveQuery();if(y==null){const w=new Error("Received unexpected dataRow message from backend.");this._handleErrorEvent(w);return}y.handleDataRow(m)}_handlePortalSuspended(m){const y=this._getActiveQuery();if(y==null){const w=new Error("Received unexpected portalSuspended message from backend.");this._handleErrorEvent(w);return}y.handlePortalSuspended(this.connection)}_handleEmptyQuery(m){const y=this._getActiveQuery();if(y==null){const w=new Error("Received unexpected emptyQuery message from backend.");this._handleErrorEvent(w);return}y.handleEmptyQuery(this.connection)}_handleCommandComplete(m){const y=this._getActiveQuery();if(y==null){const w=new Error("Received unexpected commandComplete message from backend.");this._handleErrorEvent(w);return}y.handleCommandComplete(m,this.connection)}_handleParseComplete(){const m=this._getActiveQuery();if(m==null){const y=new Error("Received unexpected parseComplete message from backend.");this._handleErrorEvent(y);return}m.name&&(this.connection.parsedStatements[m.name]=m.text)}_handleCopyInResponse(m){const y=this._getActiveQuery();if(y==null){const w=new Error("Received unexpected copyInResponse message from backend.");this._handleErrorEvent(w);return}y.handleCopyInResponse(this.connection)}_handleCopyData(m){const y=this._getActiveQuery();if(y==null){const w=new Error("Received unexpected copyData message from backend.");this._handleErrorEvent(w);return}y.handleCopyData(m,this.connection)}_handleNotification(m){this.emit("notification",m)}_handleNotice(m){this.emit("notice",m)}getStartupConf(){const m=this.connectionParameters,y={user:m.user,database:m.database},w=m.application_name||m.fallback_application_name;return w&&(y.application_name=w),m.replication&&(y.replication=""+m.replication),m.statement_timeout&&(y.statement_timeout=String(parseInt(m.statement_timeout,10))),m.lock_timeout&&(y.lock_timeout=String(parseInt(m.lock_timeout,10))),m.idle_in_transaction_session_timeout&&(y.idle_in_transaction_session_timeout=String(parseInt(m.idle_in_transaction_session_timeout,10))),m.options&&(y.options=m.options),y}cancel(m,y){if(m.activeQuery===y){const w=this.connection;this.host&&this.host.indexOf("/")===0?w.connect(this.host+"/.s.PGSQL."+this.port):w.connect(this.port,this.host),w.on("connect",function(){w.cancel(m.processID,m.secretKey)})}else m._queryQueue.indexOf(y)!==-1&&m._queryQueue.splice(m._queryQueue.indexOf(y),1)}setTypeParser(m,y,w){return this._types.setTypeParser(m,y,w)}getTypeParser(m,y){return this._types.getTypeParser(m,y)}escapeIdentifier(m){return t.escapeIdentifier(m)}escapeLiteral(m){return t.escapeLiteral(m)}_pulseQueryQueue(){if(this.readyForQuery===!0){this._activeQuery=this._queryQueue.shift();const m=this._getActiveQuery();if(m){this.readyForQuery=!1,this.hasExecuted=!0;const y=m.submit(this.connection);y&&process.nextTick(()=>{m.handleError(y,this.connection),this.readyForQuery=!0,this._pulseQueryQueue()})}else this.hasExecuted&&(this._activeQuery=null,this.emit("drain"))}}query(m,y,w){let S,I,A,g,x;if(m==null)throw new TypeError("Client was passed a null or undefined query");return typeof m.submit=="function"?(A=m.query_timeout||this.connectionParameters.query_timeout,I=S=m,S.callback||(typeof y=="function"?S.callback=y:w&&(S.callback=w))):(A=m.query_timeout||this.connectionParameters.query_timeout,S=new o(m,y,w),S.callback||(I=new this._Promise((_,T)=>{S.callback=(C,O)=>C?T(C):_(O)}).catch(_=>{throw Error.captureStackTrace(_),_}))),A&&(x=S.callback||(()=>{}),g=setTimeout(()=>{const _=new Error("Query read timeout");process.nextTick(()=>{S.handleError(_,this.connection)}),x(_),S.callback=()=>{};const T=this._queryQueue.indexOf(S);T>-1&&this._queryQueue.splice(T,1),this._pulseQueryQueue()},A),S.callback=(_,T)=>{clearTimeout(g),x(_,T)}),this.binary&&!S.binary&&(S.binary=!0),S._result&&!S._result._types&&(S._result._types=this._types),this._queryable?this._ending?(process.nextTick(()=>{S.handleError(new Error("Client was closed and is not queryable"),this.connection)}),I):(this._queryQueue.length>0&&h(),this._queryQueue.push(S),this._pulseQueryQueue(),I):(process.nextTick(()=>{S.handleError(new Error("Client has encountered a connection error and is not queryable"),this.connection)}),I)}ref(){this.connection.ref()}unref(){this.connection.unref()}end(m){if(this._ending=!0,!this.connection._connecting||this._ended)if(m)m();else return this._Promise.resolve();if(this._getActiveQuery()||!this._queryable?this.connection.stream.destroy():this.connection.end(),m)this.connection.once("end",m);else return new this._Promise(y=>{this.connection.once("end",y)})}get queryQueue(){return f(),this._queryQueue}}return b.Query=o,qr=b,qr}var Dr,vn;function ua(){if(vn)return Dr;vn=1;const e=ze.EventEmitter,t=function(){},r=(d,l)=>{const f=d.findIndex(l);return f===-1?void 0:d.splice(f,1)[0]};class s{constructor(l,f,c){this.client=l,this.idleListener=f,this.timeoutId=c}}class n{constructor(l){this.callback=l}}function i(){throw new Error("Release called on client which has already been released to the pool.")}function o(d,l){if(l)return{callback:l,result:void 0};let f,c;const p=function(b,v){b?f(b):c(v)},h=new d(function(b,v){c=b,f=v}).catch(b=>{throw Error.captureStackTrace(b),b});return{callback:p,result:h}}function a(d,l){return function f(c){c.client=l,l.removeListener("error",f),l.on("error",()=>{d.log("additional client error after disconnection due to error",c)}),d._remove(l),d.emit("error",c,l)}}class u extends e{constructor(l,f){super(),this.options=Object.assign({},l),l!=null&&"password"in l&&Object.defineProperty(this.options,"password",{configurable:!0,enumerable:!1,writable:!0,value:l.password}),l!=null&&l.ssl&&l.ssl.key&&Object.defineProperty(this.options.ssl,"key",{enumerable:!1}),this.options.max=this.options.max||this.options.poolSize||10,this.options.min=this.options.min||0,this.options.maxUses=this.options.maxUses||1/0,this.options.allowExitOnIdle=this.options.allowExitOnIdle||!1,this.options.maxLifetimeSeconds=this.options.maxLifetimeSeconds||0,this.log=this.options.log||function(){},this.Client=this.options.Client||f||hi().Client,this.Promise=this.options.Promise||zr.Promise,typeof this.options.idleTimeoutMillis>"u"&&(this.options.idleTimeoutMillis=1e4),this._clients=[],this._idle=[],this._expired=new WeakSet,this._pendingQueue=[],this._endCallback=void 0,this.ending=!1,this.ended=!1}_promiseTry(l){const f=this.Promise;return typeof f.try=="function"?f.try(l):new f(c=>c(l()))}_isFull(){return this._clients.length>=this.options.max}_isAboveMin(){return this._clients.length>this.options.min}_pulseQueue(){if(this.log("pulse queue"),this.ended){this.log("pulse queue ended");return}if(this.ending){this.log("pulse queue on ending"),this._idle.length&&this._idle.slice().map(f=>{this._remove(f.client)}),this._clients.length||(this.ended=!0,this._endCallback());return}if(!this._pendingQueue.length){this.log("no queued requests");return}if(!this._idle.length&&this._isFull())return;const l=this._pendingQueue.shift();if(this._idle.length){const f=this._idle.pop();clearTimeout(f.timeoutId);const c=f.client;c.ref&&c.ref();const p=f.idleListener;return this._acquireClient(c,l,p,!1)}if(!this._isFull())return this.newClient(l);throw new Error("unexpected condition")}_remove(l,f){const c=r(this._idle,h=>h.client===l);c!==void 0&&clearTimeout(c.timeoutId),this._clients=this._clients.filter(h=>h!==l);const p=this;l.end(()=>{p.emit("remove",l),typeof f=="function"&&f()})}connect(l){if(this.ending){const p=new Error("Cannot use a pool after calling end on the pool");return l?l(p):this.Promise.reject(p)}const f=o(this.Promise,l),c=f.result;if(this._isFull()||this._idle.length){if(this._idle.length&&process.nextTick(()=>this._pulseQueue()),!this.options.connectionTimeoutMillis)return this._pendingQueue.push(new n(f.callback)),c;const p=(v,m,y)=>{clearTimeout(b),f.callback(v,m,y)},h=new n(p),b=setTimeout(()=>{r(this._pendingQueue,v=>v.callback===p),h.timedOut=!0,f.callback(new Error("timeout exceeded when trying to connect"))},this.options.connectionTimeoutMillis);return b.unref&&b.unref(),this._pendingQueue.push(h),c}return this.newClient(new n(f.callback)),c}newClient(l){const f=new this.Client(this.options);this._clients.push(f);const c=a(this,f);this.log("checking client timeout");let p,h=!1;this.options.connectionTimeoutMillis&&(p=setTimeout(()=>{f.connection?(this.log("ending client due to timeout"),h=!0,f.connection.stream.destroy()):f.isConnected()||(this.log("ending client due to timeout"),h=!0,f.end())},this.options.connectionTimeoutMillis)),this.log("connecting new client"),f.connect(b=>{if(p&&clearTimeout(p),f.on("error",c),b)this.log("client failed to connect",b),this._clients=this._clients.filter(v=>v!==f),h&&(b=new Error("Connection terminated due to connection timeout",{cause:b})),this._pulseQueue(),l.timedOut||l.callback(b,void 0,t);else{if(this.log("new client connected"),this.options.onConnect){this._promiseTry(()=>this.options.onConnect(f)).then(()=>{this._afterConnect(f,l,c)},v=>{this._clients=this._clients.filter(m=>m!==f),f.end(()=>{this._pulseQueue(),l.timedOut||l.callback(v,void 0,t)})});return}return this._afterConnect(f,l,c)}})}_afterConnect(l,f,c){if(this.options.maxLifetimeSeconds!==0){const p=setTimeout(()=>{this.log("ending client due to expired lifetime"),this._expired.add(l),this._idle.findIndex(b=>b.client===l)!==-1&&this._acquireClient(l,new n((b,v,m)=>m()),c,!1)},this.options.maxLifetimeSeconds*1e3);p.unref(),l.once("end",()=>clearTimeout(p))}return this._acquireClient(l,f,c,!0)}_acquireClient(l,f,c,p){p&&this.emit("connect",l),this.emit("acquire",l),l.release=this._releaseOnce(l,c),l.removeListener("error",c),f.timedOut?p&&this.options.verify?this.options.verify(l,l.release):l.release():p&&this.options.verify?this.options.verify(l,h=>{if(h)return l.release(h),f.callback(h,void 0,t);f.callback(void 0,l,l.release)}):f.callback(void 0,l,l.release)}_releaseOnce(l,f){let c=!1;return p=>{c&&i(),c=!0,this._release(l,f,p)}}_release(l,f,c){if(l.on("error",f),l._poolUseCount=(l._poolUseCount||0)+1,this.emit("release",c,l),c||this.ending||!l._queryable||l._ending||l._poolUseCount>=this.options.maxUses)return l._poolUseCount>=this.options.maxUses&&this.log("remove expended client"),this._remove(l,this._pulseQueue.bind(this));if(this._expired.has(l))return this.log("remove expired client"),this._expired.delete(l),this._remove(l,this._pulseQueue.bind(this));let h;this.options.idleTimeoutMillis&&this._isAboveMin()&&(h=setTimeout(()=>{this._isAboveMin()&&(this.log("remove idle client"),this._remove(l,this._pulseQueue.bind(this)))},this.options.idleTimeoutMillis),this.options.allowExitOnIdle&&h.unref()),this.options.allowExitOnIdle&&l.unref(),this._idle.push(new s(l,f,h)),this._pulseQueue()}query(l,f,c){if(typeof l=="function"){const h=o(this.Promise,l);return setImmediate(function(){return h.callback(new Error("Passing a function as the first parameter to pool.query is not supported"))}),h.result}typeof f=="function"&&(c=f,f=void 0);const p=o(this.Promise,c);return c=p.callback,this.connect((h,b)=>{if(h)return c(h);let v=!1;const m=y=>{v||(v=!0,b.release(y),c(y))};b.once("error",m),this.log("dispatching query");try{b.query(l,f,(y,w)=>{if(this.log("query dispatched"),b.removeListener("error",m),!v)return v=!0,b.release(y),y?c(y):c(void 0,w)})}catch(y){return b.release(y),c(y)}}),p.result}end(l){if(this.log("ending"),this.ending){const c=new Error("Called end on pool more than once");return l?l(c):this.Promise.reject(c)}this.ending=!0;const f=o(this.Promise,l);return this._endCallback=f.callback,this._pulseQueue(),f.result}get waitingCount(){return this._pendingQueue.length}get idleCount(){return this._idle.length}get expiredCount(){return this._clients.reduce((l,f)=>l+(this._expired.has(f)?1:0),0)}get totalCount(){return this._clients.length}}return Dr=u,Dr}var jr={exports:{}};const da={},fa=Object.freeze(Object.defineProperty({__proto__:null,default:da},Symbol.toStringTag,{value:"Module"})),pa=oo(fa);var kr={exports:{}},wn;function ma(){if(wn)return kr.exports;wn=1;const e=ze.EventEmitter,t=He,r=tt(),s=kr.exports=function(i,o,a){e.call(this),i=r.normalizeQueryConfig(i,o,a),this.text=i.text,this.values=i.values,this.name=i.name,this.queryMode=i.queryMode,this.callback=i.callback,this.state="new",this._arrayMode=i.rowMode==="array",this._emitRowEvents=!1,this.on("newListener",(function(u){u==="row"&&(this._emitRowEvents=!0)}).bind(this))};t.inherits(s,e);const n={sqlState:"code",statementPosition:"position",messagePrimary:"message",context:"where",schemaName:"schema",tableName:"table",columnName:"column",dataTypeName:"dataType",constraintName:"constraint",sourceFile:"file",sourceLine:"line",sourceFunction:"routine"};return s.prototype.handleError=function(i){const o=this.native.pq.resultErrorFields();if(o)for(const a in o){const u=n[a]||a;i[u]=o[a]}this.callback?this.callback(i):this.emit("error",i),this.state="error"},s.prototype.then=function(i,o){return this._getPromise().then(i,o)},s.prototype.catch=function(i){return this._getPromise().catch(i)},s.prototype._getPromise=function(){return this._promise?this._promise:(this._promise=new Promise((function(i,o){this._once("end",i),this._once("error",o)}).bind(this)),this._promise)},s.prototype.submit=function(i){this.state="running";const o=this;this.native=i.native,i.native.arrayMode=this._arrayMode;let a=function(u,d,l){if(i.native.arrayMode=!1,setImmediate(function(){o.emit("_done")}),u)return o.handleError(u);o._emitRowEvents&&(l.length>1?d.forEach((f,c)=>{f.forEach(p=>{o.emit("row",p,l[c])})}):d.forEach(function(f){o.emit("row",f,l)})),o.state="end",o.emit("end",l),o.callback&&o.callback(null,l)};if(process.domain&&(a=process.domain.bind(a)),this.name){this.name.length>63&&(console.error("Warning! Postgres only supports 63 characters for query names."),console.error("You supplied %s (%s)",this.name,this.name.length),console.error("This can cause conflicts and silent errors executing queries"));const u=(this.values||[]).map(r.prepareValue);if(i.namedQueries[this.name]){if(this.text&&i.namedQueries[this.name]!==this.text){const d=new Error(`Prepared statements must be unique - '${this.name}' was used for a different statement`);return a(d)}return i.native.execute(this.name,u,a)}return i.native.prepare(this.name,this.text,u.length,function(d){return d?a(d):(i.namedQueries[o.name]=o.text,o.native.execute(o.name,u,a))})}else if(this.values){if(!Array.isArray(this.values)){const d=new Error("Query values must be an array");return a(d)}const u=this.values.map(r.prepareValue);i.native.query(this.text,u,a)}else this.queryMode==="extended"?i.native.query(this.text,[],a):i.native.query(this.text,a)},kr.exports}var _n;function ha(){if(_n)return jr.exports;_n=1;const e=He;var t;try{t=pa}catch(d){throw d}const r=Gr(),s=ze.EventEmitter,n=He,i=ui(),o=ma(),a=e.deprecate(()=>{},"Calling client.query() when the client is already executing a query is deprecated and will be removed in pg@9.0. Use async/await or an external async flow control mechanism instead."),u=jr.exports=function(d){s.call(this),d=d||{},this._Promise=d.Promise||zr.Promise,this._types=new r(d.types),this.native=new t({types:this._types}),this._queryQueue=[],this._ending=!1,this._connecting=!1,this._connected=!1,this._queryable=!0;const l=this.connectionParameters=new i(d);d.nativeConnectionString&&(l.nativeConnectionString=d.nativeConnectionString),this.user=l.user,Object.defineProperty(this,"password",{configurable:!0,enumerable:!1,writable:!0,value:l.password}),this.database=l.database,this.host=l.host,this.port=l.port,this.namedQueries={}};return u.Query=o,n.inherits(u,s),u.prototype._errorAllQueries=function(d){const l=f=>{process.nextTick(()=>{f.native=this.native,f.handleError(d)})};this._hasActiveQuery()&&(l(this._activeQuery),this._activeQuery=null),this._queryQueue.forEach(l),this._queryQueue.length=0},u.prototype._connect=function(d){const l=this;if(this._connecting){process.nextTick(()=>d(new Error("Client has already been connected. You cannot reuse a client.")));return}this._connecting=!0,this.connectionParameters.getLibpqConnectionString(function(f,c){if(l.connectionParameters.nativeConnectionString&&(c=l.connectionParameters.nativeConnectionString),f)return d(f);l.native.connect(c,function(p){if(p)return l.native.end(),d(p);l._connected=!0,l.native.on("error",function(h){l._queryable=!1,l._errorAllQueries(h),l.emit("error",h)}),l.native.on("notification",function(h){l.emit("notification",{channel:h.relname,payload:h.extra})}),l.emit("connect"),l._pulseQueryQueue(!0),d(null,this)})})},u.prototype.connect=function(d){if(d){this._connect(d);return}return new this._Promise((l,f)=>{this._connect(c=>{c?f(c):l(this)})})},u.prototype.query=function(d,l,f){let c,p,h,b,v;if(d==null)throw new TypeError("Client was passed a null or undefined query");if(typeof d.submit=="function")h=d.query_timeout||this.connectionParameters.query_timeout,p=c=d,typeof l=="function"&&(d.callback=l);else if(h=d.query_timeout||this.connectionParameters.query_timeout,c=new o(d,l,f),!c.callback){let m,y;p=new this._Promise((w,S)=>{m=w,y=S}).catch(w=>{throw Error.captureStackTrace(w),w}),c.callback=(w,S)=>w?y(w):m(S)}return h&&(v=c.callback||(()=>{}),b=setTimeout(()=>{const m=new Error("Query read timeout");process.nextTick(()=>{c.handleError(m,this.connection)}),v(m),c.callback=()=>{};const y=this._queryQueue.indexOf(c);y>-1&&this._queryQueue.splice(y,1),this._pulseQueryQueue()},h),c.callback=(m,y)=>{clearTimeout(b),v(m,y)}),this._queryable?this._ending?(c.native=this.native,process.nextTick(()=>{c.handleError(new Error("Client was closed and is not queryable"))}),p):(this._queryQueue.length>0&&a(),this._queryQueue.push(c),this._pulseQueryQueue(),p):(c.native=this.native,process.nextTick(()=>{c.handleError(new Error("Client has encountered a connection error and is not queryable"))}),p)},u.prototype.end=function(d){const l=this;this._ending=!0,this._connected||this.once("connect",this.end.bind(this,d));let f;return d||(f=new this._Promise(function(c,p){d=h=>h?p(h):c()})),this.native.end(function(){l._connected=!1,l._errorAllQueries(new Error("Connection terminated")),process.nextTick(()=>{l.emit("end"),d&&d()})}),f},u.prototype._hasActiveQuery=function(){return this._activeQuery&&this._activeQuery.state!=="error"&&this._activeQuery.state!=="end"},u.prototype._pulseQueryQueue=function(d){if(!this._connected||this._hasActiveQuery())return;const l=this._queryQueue.shift();if(!l){d||this.emit("drain");return}this._activeQuery=l,l.submit(this);const f=this;l.once("_done",function(){f._pulseQueryQueue()})},u.prototype.cancel=function(d){this._activeQuery===d?this.native.cancel(function(){}):this._queryQueue.indexOf(d)!==-1&&this._queryQueue.splice(this._queryQueue.indexOf(d),1)},u.prototype.ref=function(){},u.prototype.unref=function(){},u.prototype.setTypeParser=function(d,l,f){return this._types.setTypeParser(d,l,f)},u.prototype.getTypeParser=function(d,l){return this._types.getTypeParser(d,l)},u.prototype.isConnected=function(){return this._connected},jr.exports}var Br,En;function xn(){return En||(En=1,Br=ha()),Br}var Sn;function hi(){return Sn||(Sn=1,(function(e){var t={};const r=ca(),s=St(),n=mi(),i=di(),o=tt(),a=ua(),u=Gr(),{DatabaseError:d}=pi(),{escapeIdentifier:l,escapeLiteral:f}=tt(),c=v=>class extends a{constructor(y){super(y,v)}},p=function(v){this.defaults=s,this.Client=v,this.Query=this.Client.Query,this.Pool=c(this.Client),this._pools=[],this.Connection=n,this.types=xt(),this.DatabaseError=d,this.TypeOverrides=u,this.escapeIdentifier=l,this.escapeLiteral=f,this.Result=i,this.utils=o};let h=r,b=!1;try{b=!!t.NODE_PG_FORCE_NATIVE}catch{}b&&(h=xn()),e.exports=new p(h),Object.defineProperty(e.exports,"native",{configurable:!0,enumerable:!1,get(){let v=null;try{v=new p(xn())}catch(m){if(m.code!=="MODULE_NOT_FOUND")throw m}return Object.defineProperty(e.exports,"native",{value:v}),v}})})(ar)),ar.exports}var ga=hi();const ee=ti(ga);ee.Client;const ba=ee.Pool;ee.Connection;ee.types;ee.Query;ee.DatabaseError;ee.escapeIdentifier;ee.escapeLiteral;ee.Result;ee.TypeOverrides;ee.defaults;const ya=Object.freeze(Object.defineProperty({__proto__:null,Pool:ba,default:ee},Symbol.toStringTag,{value:"Module"}));export{Ds as default};
